...
<title><?php echo COMPANY_S; ?> - Products Sample Maintenance</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="admin-top">
                	<h1>Products Sample Maintenance</h1>
                   <div class="cl"></div> 
                </div>
                ...
                <div id="options-area">
					<div class="add-new-option">
						<a href="#" 
						    onClick="MM_openBrWindow('sample_add.php?action=sample_add#addSam','','scrollbars=yes,width=750,height=600')">
						    Add New Record		  
						</a> 
                    </div>
                </div>
               ...
               <div id="PrintForm">
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                        ...
                        <thead>
						<tr>
                          <th width="3%" height="25"  align="center">Sample No.</th>
						 <!-- <th width="3%" height="25"  align="center">Stock Id</th> -->
						  <th width="10%" style="font-size: 7px; color: red;">Designer</th>
                       ...
                       <?php 
                        ...
                        foreach($sampleData as $eachRecord)
                            {
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   <td align="left"><?php echo $eachRecord['sample_id']; ?></td>
						<td align="center">
							<a href="#" 
						    onClick="MM_openBrWindow('sample_emp.inc.php?action=Show_emp&sid=<?php echo $eachRecord['sample_id']; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
								<?php echo $empdata[2]; ?>	  
							</a>
						</td>
					   ...
					   <td align="center">
					 	<?php 
							if(($eachRecord['image'] != '') && ( file_exists("images/".$eachRecord['image'])) )
							{
								echo $utility->imageDisplay2('images/', $eachRecord['image'], 50, 50, 0, '', $eachRecord['sample_id']);
					   ...
					   <td align="center">
						<a href="#" 
						    onClick="MM_openBrWindow('add_emp.php?action=Add_emp&sid=<?php echo $eachRecord['sample_id']; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
						    Add Emp		  
						</a> |
						<a href="#" 
						    onClick="MM_openBrWindow('sample_edit.php?action=Add_emp&sid=<?php echo $eachRecord['sample_id']; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
						    Edit		  
						</a> |
						<a href="sample_dtls.php?sid=<?php echo $eachRecord['sample_id'];?>" >
						    Details	</a>		  
						 |
						<a href="#" 
						    onClick="MM_openBrWindow('add_image.php?action=Add_Image&sid=<?php echo $eachRecord['sample_id']; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
						    Image		  
						</a> 
						|
						<a href="#" 
						    onClick="MM_openBrWindow('rate-preview.php?action=Rate-preview&sid=<?php echo $eachRecord['sample_id']; ?>','ratePreview','scrollbars=yes,width=750,height=600')">
						  Rate preview		  
						</a> 
