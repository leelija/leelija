...
<title><?php echo COMPANY_S; ?>View sample Computer Arri</title>
...
<h2><a name="editStock">View Sample Computer Arri</a></h2>
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						...
						<tr class="table-row" >
							...
							[ 
							<a href="#" 
							  onClick="MM_openBrWindow('sample_computer_delete.php?action=del_computer&sid=<?php echo $eachrecord ['computer_aari_id']; ?>','delComputer','scrollbars=yes,width=400,height=400')">
							  Delete					  </a> ]
