...
{	
	$dStitch->StitchApproved($sid, $_SESSION[ADM_SESS],'Yes');
	
	$uMesg->showSuccessT('success', $id, 'id', $_SERVER['PHP_SELF'], "Thanks! For Approved", 'SUCCESS');
}
...
<h3></h3>
        ...
        <form action="<?php $_SERVER['PHP_SELF']?>?action=Add_emp&sid=<?php echo $sid; ?>" method="post" enctype="multipart/form-data">
		 <h2><a name="addUser">Approved Stitch Data</a></h2>
                        <span>All data are <span class="required"></span> Correct</span>
					...
					<input name="btnAddRecord" type="submit" class="button-add"  value="Approved" />
