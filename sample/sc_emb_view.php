...
<title><?php echo COMPANY_S; ?>View sample Computer Embroidery</title>
...
<h2><a name="editStock">View Sample Computer Embroidery</a></h2>
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						...
						<tr class="table-row" >
							...
							<td align="center">
							<a href="#" 
							  onClick="MM_openBrWindow('sample_computer_delete.php?action=del_computer&sid=<?php echo $eachrecord ['computer_emb_id']; ?>','delComputer','scrollbars=yes,width=400,height=400')">
							  Delete					  </a>
							<a href="#" 
							  onClick="MM_openBrWindow('sc_emb_edit.php?action=del_sdye&scid=<?php echo $eachrecord ['computer_emb_id']; ?>','delDye','scrollbars=yes,width=600,height=600')">
							  Edit					  </a>   
