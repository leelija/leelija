...
$dStitchData	= $dStitch->getmDailyStitch();
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
						<a href="#" 
						    onClick="MM_openBrWindow('mdaily-stitch-add.php?action=sample_add#addSam','','scrollbars=yes,width=750,height=600')">
						    Add New Record		  
						</a> 
                    </div>
					<a href="../file_download.inc.php?table=mdaily_comp_stitch">Download</a>
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><?php echo $eachRecord['computer_type']; ?></td>
					   ...
					   <td align="center"><?php echo $eachRecord['offer']; ?></td>
					   ...
					   <td align="center">
						<a href="#" 
						    onClick="MM_openBrWindow('mdaily-stitch-edit.php?action=Edit_Stitch&dcs_id=<?php echo $eachRecord['dcs_id']; ?>','stockEdit','scrollbars=yes,width=800,height=600')">
						    Edit	  
						</a> 
