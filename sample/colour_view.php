...
<title><?php echo COMPANY_S; ?>View sample colour</title>
...
<h2><a name="editStock">View Sample Colours</a></h2>
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						...
						<th class="listheader">Ratio </th>
						<th class="listheader">Ratio Value</th>
						<th class="listheader">Remarks</th>
						<th class="listheader">Added By</th>
						...
						<?php 
							...
							$ColoursDtl = $sample->getAllcolourDtl($sid);
							?>	
							<?php $reco_record = 0; 
							//echo "$data[2]";
							foreach( $ColoursDtl as $eachrecord ){
						...
						<tr class="table-row" >
							...
							<td align="center"><?php echo $eachrecord ['colour_name']; ?></td>
							<td align="center"><?php echo $eachrecord ['color_ratio']; ?></td>
							<td align="center"><?php echo $eachrecord ['color_ratio_value']; ?></td>
							<td align="center"><?php echo $eachrecord ['remarks']; ?></td>
							<td align="center"><?php echo $eachrecord ['added_by']; ?></td>
							<td align="center">
							[ 
							<a href="#" 
							  onClick="MM_openBrWindow('delete_colours.php?action=del_colour&cid=<?php echo $eachrecord ['colour_id']; ?>','delColour','scrollbars=yes,width=400,height=400')">
							  Delete					  </a> ]
