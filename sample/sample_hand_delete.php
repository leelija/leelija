...
{	
	...
	//delete the stock
	$sample->delSamhand($sid);
	
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], "Sample Hand has been delete successfully", 'SUCCESS');
	
}
?>

<title><?php echo COMPANY_S; ?> -  - Delete Sample hand </title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'del_hand') )
    {
        $samDetails = $sample->showSamHand($sid);
    ?>
    <tr class=''>
