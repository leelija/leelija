...
if(isset($_POST['btnLogin']))
{
	...
	elseif($login == 'sabanakazi12'){
		echo "Sorry!! ...";
	}
	else
	{
		
		$adminLogin->samplevalidate($login, $password, 'username', 'password', 'admin_users');
	}
}
?>
...
<title>Sample Control Panel -  CRM</title>
