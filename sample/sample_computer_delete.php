...
{	
	...
	//delete the stock
	$sample->delSamComputerEmb($sid);
	
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], "Computer Particular has been delete successfully", 'SUCCESS');
	
}
?>

<title><?php echo COMPANY_S; ?> -  - Delete Sample Computer</title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'del_computer') )
    {
        $samDetails = $sample->showSamComputerEmb($sid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Sample Computer particular :: <?php echo $samDetails[4]; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?sid=<?php echo $sid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            Are you sure	that	you	want	to delete the Sample Computer particular
            <strong><?php echo $samDetails[4]; ?></strong> from table
