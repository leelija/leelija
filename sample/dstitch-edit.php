...
$dStitchDtls 	= $dStitch->showDailyStitch($sid);

//echo $userData[0];exit;
...
{	
	...
	$dStitch->editStitchData($sid,$txtOperator,$empDtls[2],$txtDate,$userData[10]);
	
	$uMesg->showSuccessT('success', $id, 'id', $_SERVER['PHP_SELF'], "Delete has been successfully", 'SUCCESS');
}
...
<title><?php echo COMPANY_S; ?> -  Edit Stitch Data</title>
...
<h3></h3>
        ...
        <form action="<?php $_SERVER['PHP_SELF']?>?action=Add_emp&sid=<?php echo $sid; ?>" method="post" enctype="multipart/form-data">
		 <h2><a name="addUser">Edit Stitch Data</a></h2>
                           ...
                           <div class="cl"></div>
							<div >
								...
								<select name="txtOperator" type="text" id="txtOperator" class="text_box_large">
								 <option value="<?php echo $dStitchDtls[1];?>"><?php echo $dStitchDtls[12];?></option>
								<?php
                            ...
                            <div class="cl"></div>
							<div class="cl"></div>
                            <label>Date<span class="orangeLetter">*</span></label>
                            <input name="txtDate" type="date" class="text_box_large" id="txtDate" 
