...
if($sampleDtl[0] == '')
	...
	else
	{
				...
				$MaterialCost  			= 0;
				//echo $totalCost; exit;
				//add the sample computer Emb
				$computer_emb_id 	= $sample->addSamComputer($sampleDtl[0],$txtEmpName,$sampleDtl[3],$txtParticular,$txtTime,
				$txtOtherCost,$txtComDesinNo,$txtStichAmount,$txtStichRate,
				$stichCost,$MaterialCost,$totalCost,$txtProdDesc,$userData[10],$txtNoOfHeads,'scomputer_embroidery');
		...
		for($i=0; $i < $selNum; $i++)
			{
				...
				//add the scomputer_emb_material 
				$sample->addSamMaterials($computer_emb_id,$_POST['txtMaterialName'][$i],$_POST['txtMatAmount'][$i],
				$_POST['txtMUnit'][$i],'','','scomputer_emb_material','computer_emb_id');	
...
<title><?php echo COMPANY_S; ?> -Add Sample Computer Embroidery Material</title>
...
<h3><a name="editStock"></a></h3>
		 ...
		 <h2><a name="addUser">Add Sample Computer Embroidery Material</a></h2>
