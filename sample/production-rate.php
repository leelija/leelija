...
$prodRateData	= $rateChart->getAllProdRate();
...
<title><?php echo COMPANY_S; ?> - Production rate Maintenance</title>
...
<body>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
               <div id="admin-top">
                	<h1>Production rate Maintenance</h1>
                   <div class="cl"></div> 
                </div>
                <!-- Options --><br><br><br><br>
                <div id="options-area">
					<div class="add-new-option">
						<a href="add-production-rate.php?action=addProdRate"> 
               ...
               <div id="PrintForm">
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                        ...
                        <thead>
						<tr>
                          <th width="3%" height="25"  align="center">SlNo.</th>
						 <!-- <th width="3%" height="25"  align="center">Stock Id</th> -->
						  <th width="10%" style="font-size: 7px; color: red;">Design No</th>
                       ...
                       <?php 
                        ...
                        foreach($prodRateData as $eachRecord)
                            {
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
						...
						<td align="center"><?php echo $eachRecord['percentage']; ?></td>
						<td align="center"><?php echo $eachRecord['net_cost']; ?></td>
						...
						<td align="center"><?php echo $eachRecord['modified_by']; ?></td>
						<td align="center"><?php echo $eachRecord['modified_on']; ?></td>
					   
						<td align="center">
							<a href="prod-rate-view.php?action=Rate-preview&prid=<?php echo $eachRecord['id']; ?>">
							  Rate preview		  
							</a> 
						</td>
