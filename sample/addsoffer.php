...
{	
	...
	$dStitch->StitchOffer($sid, $txtOffer,$userData[2]);
...
<title><?php echo COMPANY_S; ?> -  Approved Stitch Data</title>
...
<h3></h3>
        ...
        <form action="<?php $_SERVER['PHP_SELF']?>?action=Add_emp&sid=<?php echo $sid; ?>" method="post" enctype="multipart/form-data">
		 <h2><a name="addUser">Add Offer</a></h2>
                        <span>Stitch: <?php echo $dStitchDtls[4];?><span class="required"></span>&nbsp;&nbsp;Shift:<?php echo $dStitchDtls[3];?></span>
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							value="<?php echo $dStitchDtls[11];?>" size="25" />
                            <div class="cl"></div>	
