...
<title><?php echo COMPANY_S; ?>View sample Hand Material</title>
...
<h3><a name="editStock">View Sample Hand Material</a></h3>
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						...
						<tr class="table-row" >
							...
							<a href="#" 
							  onClick="MM_openBrWindow('sample_hand_delete.php?action=del_hand&sid=<?php echo $eachrecord ['hand_id']; ?>','delHand','scrollbars=yes,width=400,height=400')">
							  Delete					  </a> 
							  
							<a href="#" 
							  onClick="MM_openBrWindow('sample_hand_edit.php?action=del_sdye&hid=<?php echo $eachrecord ['hand_id']; ?>','delDye','scrollbars=yes,width=600,height=600')">
							  Edit					  </a> 
							</td>
						</tr>
