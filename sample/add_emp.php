...
{	
	...
	if(count($selNum)=='')
	{
		$error->showErrorTA($action, $id, $id_var, $url,"Select number of employee empty", $typeM, $anchor);
	}
	else
	{
		...
		{
			// Add employee
			$sample->addSampleDtls($sid,$_POST['txtEmpName'][$i],$_POST['txtPost'][$i],$userData[10]);
			//forward
		}
		$uMesg->showSuccessT('success', $id, 'id', $_SERVER['PHP_SELF'], "Employee has been successfully added", 'SUCCESS');
        ...
        <form action="<?php $_SERVER['PHP_SELF']?>?action=Add_emp&sid=<?php echo $sid; ?>" method="post" enctype="multipart/form-data">
		 <h2><a name="addUser">Add Employee</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                           <div class="cl"></div>
							<tr>
								<label>Select No. of Employee</label>
									...
									?>
									  <select name="selNum" id="selNum" onchange="return getAllSampleEmp();"
									   class="textBoxA">
								...
								<div class="cl"></div>
								<div id="showSamProductsInDetails"></div>
                            <div class="cl"></div>
