...
{	
	$dStitch->delDailyCompStitch($sid);
...
<h3></h3>
        ...
        <form action="<?php $_SERVER['PHP_SELF']?>?action=Add_emp&sid=<?php echo $sid; ?>" method="post" enctype="multipart/form-data">
		 <h2><a name="addUser">Delete Stitch Data</a></h2>
                        <span>Are sure!! You want to delete this<span class="required"></span>Data</span>
					...
					<input name="btnAddRecord" type="submit" class="button-add"  value="Del" />
