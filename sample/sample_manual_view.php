...
<h3><a name="editStock">View Sample Manual Aari Material</a></h3>
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						...
						<tr class="table-row" >
							...
							[ 
							<a href="#" 
							  onClick="MM_openBrWindow('sample_manual_delete.php?action=del_manual&sid=<?php echo $eachrecord ['manual_arri_id']; ?>','delManual','scrollbars=yes,width=400,height=400')">
							  Delete					  </a> ]
