...
<body>
		...
		<div class="container"><!--Start Container-->
			<div class="row">
				<div class="span12">
					<div id="keep-up-date">
						<h1>Check Due Order Book No. Wise</h1>
						<br />
						<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form form-inline">
		  						<input placeholder="Search with Book No." class="input-xxlarge" id="appendedInputButton" name="txtBookNo" type="text">
						...
						<?php
							...
							{	
								...
								$orderDetail 				= $productOrder->getBookNoStatus($txtBookNo);
									...
									<table class="single-column" cellpadding="0" cellspacing="0" border="1">
										...
										<?php 
											...
											<thead >
											   ...
											   <th align="center" width="5%"  >Color</th>
											   <th align="center" width="5%"  >Due</th>
											   <th align="center" width="5%"  >Dispatch</th>
											</thead>
										   <?php 
											$k = 1;
