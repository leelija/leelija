...
<head>
	...
	<title>Due Party Order Status</title>
...
<body>
		...
		<div class="container"><!--Start Container-->
			<div class="row">
				<div class="span12">
					<div id="keep-up-date">
						<h1>Check GR Party Code. Wise</h1>
						<br />
						<form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="form form-inline">
		  						<input placeholder="Search with Party Code" class="input-xxlarge" id="appendedInputButton" name="txtPartyCode" type="text">
						...
						<?php
							...
							{	
								...
								$GrDtlsDetail 					= $productStock->showPartyGrProdDtls($txtPartyCode);
								//echo $txtPartyCode;exit;
									...
									<table class="single-column" cellpadding="0" cellspacing="0" border="1">
										...
										<?php 
											...
											<thead >
											   ...
											   <th align="center" width="3%" >Party Code</th>
											   <th align="center" width="5%"  >Design No</th>
											   <th align="center" width="5%"  >Quantity</th>
											</thead>
										   <?php 
											$k = 1;
											foreach($GrDtlsDetail as $eachRecord)
												{
												
												//Order Details
												$stockDtls 		 = $productStock->showProductStock($eachRecord['stock_id']);
												$tGR			 = $eachRecord['SUM(greturn)'] + $eachRecord['SUM(ready_gd)'];
										?>
											<tr align="left">
											<td align="center"><?php echo $k; ?></td>
											<td align="center"><?php echo $eachRecord['party_code']; ?></td>
											<td align="center"><?php echo $stockDtls[1]; ?></td>
											<td align="center"><?php echo $tGR; ?></td>
										 </tr>
										  <?php 
												}
												$k++;
