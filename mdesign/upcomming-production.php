...
<head>
	...
	<title>Up Comming Production</title>
...
<body>
		...
		<div class="container"><!--Start Container-->
			<div class="row">
				<div class="span12">
					<div id="keep-up-date">
						<h1>Check Up Comming Product Factory Wise</h1>
						<br />
						...
						<?php
							...
							{	
								...
								$fStitchStat 				= $statusCat->getDueStitchPrd($txtFactory);
									...
									<table class="single-column" cellpadding="0" cellspacing="0" border="1">
										...
										<?php 
											...
											<thead >
											   ...
											   <th align="center" width="5%"  >Particular</th>
											   <th align="center" width="5%"  >Stitching</th>
											</thead>
										   <?php 
											$k = 1;
											foreach($fStitchStat as $eachRecord)
												{
