...
$otherBillingdata = $bill->showOthersBilling();
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="<?php echo "mep_others_bill_add.php"."?action=add_fbill"; ?>">
                            Add New Bill
                        </a> 
                    </div>
				</div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tbody>
						   <?php 
							$sl=1;   
							foreach($otherBillingdata as $eachRecord)
								{
						...
						?>
							<tr align="left"<?php $utility->printRowColor($bgColor);?>>
								...
								<td align="center"><?php echo $eachRecord['bill_for']; ?></td>
								<td align="center"><?php echo $eachRecord['bill_purpose']; ?></td>
								<td align="center"><?php echo $eachRecord['tamount']; ?></td>
								<td><?php echo $dateUtil->printDate($eachRecord['added_on']); ?></td>
								<td align="center"><?php echo $eachRecord['added_by']; ?></td>
								<td>
									<p 
									onClick="MM_openBrWindow('mep-other-bill-view.php?action=bill-review&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									View					  
									</p> 
								</td>
							</tr>
