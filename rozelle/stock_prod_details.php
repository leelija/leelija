                ...
                <div id="data-column">
                    ...
                    ?>
					  ...
					  <td align="center" ><?php echo $productDetail[0]; ?></td>
					   <td align="center"><?php echo $productDetail[1]; ?></td>
					   <td align="center"><?php echo $productDetail[3]; ?></td>
					...
					<!--	<td align="center" ><?php //echo $productDetail[9]; ?></td>
					  ...
					  [ 
					    <a href="order_add.php?action=add_ord&sid= <?php echo $productDetail[0]; ?>" style="color:red;">
					  Order					  </a> ]<br>
