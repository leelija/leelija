...
$orderDeliverDtl		= $rozelleOrder->RozordersDeliverDtl($oid);
...
<title><?php echo COMPANY_S; ?>Delivery Status</title>
...
<h3><a name="editStock">Delivery Status </a></h3>
		...
		Order Id:<?php echo $oid;?></h2>
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						...
						<th class="listheader">Deliver date </th>
						</tr>
						...
						<?php 
							...
							<?php $reco_record = 0; 
							//echo "$data[2]";
							foreach( $orderDeliverDtl as $eachrecord ){
