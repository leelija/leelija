...
$orderColorDtl		= $rozelleOrder->RozordersDtlDisp($oid);

$orderDtl		= $rozelleOrder->showRozelleOrders($oid);
...
<h3><a name="editStock">View Colours Details</a></h3>
		...
		<h2 style="float:left;">Total Quantity:<?php  $rozelleOrder->RozTotalQuantitySum($oid);?></h2>
