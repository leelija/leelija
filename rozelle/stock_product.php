...
<title><?php echo COMPANY_S; ?>  Product stock Availability </title>
<!-- Style -->
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="admin-top">
                	<h1>Product stock Availability</h1>
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "bulk_order.php"."?action=add_ord"; ?>">
                            Bulk Order
                        </a> 
                    </div>
                </div>
                  ...
                  <!--    <th width="10%" >Product In</th>
                    ...
                    ?>
					  ...
					  <td >
					   [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('stock_details.php?action=stockDetail&sid=<?php echo $stockDetail[0]; ?>','OrdEdit','scrollbars=yes,width=750,height=600')">
					  Stock Details					  </a> ]
