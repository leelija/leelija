...
//echo "hi...";
	...
	else
	{
		...
		for($i=0; $i < $selNum; $i++)
			{
				//add the Orders
				$orders_id =  $rozelleOrder->addRozzeleOrders($_POST['txtDesignNo'][$i],$txtBookNo, $txtPartyName, $txtBrokar, $txtRetaHol, $txtForm, '',
				'',0,$txtPriority,'open',$txtProdDesc,$OrdersDate,$TargetDate);	
			}
			for($i=0; $i < $selNum1; $i++)
			{
				//add the orders colour
				$rozelleOrder->addRozOrderDtl($orders_id,$_POST['txtDesignNo'][$i],$txtBookNo,$txtPartyName, $_POST['txtQuantity'][$i],$_POST['txtQuantity'][$i],'',$_POST['txtColour'][$i],
                ...
                <div class="webform-area">
					...
					?>
                       ...
                       <!--  <label>Brokar <span class="orangeLetter"></span></label>
							...
							<tr>
									<label>Select No. of Design</label>
									...
									$arr_label	= range(1,8);
									?>
									  <select name="selNum" id="selNum" onchange="return getRozelleBulkOrder();"
									   class="textBoxA">
