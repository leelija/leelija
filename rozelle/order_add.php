...
{	
	...
	//add the Orders
	 $orders_id =  $rozelleOrder->addRozzeleOrders($txtDesignNo,$txtBookNo, $txtPartyName, $txtBrokar, $txtRetaHol, $txtForm, '',
		...
		for($i=0; $i < $selNum; $i++)
			{
				...
				$rozelleOrder->addRozOrderDtl($orders_id,$txtDesignNo,$txtBookNo,$txtPartyName, $_POST['txtQuantity'][$i],$_POST['txtQuantity'][$i],'',$_POST['txtColour'][$i],
