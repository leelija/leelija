...
$productDetail=$stock->stockDtlColor($sid);
...
<title><?php echo COMPANY_S; ?>Stock Details</title>
...
<h3><a name="editStock">stock Details</a></h3>
    
          
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						<tr class="listheader">
						
						<th class="listheader">SL No. </th>
						<th class="listheader">Stock Id </th>
						<th class="listheader">Design No. </th>
						<th class="listheader">Current Stock(pieces) </th>
						<th class="listheader">Colour</th>
						<th class="listheader">Added Date</th>
						...
						<?php 
							...
							<?php $reco_record = 0; 
							//echo "$data[2]";
							foreach( $productDetail as $eachrecord ){
						...
						<tr class="table-row" >
							...
							<td align="center"><?php echo $eachrecord ['stock_dtl_id']; ?></td>
							<td align="center"><?php echo $eachrecord ['stock_id']; ?></td>
						...
						?>
							...
							<div class="canbutton" style="float: right;">
