...
//$userData 	=  $adminLogin->getUserDetail($_SESSION[REP_SESS]);
...
if(isset($_POST['btnLogin']))
{
	...
	{
		$adminDtl	=	$adminLogin->getUserDetail($login);
		$adminLogin->valiReoptUSR($login, $password,$adminDtl[3], 'username', 'password','usertype', 'admin_users');
	}
}
?>
...
<head>
  ...
  <title>Report Panel | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index2.html"><b>Report</b>Panel</a>
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
      <div class="form-group has-feedback">
        <input type="text" name="txtLogin" class="form-control" placeholder="User name">
