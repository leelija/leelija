...
$cmpTranDtls	= $company->getCompTranData();
...
<title><?php echo COMPANY_S; ?> -Company Transaction Details</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="admin-top">
                	<h1>Company Transaction Details</h1>
                   <div class="cl"></div> 
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tr>
						 ...
						 <!-- <th width="3%" height="25"  align="center">Stock Id</th> -->
						  ...
						  <th width="10%" >Tran. Type </th>
						   <th width="10%" >CR/DR</th>
						  <th width="10%" >Balance</th>
						  <th width="10%" >Acc.Balance</th>
						  <th width="10%">Source/Purpose</th>
						  <th width="10%" >Payment Type</th>
						  <th width="10%" >Cheque No</th>
						  <th width="10%" >Notes</th>
						  <th width="10%" >Tran. By</th>
						  <th width="10%" >Tran. On</th>
						</tr>  
                        </thead>
						<tbody>
                       <?php 
                        ...
                        foreach($cmpTranDtls as $eachRecord)
                            {
							
							$bAccDtls 					= $company->showCompAcc($eachRecord['account_id']);
							$compDtls 					= $company->showCompDtls($bAccDtls[1]);
							//$compDtls 					= $company->showCompDtls($eachRecord['account_id']);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><a href=""><?php echo $compDtls[1]; ?>-<?php echo $bAccDtls[2]; ?></a></td>
					   <td align="center"><?php echo $eachRecord['tran_type']; ?></td>
					   <td align="center"><?php echo $eachRecord['cr_dr']; ?></td>
					   <td align="center"><?php echo $eachRecord['balance']; ?></td>
					   <td align="center"><?php echo $eachRecord['account_balance']; ?></td>
					   <td align="center"><?php echo $eachRecord['source_or_purpose']; ?></td>
					   <td align="center"><?php echo $eachRecord['payment_type']; ?></td>
					   <td align="center"><?php echo $eachRecord['cheque_no']; ?></td>
