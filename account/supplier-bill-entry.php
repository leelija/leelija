...
$sBillEntDtls	= $supplier->getSupplierBillData();
...
<title><?php echo COMPANY_S; ?> -Purchase Bill Details</title>
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="add-supplier-bill.php?action=add_suppBill#addSuppBill" >
                          Add Records				  
                        </a>
                    </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($sBillEntDtls as $eachRecord)
                            {
                    ...
                    ?>
					  ...
					  <!-- <td align="center">
						...
						<a href="pbillpayment.php?action=create_Tran&sbe_id=<?php echo $eachRecord['sbe_id']; ?>" >
							<?php// if($eachRecord['payment_status'] ==''){ echo "Payment";} else{ echo $eachRecord['payment_status'];}?>			  
                        </a>
					   </td>-->
						<td>
							<?php
							...
							?>
								<a style="color:red;" href="pbillpayment.php?action=create_Tran&sbe_id=<?php echo $eachRecord['sbe_id']; ?>" >
									Paid				  
								</a>
							<?php	
								}
