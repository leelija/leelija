...
{	
	...
	elseif($txtTranType =='withdraw' AND $txtBalance > $bAccDtls[4]){
		echo "Put the Valid Balance";
	}
	else
	{
		if($txtTranType == 'withdraw'){
		...
		$company->addCompTran($txtTranType, $txtPayType, $txtCheqeNo,$ca_id,$txtPurSource,$txtBalance,$crdr,$currBalance,$txtProdDesc,$userData[2]);
                ...
                <div class="webform-area">
					...
					?>
                        ...
                        <form action="<?php $_SERVER['PHP_SELF']?>?action=create_Tran&ca_id=<?php echo $ca_id; ?>" method="post" enctype="multipart/form-data">
                            <h2>Account Name: <span style="color: blue;"><?php echo $compDtls[1]; ?>-<?php echo $bAccDtls[2]; ?></span></h2>
							<div class="cl"></div>
							<div >
								<label>Transaction Type<span class="orangeLetter">*</span></label>							
								<select name="txtTranType" type="text" id="txtTranType" class="text_box_large">
                            ...
                            <input name="txtPurSource" type="text" class="text_box_large" id="txtPurSource" 
					        value="<?php $utility->printSess2('txtPurSource',''); ?>" size="25" />
                            <div class="cl"></div>
							<div >
