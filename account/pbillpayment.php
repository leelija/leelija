...
$sbe_id			= $utility->returnGetVar('sbe_id','0');
//User detail
$userData 		=  $customer->getCustDatabyEmail($_SESSION[ACC_SESS]);
$pBillDtls		=  $supplier->showSupplierBillEnt($sbe_id);
$suppDtls		=  $supplier->showSupplier($pBillDtls[1]);
...
{	
	...
	else
	{
		...
		$sbalance		= $suppDtls[6] - $txtBalance;
		...
		//add the Supplier Transaction Records
		$supplier->addSupplierTran($suppDtls[0], $txtPayType, $txtCheqeNo,$bAccDtls[0],$txtBalance,$txtProdDesc,$userData[2]);
		//Update Supplier Account
		$supplier->UpdateSupplier($pBillDtls[1],$suppDtls[1],$suppDtls[2], $suppDtls[3],$suppDtls[4],$suppDtls[5], $sbalance,$userData[2]);
		
		//Supplier Acc Details
		$suppAccDtls = $supplier->showSuppAccCompWise($pBillDtls[1],$bAccDtls[1]);
		$ctBalance 	= $suppAccDtls[3] - $txtBalance;
		$supplier->UpdateSuppAccBlnc($pBillDtls[1],$bAccDtls[1], $ctBalance);
		
		//add the Company Transaction Records
		$company->addCompTran('payment', $txtPayType, $txtCheqeNo,$bAccDtls[0],$suppDtls[1],$txtBalance,'dr',
		$currBalance,$txtProdDesc,$userData[2]);
	
		//Update Supplier bill
		$supplier->editSuppBill($sbe_id,'paid',$userData[2]);
		
		//deleting the sessions
		$utility->delSessArr($sess_arr);
		
		//forward the web page
		$uMesg->showSuccessT('success', 0, '', 'supplier-bill-entry.php', "Transaction has been successfully completed", 'SUCCESS');
	}
...
<title><?php echo COMPANY_S; ?> - Supplier Payment</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="admin-top">
                	<h1>Payment For Supplier: <?php echo $suppDtls[1];?>&nbsp;&nbsp;Bill No:<?php echo $pBillDtls[2];?> </h1>
                </div>
                ...
                <div class="webform-area">
					...
					?>
                        ...
                        <form action="<?php $_SERVER['PHP_SELF']?>?action=create_Tran&sbe_id=<?php echo $sbe_id; ?>" method="post" enctype="multipart/form-data">
                            <div class="cl"></div>
					        ...
					        value="<?php echo $pBillDtls[10]; ?>" size="25" />
                            <div class="cl"></div>
