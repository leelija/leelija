...
$custTranDtls	= $buyer->getCustTranData();
...
<title><?php echo COMPANY_S; ?> -Customer Transaction Details</title>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($custTranDtls as $eachRecord)
                            {
							
							$bAccDtls 					= $company->showCompAcc($eachRecord['cheque_issue_from']);
							$compDtls 					= $company->showCompDtls($bAccDtls[1]);
							//$compDetail 				= $company->showCompDtls($eachRecord['cheque_issue_from']);
							$custDtls					=  $buyer->showBuyer($eachRecord['pid']);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><a href=""><?php echo $custDtls[1]; ?></a></td>
