...
<title><?php echo COMPANY_S; ?> - Generate Vendor Payment Advice note</title>
...
<body>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="admin-top">
                	<h1>Generate Vendor Payment Advice</h1>
                </div>
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if(isset($_GET['action']) && ($_GET['action'] == 'addVPayAdvice')) 
					{	
					?>
						<br>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<div >
								<label>Vendor Name<span class="orangeLetter">*</span></label>							
									<select name="txtVenName[]" type="text" id="txtVenId" class="form-control select2">
										<option value="">Select Vendor Name</option>
										<?php
											$venDtls         = $vendor->getVendorData();
											foreach ($venDtls as $eachrecord){//Array or records stored in $row
											//echo $row[colour_name];
										?>	
											<option value="<?php echo $eachrecord['vid']?>"><?php echo $eachrecord['vcompany']?></option>
										<?php
							...
							<div class="cl"></div>
                            <div class="form-group" id="validate_chapter">
								<label>Select</label>
								<select id="ventbillNo" class="form-control input-sm" name="ventbillNo"> 
	...
	<!-- display chapter subjectwise-->
	<script>
	$( "#txtVenId" ).change(function( event ) {
	  var id = $( this ).val(),
	  param_data = { id : id },
	 // url = $("#frm_start_test").attr( "action" );
		//url = "vendor-bill.inc.php";
	  //alert(url);
	  $.get( url, param_data, function( data ) {
	   $('#ventbillNo').empty();	 
	   $('#ventbillNo')
