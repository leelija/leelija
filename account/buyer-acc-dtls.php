...
$buyerAccDtls	= $buyer->getBuyerAccData();
...
<title><?php echo COMPANY_S; ?> -Buyer Acc Details</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="admin-top">
                	<h1>Buyer Acc Details</h1>
                   <div class="cl"></div> 
                </div>
                
                <!-- Options --><br><br>
                <div id="options-area">
					<a href="../file_download.inc.php?table=buyer_acc_details">Download</a>
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($buyerAccDtls as $eachRecord)
                            {
							
							$compDetail 				= $company->showCompDtls($eachRecord['comp_acc']);
							$buyerDtl					= $buyer->showBuyer($eachRecord['party_id']);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><?php echo $buyerDtl[14]; ?></td>
