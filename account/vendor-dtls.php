...
$vendorDtls		= $vendor->getVendorData();
...
<title><?php echo COMPANY_S; ?> -Vendor Details</title>
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="add-new-vendor.php?action=add_Vendor#addVendor" >
                          Add Records				  
                        </a>
                    </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($vendorDtls as $eachRecord)
                            {
							
							$venTypeDtls 				= $vendor->showVendorType($eachRecord['ven_type']);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><a href=""><?php echo $eachRecord['vendor_name']; ?></a></td>
					   <td align="center"><?php echo $venTypeDtls[1]; ?></td>
					   <td align="center"><?php echo $eachRecord['vcompany']; ?></td>
					   <td align="center"><?php echo $eachRecord['vendor_address']; ?></td>
					   <td align="center"><?php echo $eachRecord['vendor_contact']; ?></td>
					   <td align="center"><?php echo $eachRecord['vendor_gst']; ?></td>
					   <td align="center"><?php echo $eachRecord['vbalance']; ?></td>
					   <td align="center"><?php echo $eachRecord['tds']; ?></td>
					   <td align="center">
						
						<a href="ven-tran.php?action=create_Tran&vbe_id=<?php echo $eachRecord['vid']; ?>" >
							Payment
						</a>
					   </td>
