...
<title><?php echo COMPANY_S; ?> -Customer Details</title>
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="add-customer.php?action=add_customer#addSupplier" >
                          Add Records				  
                        </a>
                    </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($buyerDtls as $eachRecord)
                            {
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><a href=""><?php echo $eachRecord['party_name']; ?></a></td>
					   <td align="center"><?php echo $eachRecord['company']; ?></td>
					   <td align="center"><?php echo $eachRecord['party_address']; ?></td>
					   <td align="center"><?php echo $eachRecord['party_city']; ?></td>
					   <td align="center"><?php echo $eachRecord['party_phone']; ?></td>
					   <td align="center"><?php echo $eachRecord['gst_no']; ?></td>
					   <td align="center"><?php echo $eachRecord['payment_due']; ?></td>
					   
					   <td align="center">
						
						<a href="customer-edit.php?action=create_edit&party_id=<?php echo $eachRecord['party_id']; ?>" >
							edit				  
                        </a>|
						<a href="cust-transaction.php?action=create_Tran&party_id=<?php echo $eachRecord['party_id']; ?>" >
							Payment				  
                        </a>
					   </td>
