...
<title><?php echo COMPANY_S; ?>View sample Manual Material</title>
...
<h3><a name="editStock">View Sample Manul Material</a></h3>
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						...
						<th class="listheader">Material Name </th>
						<th class="listheader">Material Amount</th>
						...
						<?php 
							...
							$SamManualDtl = $sample->getAllManualDtl($sid);
							?>	
							<?php $reco_record = 0; 
							//echo "$data[2]";
						...
						<!--	<td align="center">
							[ 
							<a href="#" 
							  onClick="MM_openBrWindow('sample_manual_delete.php?action=del_manual&sid=<?php //echo $eachrecord ['manual_id']; ?>','delManual','scrollbars=yes,width=400,height=400')">
							  Delete					  </a> ]
