        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
				<img src="../employee/images/photos/<?php echo $empData[12];?>" class="profile-user-img img-responsive img-circle" alt="User Image">
				<h3 class="profile-username text-center"><?php echo $empData[2];?></h3>
