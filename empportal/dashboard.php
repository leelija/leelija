				...
				<?php 
						...
						{   
							...
							foreach($sampleDtls as $eachRow)
							{
								...
								$pOrdDtls 	= $productOrder->getTwoMOnthDwOrder($designNo);
								
								foreach($pOrdDtls as $eachRowff)
									{
										$pipeOrdQty		= $eachRowff['SUM(due_quantity)'];
										$tOrdQuantity	+= $pipeOrdQty;
										//echo $tOrdQuantity; exit;
									}
							}
						?>	
							<h3><?php echo $tOrdQuantity;?><sup style="font-size: 20px"></sup></h3>
							<p>Due Order</p>
						<?php
						}
						?>	
				...
				<?php 
						...
						{   
							...
							foreach($sampleDtls as $eachRow)
							{
								...
								foreach($pSalesDtls as $eachRowSales)
									{
										$pSalesQty		= $eachRowSales['SUM(sales)'];
										$tSalesQuantity	+= $pSalesQty;
										//echo $tOrdQuantity; exit;
									}
							}
						?>	
							<h3><?php echo $tSalesQuantity;?><sup style="font-size: 20px"></sup></h3>
							<p>Sales Quantity</p>
            ...
            <div class="inner">
				...
				<?php 
						...
						{   
							...
							{
								$designNo 	= $eachRow['design_no'];
								$sProdDtls 	= $productStock->getProdStatDwCount($designNo);
								
								foreach($sProdDtls as $eachRowS)
									{
										$pSalesQty		= $eachRowS['SUM(sales)'];
										$pNSalesQty		= $eachRowS['SUM(net_sales)'];
										$tSalesQuantity	+= $pSalesQty;
										$tNSalesQuantity += $pNSalesQty;
										
										//echo $tOrdQuantity; exit;
									}
							}
						?>	
							<h3><?php echo $tNSalesQuantity;?><sup style="font-size: 20px"></sup></h3>
							<p>Net Sales</p>
          ...
          <div class="small-box bg-red">
            <div class="inner">
				...
				<?php 
						...
						?>	
							<h3><?php $gr = $tSalesQuantity - $tNSalesQuantity; echo $gr;?><sup style="font-size: 20px"></sup></h3>
							<p>GR Products</p>
        ...
        <section class="col-lg-7 connectedSortable">
          ...
          <div class="box box-primary">
            <div class="box-header">
              ...
              <h3 class="box-title">My Planning List</h3>
