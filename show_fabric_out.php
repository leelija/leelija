...
$fabric_out_id		= $utility->returnGetVar('fabric_out_id','');
...
{
	$link = "&btnSearch=search&fabric_out_id=".$_GET['fabric_out_id']."&mode=&type=".$_GET['type'];
	$fid = $search_obj->getProductKeyword($fabric_out_id);
	
}
else
{
	$link = '';
	$fid = $fabric->getAllFabricOut('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="data-column">
                    ...
                    ?>  
                    <thead>
                      <th width="3%" height="25"  align="center">Fabric Out Id</th>
					  <th width="10%" >Order Id</th>
                      <th width="10%" >Fabric Name </th>
                      <th width="10%" >fabric(meter)</th>
					...
					<?php
                       ...
                       $fid = array_slice($fid, $start, $limit);     
                        foreach($fid as $x)
							...
							$fabricOutDetail = $fabric->showFabricOut($x);
                    ...
                    ?>
					  ...
					  <td align="center"><?php echo $fabricOutDetail[13]; ?></td>
					  <td align="center"><?php echo $fabricOutDetail[1]; ?></td>
					   <td align="center"><?php echo $fabricOutDetail[2]; ?></td>
					   <td align="center"><?php echo $fabricOutDetail[3]; ?></td>
					   <td align="center"><?php echo $fabricOutDetail[4]; ?></td>
					   <td align="center"><?php echo $fabricOutDetail[5]; ?></td>
					   <td align="center"><?php echo $fabricOutDetail[7]; ?></td>
					   <td align="center"><?php echo $fabricOutDetail[8]; ?></td>
					   <td align="center"><?php echo $fabricOutDetail[9]; ?></td>
