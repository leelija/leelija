...
{
	$link = '';
	$arid = $altrate->getAllAlterRateAll('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  - alter rate</title>
<!-- Style -->
                ...
                <div id="data-column">
                    ...
                    <thead>
                      ...
                      <th width="10%" >Particulars</th>
					   <th width="10%" >Alter Rate(RS.)</th>
                 <!--     <th width="15%" align="center">Action</th>-->
                   </thead>
					<?php
                        
                       $k = $pages->getPageSerialNum($numResDisplay);
                       $rid = array_slice($arid, $start, $limit);     
                        foreach($rid as $x)
                            {
							//$x = $pageArray[$pageNumber][$j];
							
							$AltRateDtl = $altrate->showAlterRate($x);
							//print_r($prodDetail);exit;
							$bgColor 	= $utility->getRowColor($k);	
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   <!--<td align="left"><?php //echo $AltRateDtl[0]; ?></td>-->
					   <td align="left"><?php echo $k++; ?></td>
					   <td align="center"><?php echo $AltRateDtl[1]; ?></td>
					   <td align="center"><?php echo $AltRateDtl[2]; ?></td>
					   <td align="center"><?php echo $AltRateDtl[3]; ?></td>
                  ...
                  <div class="first-column">
                        ...
                        <div class="pagination-bottom">
                            <div class="upper-block">Total Alter Rate(s): <?php echo count($arid);?></div>
                         <?php echo $pagination ?>
                        </div>
