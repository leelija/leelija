                        ...
                        <thead>
                          ...
                          <th width="22%">Action</th>
                            ...
                            <tr <?php //$utility->printRowColor($bgColor);?>>
                              ...
                              [
                              <a href="javascript:void(0)" 
                              onClick="MM_openBrWindow('client-edit.php?action=edit_user&cus_id=<?php echo $userId; ?>','CustomerEdit','scrollbars=yes,width=700,height=650')">edit</a>					  
                              ]
                        ...
                        <?php 
						 ...
						 ?>
                         	<div class="detail-block">
                                ...
                                <p><label>Customer Type</label> <?php echo $cusDtl[0]; ?> </p>
                                ...
                                <p><label>Profession</label> <?php echo $cusDtl[14]; ?> </p>
