...
<title><?php echo COMPANY_S; ?> -  - Delete product in </title>
...
<table class="tblBrd" align="center" width="100%">
    ...
    {
        $productInDetails = $stock->showProductIn($sid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Product In :: <?php echo $productInDetails[0]; ?></h3></td>
    </tr>
    <tr>
      <td>
