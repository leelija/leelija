...
{
	$link = '';
	$fid = $fabric->getAllFabricIn('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="data-column">
                    ...
                    ?>  
                    <thead>
                      <th width="3%" height="25"  align="center">Fabric In Id</th>
                    ...
                    ?>
					  ...
					  <td align="center"><?php echo $fabricInDetail[1]; ?></td>
					   ...
					   <td align="center"><?php echo $fabricInDetail[4]; ?></td>
					   ...
					   <td align="center"><?php echo $fabricInDetail[9]; ?></td>
