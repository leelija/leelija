...
$rCompBilldata 	= $bill->showRFRIBill('mep_comp_bbook');
...
<title><?php echo COMPANY_S; ?> - Computer Bill Details</title>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tbody>
						   <?php 
							$sl=1;   
							foreach($rCompBilldata as $eachRecord)
								{
						...
						?>
							<tr align="left"<?php $utility->printRowColor($bgColor);?>>
								...
								<td>
									<p 
									onClick="MM_openBrWindow('mcomp-bill-review.php?action=bill-review&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									View					  
									</p> 
									<p 
									onClick="MM_openBrWindow('add-mcomp-material.php?action=add-material&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									Add Material					  
									</p> 
									<p 
									onClick="MM_openBrWindow('update-rcomp-bill.php?action=bill-update&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','align=right','scrollbars=yes,width=450,height=600')">
									Payment					  
									</p>
								</td>
							</tr>
