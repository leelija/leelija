function getSampFbBill()
{
//alert("Hi..");
	//var sid	= sid
	var selNum = document.getElementById("selNum").value;
	var url= "sfab_bill.inc.php?selNum=" + escape(selNum);
	...
	document.getElementById('showSampFabBill').innerHTML=
...
function geOrderColour()
{
	...
	if(request.readyState == 4)
	{
		...
		if(request.status == 200)
		{
			...
			document.getElementById("showSampFabBill").innerHTML = xmlResponse;
		}
