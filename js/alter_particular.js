...
//alert("Hi..");
	...
	var url= "alter_particular.inc.php?selNum=" + escape(selNum);
	...
	document.getElementById('showAlterParticular').innerHTML=
...
function geAlterParticular()
{
	...
	if(request.readyState == 4)
	{
		...
		if(request.status == 200)
		{
			...
			document.getElementById("showAlterParticular").innerHTML = xmlResponse;
		}
