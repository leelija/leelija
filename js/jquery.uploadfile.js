...
//			sd.submitDiv.show();
        ...
        function setDragDropHandlers(obj, s, ddObj) 
		{
            ...
            $(document).on('dragover', function (e) {
                e.stopPropagation();
                e.preventDefault();
                ddObj.css('border', '1px solid #ddd');
            });
        ...
        function serializeAndUploadFiles(s, obj, files) 
		{
            ...
            for(var i = 0; i < files.length; i++) 
			{
                ...
                var pd = new createProgressDiv(obj, s);	//preview images
                var fileNameStr = "";
				...
				var inputField = $("<input type='hidden' id=image-'" + i + "' name=image-'" + i +"' value='" + files[i] +"' />");
                form.appendTo('body');
				inputField.appendTo('body');
                var fileArray = [];
                fileArray.push(files[i].name);
                ajaxFormSubmit(form, ts, pd, fileArray, obj, files[i]);
                obj.fileCounter++;
				//var json_i = JSON.stringify(files[i]);
				//alert(json_i);
            }
			//var fileInStr = "<input type='hidden' id= 'hiddenField'  name= 'getImageNo'  value= '"+ i +"'/>";
			 //window.location.href = "drag-drop.php?w2=" + i;
...
//				}
			 ...
			 document.getElementById("hiddenField").value = i;
			 var json_text = JSON.stringify(files);
			 //alert(json_text);
			 //var json_text = arr.toString();
			 document.getElementById("hiddenJason").value = json_text;
			 //alert(document.getElementById("hiddenJason").value);
        }
        ...
        function createProgressDiv(obj, s) {
            ...
            this.abort = $("<div class='ajax-file-upload-red ajax-file-upload-abort " + obj.formGroup + "'>" + s.abortStr + "</div>").appendTo(this.statusbar)
                .hide();
            this.cancel = $("<div class='ajax-file-upload-cancelbtn ajax-file-upload-cancel " + obj.formGroup + "'>" + 
		...
		function createSubmitDiv(obj,s) 
		{
			this.submitDiv = $("<div class='ajax-file-upload-green'>" + s.submitStr + "</div>").width(100).hide();
			return this;
		} 
