function getFabricRate()
{
	//alert('hi..');
	var selNum = document.getElementById("selNum").value;
	var url= "prod-fab-rate.php?selNum=" + escape(selNum);
	...
	document.getElementById('showFabricRate').innerHTML=
...
function getDescRes()
{
	...
	if(request.readyState == 4)
	{
		...
		if(request.status == 200)
		{
			...
			document.getElementById("showFabricRate").innerHTML = xmlResponse;
		}
