    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="admin-top">
                	<h1>Stock Product Sales Details</h1>
                ...
                <!--	<div class="add-new-option">
					...
					<a href="sales_download.php">Download</a>
                </div>
                <!-- eof Options -->
                ...
                <div id="data-column">
					...
					<!--  <td >
					    [ 
					  <a href="#" onClick="MM_openBrWindow('sales_edit.php?action=sales_edit&sid=<?php echo $productSalesDetail[0]; ?>','OrdDelete','scrollbars=yes,width=700,height=500')">
					  Edit					  </a> ]<br>
