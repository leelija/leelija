...
$productInDetail = $productStock->stockProdInData();
...
<title><?php echo COMPANY_S; ?> - Stock Products Add details</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
				...
				<div id="admin-top">
                	<h1>Stock Products Add Details</h1>
                   <div class="cl"></div> 
                </div>
                
                <!-- Options --><br><br><br><br>
                <div id="options-area">
					<a href="../file_download.inc.php?table=stock_product_in">Download</a>
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($productInDetail as $eachRecord)
                            {
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   <td align="left"><?php echo $eachRecord['product_in_id']; ?></td>
					   <td align="center"><?php echo $eachRecord['design_no']; ?></td>
					   <td align="center"><?php echo $eachRecord['bil_no']; ?></td>
