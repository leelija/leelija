...
$productReturnDetail 	= $productStock->showStockProdReturn($gd_id);
$stockDetails 			= $productStock->showProductStock($productReturnDetail[1]);
...
if($txtProductIn == '')
	...
	{
		//edit stock product
	    $productStock->editStockProduct($stockDetails[0],$stockDetails[1], $txtStock, $totalProdIn, $stockDetails[4], $stockDetails[12], $goodsReturn,
				...
				if($productReturnDetail[3] == $eachrecord['colour'] && $stockDetails[1] == $eachrecord['design_no'])
					{
						...
						$productStock->editstockProdDetails($eachrecord['stock_dtl_id'],$stockDetails[0],$stockDetails[1], $productReturnDetail[3], $total_quantity,$total_quantity_in,
					...
					// gd return edit
					$productStock->editStockProdreturn($gd_id, $stockDetails[0],$goodsReturn,$productReturnDetail[3],$productReturnDetail[4], $productReturnDetail[5]
					, $ReadygoodsReturn,'');
...
<title><?php echo COMPANY_S; ?> -  - Product Return</title>
