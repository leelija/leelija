...
$shopProdOut	= $rozStock->ShoProdsOutShow();
...
<title><?php echo COMPANY_S; ?> - Shop Products  Out</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
				...
				<div id="admin-top">
                	<h1>Shop Products Out Details</h1>
                   <div class="cl"></div> 
				...
				<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($shopProdOut as $eachRecord)
                            {
						...
						<tr align="left"<?php $utility->printRowColor($bgColor);?>>
							...
							<td align="center"><?php echo $eachRecord['outqty']; ?></td>
