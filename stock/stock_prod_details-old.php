...
//echo $keyword;exit;
	$link = '';
	$sid = $search_obj->getStockDtlKeyword($keyword);
	//echo $sid;exit;
}
else
{
	$link = '';
	$sid = $productStock->getAllStockProdDetails('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  Stock products Details</title>
<!-- Style -->
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="options-area">
					...
					<a href="stock_details_download.php">Download</a>
                </div>
                <!-- eof Options -->
                ...
                <div id="data-column">
                    ...
                    <thead>
                      ...
                      <th width="10%" >Current Stock(pieces)</th>
               ...
               <!--       <th width="15%" align="center">Action</th> -->
					...
					<?php
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							$productDetail = $productStock->showStockProdDetails($x);
                    ...
                    ?>
					  ...
					  <td align="center" ><?php echo $productDetail[0]; ?></td>
					   <td><?php echo $productDetail[1]; ?></td>
					   <td><?php echo $productDetail[3]; ?></td>
					    <td align="center"><?php echo $productDetail[2]; ?></td>
						
						<td align="center" ><?php echo $productDetail[9]; ?></td>
					   <td><?php echo $productDetail[10]; ?></td>
					   <td><?php echo $productDetail[11]; ?></td>
					    <td align="center"><?php echo $productDetail[12]; ?></td>
						<td align="center"><?php echo $productDetail[4]; ?></td>
						
					 
					 
					<!--   [ 
					  <a href="#" onClick="MM_openBrWindow('stock_details_edit.php?action=stock_edit&sid=<?php //echo $productDetail[8]; ?>','OrdDelete','scrollbars=yes,width=700,height=500')">
					  Edit					  </a> ]<br> -->
					  <td >
					  [ 
					  <a href="#" onClick="MM_openBrWindow('stock_prod_details_delete.php?action=del_sid&sid=<?php echo $productDetail[8]; ?>','OrdDelete','scrollbars=yes,width=400,height=350')">
					  delete					  </a> ]<br>
