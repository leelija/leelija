...
if(isset($_POST['btnLogin']))
{
	...
	else
	{
		...
		$Login->validateStock($login, $password, 'email', 'password', 'customer');
...
<title>Products Stock Maintenance </title>
...
<body>
   ...
   <!-- <div id="header">
    ...
    <div id="crm-login-page-heading-back">
    	<h1>Sign in to manage <?php echo COMPANY_S; ?>MEP Products Stock</h1>
    </div>
    <!-- eof Page Heading -->
	...
	<div id="adminPanelLogin">
    	...
    	<div id="loginBox">
        	<h2>MEP Products Stock Maintenance</h2>
