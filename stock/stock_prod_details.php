    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <!-- Options --><br><br><br><br>
                <div id="options-area">
					<a href="download_excel.php?table=stock_products_details">Download</a>
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($stockProdDetail as $eachRecord)
                            {
							
							
							$grDtls 				= $productStock->showTGrProdClWise($eachRecord['stock_id'],$eachRecord['colour']);
							...
							$productStock->editProdstocDtlskNsales($eachRecord['stock_dtl_id'], $netsales);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><?php echo $eachRecord['quantity_in']; ?></td>
					   <td align="center"><?php echo $eachRecord['sales']; ?></td>
					   <td align="center"><?php echo $netsales; ?></td>
					   <td align="center"><?php echo $eachRecord['quantity_return']; ?></td>
