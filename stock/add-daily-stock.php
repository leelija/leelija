...
require_once("../classes/hmda_stock.class.php"); 
...
{	
	...
	$txtContainer		= $_POST['txtContainer'];
	...
	elseif($txtContainer == ''){
		$error->showErrorTA($action, $id, $id_var, $url, "Container Name Empty", $typeM, $anchor);
	}
	elseif($txtNumber == ''){
		$error->showErrorTA($action, $id, $id_var, $url, "Container Number Empty", $typeM, $anchor);
	}
	else
	{
		// Add Stock
		$dailyStock->addLiveStock($txtDesignNo,$txtContainer, $txtNumber, $txtStock,$userData[2]);
    ...
    <div class="webform-area">		
        ...
        <form action="<?php $_SERVER['PHP_SELF']?>?action=add_prod" method="post" enctype="multipart/form-data">
            ...
            <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">	
				...
				<div >
					<label>Container<span class="orangeLetter">*</span></label>							
						<select name="txtContainer" type="text" id="txtContainer" class="text_box_large">
							<option value="Rack">Rack</option> 
							<option value="Katton">Katton</option> 
						</select>
				</div>
                
				<div class="cl"></div>
				<label>Number<span class="orangeLetter">*</span></label>
                <input name="txtNumber" type="text" class="text_box_large" id="txtNumber" size="25" />
                <div class="cl"></div>
							
				<label>Stock (Pcs.)<span class="orangeLetter">*</span></label>
