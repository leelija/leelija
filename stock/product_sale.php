				...
				if($txtProdColour == $eachrecord['colour'] && $txtDesignNo == $eachrecord['design_no'])
					{
						...
						$netSales 		= $eachrecord['net_sales'] + $txtProductIn;
						if($total_quantity >= 0){
						// stock product Details edit
						$productStock->editstockProdDetails($eachrecord['stock_dtl_id'],$stockDetails[0],$txtDesignNo, $eachrecord['colour'], $total_quantity,$eachrecord['quantity_in'],
						...
						//edit stock product
						$productStock->editStockProduct($stockDetails[0],$txtDesignNo, $txtStock, $stockDetails[3], $totalSales, $net_sales, $stockDetails[5],
						$stockDetails[6], $stockDetails[7],'');	
						
						// add stock product sales
						$productStock->addStockProdSales($txtDesignNo, $txtProductIn,$txtProdColour, $txtCompanyName, $txtAddress , $txtContactNo , $txtProdDesc, $ProStat, $userData[2]);
					...
					<!--================show product details end--========================-->		
							...
							<tr>
								<label>Select No. of colours</label>
									...
									?>
									  <select name="selNum" id="selNum" onchange="return getAllProductsSale(<?php echo $sid; ?>);"
									   class="textBoxA">
								...
								<div class="cl"></div>
								<div id="showProductsSaleDetails"></div>
                            <div class="cl"></div>
						...
						-->	
							...
							<select name="ProStat" id="ProStat" class="textBoxA">
...
<?php /*?>                            <label>Tax</label>
                ...
                <input name="btnEditOrd" type="submit" class="button-add"  value="Sales" />
