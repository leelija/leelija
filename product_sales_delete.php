...
<title><?php echo COMPANY_S; ?> -  - Delete product Sales </title>
...
<table class="tblBrd" align="center" width="100%">
    ...
    {
        $productInDetails = $stock->showProductSales($sid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Product Sales :: <?php echo $productInDetails[0]; ?></h3></td>
    </tr>
    <tr>
      <td>
