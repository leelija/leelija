...
<body> 
			...
			<div class="modal-body" style="font-size:9px;">
				<table class="single-column" cellpadding="0" cellspacing="0" border="1">
										...
										<thead>
										  ...
										  <th width="5%" >Area</th>
										  <th width="5%"  >Due(Qty)</th>
										  <th width="5%"  >Due(Stitch)</th>
									...
									?>
									   ...
									   <?php
										...
										<td align="center"><?php echo $eachRecord['marea']; ?></td>
										<td align="center"><?php echo $eachRecord['quantity']; ?></td>
										<td align="center"><?php echo $tstcAmount;?></td>
			...
			<div class="modal-body" style="font-size:9px;">
				<table class="single-column" cellpadding="0" cellspacing="0" border="1">
						<thead>
							...
							<th width="20%">Due Billing Amount(Rs.)</th>
							<th width="20%" >Due Stitch</th>
					...
					<?php	if($gTotal > 0){?>
						...
						<td align="center"><?php echo ($tStitchAmount/8000000); ?></td>
					<?php
						}
					?>	
					<?php		
	...
	<div class="col-md-2">
	  <div class="w_sidebar">
		...
		<a href="mep-computer.php">MEP Computer</a><br>
