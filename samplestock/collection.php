...
{
	$link = '';
	$pgid = $photogallery->getAllSampeGl('sample_gallery_id','DESC',1,8);
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
						...
						<?php 
							...
							?>
								<div class="col-md-4 grid-4" grid-in>
									<a href="gproducts-details.php?sgid=<?php echo $sphotoGalleryDetail[0]; ?>" target="null">
			...
			<!---Right Div Start-->
     		<div class="col-md-3 product_right">
				...
				<ul class="nav nav-tabs">
					<li class="active"><a data-toggle="tab" href="#home">MEP</a></li>
