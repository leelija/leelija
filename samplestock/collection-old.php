...
$numResDisplay	= (int)$utility->returnGetVar('numResDisplay', 120);
		...
		<div class="products_top">
			...
			<!---->
				...
				<div class="tab-content"><!--Start tab-->
						...
						<?php 
							...
							?>
								<div class="col-md-4 grid-4" grid-in>
									<a href="gproducts-details.php?sgid=<?php echo $sphotoGalleryDetail[0]; ?>" >
					...
					<?php	$pgid = $photogallery->getAllSampeGl('sample_gallery_id','DESC',2);?>
						<!---->
						<div class="product_box1">   
						<?php 
							if(count($pgid) == 0)
							...
							?>
								<div class="col-md-4 grid-4" grid-in>
									...
									<div class="tab_desc1">
										...
										<p>Due Order-><?php echo $eachRow['SUM(due_quantity)'];?></p>
