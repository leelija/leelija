...
if(isset($_POST['btnLogin']))
{
	...
	else
	{
		...
		$Login->validateRozProduction($login, $password, 'email', 'password', 'customer');
...
<title>HMDA Products Maintenance </title>
...
<body>
   ...
   <!-- <div id="header">
    ...
    <div id="crm-login-page-heading-back">
    	<h1>Sign in to manage <?php echo COMPANY_S; ?>MEP Products</h1>
    </div>
    <!-- eof Page Heading -->
	...
	<div id="adminPanelLogin">
    	...
    	<div id="loginBox">
        	<h2>MEP Products Maintenance</h2>
