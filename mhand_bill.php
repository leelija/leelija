...
$rHandBilldata 	= $bill->showRFRIBill('mep_hand_bbook');
                	...
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						?>
							<tr align="left"<?php $utility->printRowColor($bgColor);?>>
								...
								<td>
									<p 
									onClick="MM_openBrWindow('mhand-bill-review.php?action=bill-review&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									View					  
									</p> 
									<p 
									...
									<p 
									onClick="MM_openBrWindow('#?action=bill-update&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=450,height=600')">
									Update Payment					  
									</p>
