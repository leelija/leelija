...
$rStitchBilldata = $bill->showRFRIBill('rfri_fs_bbook');
...
<title><?php echo COMPANY_S; ?> - Stitch Bill Details</title>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tbody>
						   <?php 
							$sl=1;   
							foreach($rStitchBilldata as $eachRecord)
								{
						...
						?>
							<tr align="left"<?php $utility->printRowColor($bgColor);?>>
								...
								<td>
									<p 
									onClick="MM_openBrWindow('rstitch-bill-review.php?action=bill-review&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									View					  
									</p> 
								</td>
							</tr>
