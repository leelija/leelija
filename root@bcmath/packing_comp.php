...
$stockInData 	= $productStock->stockCompInData($bid);



?>

<title><?php echo COMPANY_S; ?>View Packing Complete Details</title>
...
<h3><a name="editStock">View Packing Complete Details</a></h3>
