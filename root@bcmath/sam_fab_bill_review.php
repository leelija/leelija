...
<!-- /TinyMCE -->
    ...
    <div class="webform-area">		
        ...
        if( (isset($_GET['action'])) && ($_GET['action'] == 'bill-review') )
        {
			...
			$sampFabBillDetails  	= $bill->showSampFabBillDtl($bid);
			
			$sampFabBill 			= $bill->allSampleFabBill($bid);
			$bDate					= date_create($sampFabBill[9]);
			
			$ordDate				= date_create($sampFabBill[5]);
			$trdDate				= date_create($sampFabBill[6]);
        ...
        ?>
			...
			<div id="PrintForm" style="padding-left:60px;"><!-- start Print -->
				...
				<div style="width: 100%;">
					<p style="width: 50%; float: left;">No.: <b><?php echo $bid;?></b></p> 
				...
				<p style="border-bottom: 1px dashed #999;">Messrs &nbsp;<?php echo $sampFabBill[2]; ?>&nbsp;</p>
                ...
                <div id="data-column" style="position:relative; bottom: 9px; font-size:12px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tbody>
						   <?php 
							$sl=1;  
							$tAmount 		= 0;
							foreach($sampFabBillDetails as $eachRecord)
								{
						...
						?>
							<tr width="100%" class="single-column" cellpadding="0" cellspacing="0">
								...
								<td style="text-align:center;border: solid 1px #000;"><?php echo $eachRecord['fabric']; ?></td>
								<td style="text-align:center;border: solid 1px #000;"><?php echo $eachRecord['fcolour']; ?></td>
								<td style="text-align:center;border: solid 1px #000;"><?php echo $eachRecord['fab_quantity']; ?></td>
								<td style="text-align:center;border: solid 1px #000;"><?php echo $eachRecord['frate']; ?></td>
					...
					<h3>Remark: <?php echo $sampFabBill[7];?></h3>
				...
				<div style="width: 100%;">
					...
					<p style="width: 48%;float:right; text-align: right;">Bill By <b><?php echo $sampFabBill[8];?></b></p>
				</div>
