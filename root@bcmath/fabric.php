...
if((isset($_GET['btnSearch'])) &&($_GET['btnSearch'] == 'search'))
{
	...
	$fid = $search_obj->getProductKeyword($keyword);
	
}
else
{
	$link = '';
	$fid = $fabric->getAllFabric('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="data-column">
                    ...
                    ?>  
                    <thead>
                      <th width="3%" height="25"  align="center">Fabric Id</th>
                    ...
                    ?>
					  ...
					  <td align="left"><?php echo $fabricDetail[0]; ?></td>
