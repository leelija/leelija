...
else
{
	...
	$sid = $statusCat->getAllComputerComp('added_on','DESC',$userId);
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
        ...
        <div class="inner-container">
					...
					<!--	  <th width="5%" >Computer Id</th>
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							$tQty 			= $statusCatDetail[7] + $statusCatDetail[15];
							if($statusCatDetail[20] == "Multi" OR $statusCatDetail[20] == "Embroidery" ){
								$tstcAmount = ($tQty * $statusCatDetail[23] * 100) / .8 ;
							}else{
								$tstcAmount = ($tQty * $statusCatDetail[23] * 100) / 1.6 ;
							}
			...
			<!--		  <td align="left"><?php //echo $statusCatDetail[0]; ?></td>
					  <td align="center"><?php //echo $statusCatDetail[1]; ?></td>    -->
					   ...
					   <td><?php echo $statusCatDetail[19]; ?></td>
					   ...
					   <?php
						...
						if($statusCatDetail[7]>0)
						   ...
						   ?>
						<td><?php echo $statusCatDetail[20]; ?></td>	
						<td><?php echo $statusCatDetail[22]; ?></td>  
					   	<td><?php echo $statusCatDetail[18]; ?></td>
						
						<td><?php echo $tstcAmount; ?></td>
