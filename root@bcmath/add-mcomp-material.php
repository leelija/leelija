	...
	for($i=0; $i < $selNum; $i++)
		{
			...
			if($material == '')
				...
				elseif($matRate == '')
				{
					...
					$bill->addBillMat($bid,$material,$matUnit,$matAmount,$matRate,$tAmount, $customerDtl[2],'mcomputer_bill_material');
				}
...
<title><?php echo COMPANY_S; ?> -  - Add Computer Material</title>
...
<!-- /TinyMCE -->
	...
	<h2><a name="editStock">Add New Record</a></h2>
		<h2><a name="addUser">Bill Id:C<?php echo $bid; ?> </a></h2>
