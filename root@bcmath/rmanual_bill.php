...
$rDyeBilldata 	= $bill->showRFRIBill('rfri_manual_bbook');
                	...
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						?>
							<tr align="left"<?php $utility->printRowColor($bgColor);?>>
								...
								<td>
									<p 
									onClick="MM_openBrWindow('rmanual-bill-review.php?action=bill-review&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									View					  
									</p> 
									<p 
									onClick="MM_openBrWindow('add-manual-material.php?action=add-material&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									Add Material					  
									</p> 
