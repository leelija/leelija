	...
	for($i=0; $i < $selNum; $i++)
		{
			...
			if($material == '')
				...
				elseif($matRate == '')
				{
					...
					$bill->addBillMat($bid,$material,$matUnit,$matAmount,$matRate,$tAmount, $customerDtl[2],'manual_bill_material');
				}
...
<title><?php echo COMPANY_S; ?> -  - Add Manual Material</title>
...
<!-- /TinyMCE -->
	...
	<h2><a name="editStock">Add New Record</a></h2>
		<h2><a name="addUser">Bill Id:M<?php echo $bid; ?> </a></h2>
