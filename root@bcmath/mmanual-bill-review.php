...
<title><?php echo COMPANY_S; ?> -  Manual Bill Review</title>
...
<!-- /TinyMCE -->
    ...
    <div class="webform-area">		
        ...
        {
            $billNo					= "M".$bid."";
			$manualDetails  		= $statCat->disPlTableDtls($billNo,'manual_table');
			$billDtl 				= $bill->allRFRIBillTable($bid,'mep_manual_bbook');
			//factory details
        ...
        ?>
			...
			<div id="PrintForm" style="padding-left:60px;"><!-- start Print -->
				...
				<div style="width: 100%;">
					<p style="width: 50%; float: left;">No.: <b>M<?php echo $bid;?></b></p> 
					<p style="width: 48%;float:right; text-align: right;">Date: <?php echo date_format($bDate,"d/m/Y"); ?></p>
				</div>
				<h1 style="text-align:center;text-decoration: underline;color:#000;">Moni ENterprises </h1>
                ...
                <div id="data-column" style="position:relative; bottom: 9px; font-size:12px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tbody>
						   <?php 
							$sl=1;  
							$tquantity 		= 0;
							foreach($manualDetails as $eachRecord)
								{
					...
					<!--<div class="tBillTitle" style="background:#ddd; height: 30px;">
						...
						<p class="rtotal" style="width: 45%; float: right;position: relative;left: 205px;"><b><?php echo $tquantity;?></b></p>
					</div>
					-->
                ...
                <div id="data-column" style="position:relative; bottom: 9px; font-size:12px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                        <!-- display option -->
                        <?php 
						$sManualEmbDtls		= $sample->getManualEmbDtl($designNo);	
						if(count($sManualEmbDtls) == 0)
						{
						?>
                        <tr align="left" class="orangeLetter">
                          <td height="20" colspan="5"> <?php echo "Table is empty"; ?></td>
						...
						<tbody>
						   <?php 
							$sl=1;  
							$tAmount 		= 0;
							foreach($sManualEmbDtls as $eachRecord)
								{
								$bgColor 	 	= $utility->getRowColor($sl);
					...
					<div class="tBillTitle" style="background:#ddd; height: 30px;">
						<p class="ltotal" style="width:50%; float:left;">Total Amount For 1 piece</p>
					...
					<?php $TotalAmount 		= $tquantity * $tAmount; ?>
					<b><p style="font-size: 16px;">Total Amount(<?php echo $tquantity;?>Piece) : <?php echo $TotalAmount;?></p></b>
                    <div class="first-column">
					</div>
                </div> <!-- Display Data End-->
                ...
                <div id="data-column" style="position:relative; bottom: 9px; font-size:12px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                        <!-- display option -->
                        <?php 
							$billMatDtls  	= $bill->showBillMat($bid,'manual_bill_material');	
