    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
				...
				<div id="admin-top">
                	<h1>Sample Fabric Bill Details</h1>
                   <div class="cl"></div> 
                </div>
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="<?php echo "sfab_bill_add.php"."?action=add_fbill"; ?>">
                            Add New Bill
                        </a> 
                    </div>
				</div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tbody>
						   <?php 
							$sl=1;   
							foreach($samFabBilldata as $eachRecord)
								{
						...
						?>
							<tr align="left"<?php $utility->printRowColor($bgColor);?>>
								...
								<td>
									<p 
									onClick="MM_openBrWindow('sam_fab_bill_review.php?action=bill-review&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									View					  
									</p> 
								</td>
							</tr>
