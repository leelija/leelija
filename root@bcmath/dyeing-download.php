...
//$noOfOrd		= array();
$numResDisplay	= (int)$utility->returnGetVar('numResDisplay', 10000);
...
else
{
	...
	$sid = $statusCat->getAllDyeingForDWN('added_on','DESC',$userId);
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
        ...
        <div class="inner-container">
			...
			<!--		  <td align="left"><?php //echo $statusCatDetail[0]; ?></td>
                      ...
                      <?php echo $statusCatDetail[2]; ?>	 </a> 
					   ...
					   <td><?php echo $statusCatDetail[4]; ?></td>
