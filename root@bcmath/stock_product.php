...
{
	$link = '';
	$sid = $stock->getAllStock('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  stock Management</title>
<!-- Style -->
            ...
            <div id="admin-body">
                ...
                <div id="data-column">
                    ...
                    ?>
					  ...
					  <td align="left"><?php echo $stockDetail[0]; ?></td>
					  <td align="center" ><?php echo $stockDetail[1]; ?></td>
					   <td><?php echo $stockDetail[2]; ?></td>
						...
						<td align="center"><?php echo $stockDetail[6]; ?></td>
						 <td align="center"><?php echo $stockDetail[8]; ?></td>
						
					 
					  <td >
					   [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('stock_prod_in.php?action=edit_sid&sid=<?php echo $x; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
					  Product In					  </a> ]
					 
					   [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('product_sale.php?action=edit_sid&sid=<?php echo $x; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
					  Sales					  </a> ]
					  
					  [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('goods_return.php?action=edit_sid&sid=<?php echo $x; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
					  GR					  </a> ]
					  
                   <!--   [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('greturn_update.php?action=edit_sid&sid=<?php //echo $x; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
					  GR Update					  </a> ]  -->
				...
				<!--	 <a href="#" 
					  ...
					  [ 
					  <a href="#" onClick="MM_openBrWindow('stock_delete.php?action=del_sid&sid=<?php //echo $x; ?>','OrdDelete','scrollbars=yes,width=400,height=350')">
					  delete					  </a> ]--><br>
                  ...
                  <div class="first-column">
                        ...
                        <div class="pagination-bottom">
                            <div class="upper-block">Total stock(s): <?php echo count($sid);?></div>
                         <?php echo $pagination ?>
                        </div>
