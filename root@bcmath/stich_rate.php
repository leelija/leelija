...
{
	$link = '';
	$rid = $rate->getAllStichRateAll('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  - Stiching rate</title>
<!-- Style -->
            ...
            <div id="admin-body">
             ...
             <!--   <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "stich_rate_add.php"."?action=add_stich_rate"; ?>">
                            Add New Stiching Rate
                        </a> 
                    </div>
                </div>-->
                <!-- eof Options -->
                ...
                <div id="data-column">
                    ...
                    ?>  
                    <thead>
                       <th width="3%" height="25"  align="center">Stiching Rate Id</th>
                      <th width="10%" >Design No. </th>
                      <th width="10%" >Particulars</th>
					   <th width="10%" >Particulars Rate(RS.)</th>
                 <!--     <th width="15%" align="center">Action</th>-->
					...
					<?php
                       ...
                       $rid = array_slice($rid, $start, $limit);     
                        foreach($rid as $x)
							...
							$StichRateDetails = $rate->showStichRate($x);
							//print_r($prodDetail);exit;
							$bgColor 	= $utility->getRowColor($k);	
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   <td align="left"><?php echo $StichRateDetails[0]; ?></td>
					  <td align="center"><?php echo $StichRateDetails[1]; ?></td>
					   <td align="center"><?php echo $StichRateDetails[2]; ?></td>
					   <td align="center"><?php echo $StichRateDetails[3]; ?></td>
					...
					<!--  <td >
					  [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('stich_rate_edit.php?action=stich_rate&rid=<?php //echo $StichRateDetails[0]; ?>','editStichRate','scrollbars=yes,width=750,height=600')">
					  Edit					  </a> ]
					  
					  
					 
					  [ 
					  <a href="#" onClick="MM_openBrWindow('fabric_delete.php?action=del_stichRate&rid=<?php //echo $StichRateDetails[0]; ?>','DeleteStichRate','scrollbars=yes,width=400,height=350')">
					  Delete					  </a> ]<br>
                  ...
                  <div class="first-column">
                        ...
                        <div class="pagination-bottom">
                            <div class="upper-block">Total Stiching Rate(s): <?php echo count($rid);?></div>
                         <?php echo $pagination ?>
                        </div>
