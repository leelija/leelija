...
//echo $keyword;exit;
	$link = '';
	$sid = $search_obj->getProductKeywordiron($keyword);
	//echo $sid;exit;
}
...
else
{
	...
	$sid = $statusCat->getAllIron('iron_id','DESC',$userId);
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> - Iron Status</title>
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
              ...
              <div class="padT30"><!-- --> </div> 
				...
				<!--		  <th width="7%" >Iron Id</th>
						  ...
						  <th width="18%"  >Iron(left)</th>
                          <th width="18%"  >Iron(complete)</th>
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							$statusCatDetail = $statusCat->showProductIron($x);
			...
			<!--		  <td align="left"><?php //echo $statusCatDetail[0]; ?></td>
					...
					<?php 
					   if($statusCatDetail[7] == 0)
						{
							$statusCat->editIronstatus($statusCatDetail[0],'Complete');
					   ?>
					   ...
					   <?php
								...
								if($statusCatDetail[15]==0)
								{
									...
									{
										$statusCat->editIronstatus($statusCatDetail[0],'Running');
									}	
									else{
										$statusCat->editIronstatus($statusCatDetail[0],'Incomplete');
									}
								}
								else{
									$statusCat->editIronstatus($statusCatDetail[0],'Running');
					   ...
					   <?php
						...
						?>  
                         ...
                         [ 
                          <a href="#" onClick="MM_openBrWindow('iron_update.php?action=update_iron&dhmckfip=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=700,height=600')">
                          Update Iron				  </a> ]
