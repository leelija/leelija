...
//Material Details
$billMatDtls  	= $bill->showBillMat($bid,'hand_bill_material');

//echo $_SESSION[USR_SESS];
//echo $userData[20];exit;
?>

<title><?php echo COMPANY_S; ?> -  Hand Bill Review</title>
...
<!-- /TinyMCE -->
    ...
    <div class="webform-area">		
        ...
        {
            $billNo					= "H".$bid."";
			$handDetails  			= $statCat->disPlTableDtls($billNo,'hand_table');
			$billDtl 				= $bill->allRFRIBillTable($bid,'mep_hand_bbook');
			//factory details
        ...
        ?>
			...
			<div id="PrintForm" style="padding-left:60px;"><!-- start Print -->
				...
				<div style="width: 100%;">
					<p style="width: 50%; float: left;">No.: <b>MEP-H<?php echo $bid;?></b></p> 
                ...
                <div id="data-column" style="position:relative; bottom: 9px; font-size:12px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                        ...
                        <thead>
						<tr>
						  <th width="5%" height="25"  align="center">SL.NO</th>
						...
						<tbody>
						   <?php 
							$sl=1;  
							$totalCost 		= 0;
							foreach($handDetails as $eachRecord)
								{
								...
								$type			= $eachRecord['work_type'];
								
								if($eachRecord['perticular'] != ''){
								$sHandDtls		= $sample->getAllHandDtlsPartWise($designNo,$type,$eachRecord['perticular']);
								$tAmount		= $sHandDtls[5] * $sHandDtls[6] + $sHandDtls[8]+ $sHandDtls[9];
								$gTotal 		= $tAmount * $quantity;
								}
								else{
									// Cost Calculate		
									$sHandDtls		= $sample->getAllHandDtlDT($designNo,$type);
									foreach($sHandDtls as $eachRow)
									{
										$totalAmount	= $eachRow['total_cost'];
										//$quantity		= $eachRecord['quantity'] + $eachRecord['complete'];
										$tAmount 		= $totalAmount;
									}
									$gTotal 		= $tAmount * $quantity;
						...
						?>
							<tr align="left"<?php $utility->printRowColor($bgColor);?>>
								...
								<td align="center"><?php echo $eachRecord['perticular']; ?>(<?php echo $eachRecord['work_type']; ?>)</td>
								<td align="center"><?php echo $quantity; ?></td>
								<td align="center"><?php echo $tAmount; ?></td>
					...
					<div class="tBillTitle" style="background:#ddd; height: 30px;">
						<p class="ltotal" style="width:50%; float:left;">Total Billing Amount</p>
						<p class="rtotal" style="width: 45%; float: right;position: relative;left: 205px;"><b><?php echo $totalCost;?></b></p>
					</div>
