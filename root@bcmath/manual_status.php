...
//echo $keyword;exit;
	if($_POST['type'] ==""){
		$link = '';
		$sid = $search_obj->getManualPipeline($keyword ,$userId);
		//echo $sid;exit;
	}
	else{
		$link = '';
		$sid = $advSearch->getCommonSearch($keyword,$type,$userId,'manual_id','manual_table');
...
else
{
	...
	$sid = $statusCat->getAllManual('added_on','DESC',$userId);
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
			  ...
			  <!-- Download option -->
                <div id="options-area">
					<a href="file_download.inc.php?table=manual_table">Download</a>
					<a href="manual-status-download.php">Download & view</a>
                </div>
                <!-- eof Download option -->
                ...
                <div id="data-column">
					...
					<!--	  <th width="7%" >manual Id</th>
						  ...
						  <th width="18%"  >Manual(left)</th>
                          <th width="18%"  >Manual(complete)</th>
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							$statusCatDetail = $statusCat->showProductManual($x);
							$customerDetail = $client->getCustomerData($statusCatDetail[5]);
							
							$ordDtls 		= $order->showOrders($statusCatDetail[2]);
							// update factory
							$status->updatePipeLine($statusCatDetail[2],$ordDtls[14],'manual_table');
					...
					<!--  <td align="left"><?php //echo $statusCatDetail[0]; ?></td>
					 ...
					 <!--  <td align="center"><?php //echo $statusCatDetail[5]; ?></td>-->
                      ...
                      <?php echo $customerDetail[5]; ?>	 </a> 
					   ...
					   if($statusCatDetail[7] == 0)
						{
							$statusCat->editManualstatus($statusCatDetail[0],'Complete');
					   ?>
					   ...
					   <?php
								...
								if($statusCatDetail[15]==0)
								{
									...
									{
										$statusCat->editManualstatus($statusCatDetail[0],'Running');
									}	
									else{
										$statusCat->editManualstatus($statusCatDetail[0],'Incomplete');
									}
								}
								else{
									$statusCat->editManualstatus($statusCatDetail[0],'Running');
					   ...
					   <?php
						...
						?>  
                         ...
                         [ 
                          <a href="#" onClick="MM_openBrWindow('manual_update.php?action=update_manual&dhmckfip=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=700,height=600')">
                          Update Manual					  </a> ]
