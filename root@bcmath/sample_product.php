...
{
	$link = '';
	$sid = $sample->getAllSample('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
             ...
             <!-- <h2>Total Current Stock:<?php  //$stock->CurrentstockSum();?></h2>-->
                ...
                <div id="data-column">
                    ...
                    <thead>
					  ...
					  <th width="10%" >Labour Type</th>
                      <th width="10%" >Remarks</th>
					  <th width="10%" >Colour</th>
                      <th width="10%" >Dyeing Cost</th>
                      <th width="10%" >Hand Cost </th>
					  <th width="10%" >Manual Cost</th>
					...
					<?php
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							$sampleDetail = $sample->showSample($x);
                    ...
                    ?>
					  ...
					  <td align="center" ><?php echo $sampleDetail[1]; ?></td>
					  <td align="center" ><?php echo $sampleDetail[7]; ?></td>
					   <td align="center"><?php echo $sampleDetail[2]; ?></td>
					   <td align="center">
						<!--[ 
					    <a href="#" 
						  ...
						  Add					  </a> ]-->
						   ...
						   [ 
							<a href="#" 
						  onClick="MM_openBrWindow('colour_view.php?action=view_colour&sid=<?php echo $sampleDetail[0]; ?>','viewsColour','scrollbars=yes,width=600,height=550')">
						  Views					  </a> ]
					    ...
					    <a href="#" 
						  ...
						  Add					  </a> ] -->
						   ...
						   [ 
							<a href="#" 
						  onClick="MM_openBrWindow('sample_dyeing_view.php?action=view_dyeing&sid=<?php echo $sampleDetail[0]; ?>','viewsColour','scrollbars=yes,width=600,height=500')">
						  Views					  </a> ]
