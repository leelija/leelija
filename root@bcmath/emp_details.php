...
$emp_id			= $utility->returnGetVar('emp_id','0');

$userId			= $utility->returnSess('userid', 0);
$customerDtl	= $customer->getCustomerData($userId);

//echo $customerDtl[2];exit;
$empDetails		= $customer->getCustData($emp_id);
...
<h3><a name="editStock">Employee Details</a></h3>
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						...
						<?php 
							...
							<?php $reco_record = 0; 
							//echo "$data[2]";
							foreach( $empDetails as $eachrecord ){
						...
						<tr class="table-row" >
							<td align="center"><?php echo $eachrecord ['fname']; ?></td>
							<td align="center"><?php echo $eachrecord ['email']; ?></td>
