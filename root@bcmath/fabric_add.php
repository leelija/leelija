...
{	
	...
	//add the Orders
	    $fabric->addFabric($txtFabName,'', '', $txtProdDesc, $txtUser);	
		...
		$uMesg->showSuccessT('success', 0, '', 'fabric.php', SUPROD001, 'SUCCESS');
	}
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
					...
					?>
                        ...
                        <h2><a name="addUser">Add Fabric</a></h2>
                        <span>Please fill the  <span class="required"></span> Fabric Name field</span>
