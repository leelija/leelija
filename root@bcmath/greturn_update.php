...
if($txtProductIn == '')
	...
	{
		//edit stock
	    $stock->editStock($stockDetails[0],$txtDesignNo, $txtStock, $totalProdIn, $stockDetails[4], $stockDetails[12], $goodsReturn,
		...
		foreach($stockDetailsDtl as $eachrecord ){
				...
				if($txtColour == $eachrecord['colour'] && $txtDesignNo == $eachrecord['design_no'])
					...
					$goodsReturn = $showGRDtl[2] - $txtProductIn;//Now current goods Return
					$ReadygoodsReturn = $showGRDtl[11] + $txtProductIn;// ready goods return
					
					$stock->editGreturn($txtDesignNo, $goodsReturn,$txtColour,$showGRDtl[3], $showGRDtl[4], $showGRDtl[5],$showGRDtl[6],$ReadygoodsReturn,'');
...
<title><?php echo COMPANY_S; ?> -  - Product Update</title>
