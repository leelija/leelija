...
$current_stock= $fabricDtl[2]-$txtAmount;
	...
	{
		//add the fabric out
	   $fabric->addfabricOut($txtOrdId,$fabricDtl[1],$txtAmount,$txtCompany,$txtPrice,$totalamount,$txtEmpId,$txtEmpName,$txtProdDesc,$customerDtl[16]);	
...
<title><?php echo COMPANY_S; ?> -  - Out fabric</title>
...
<h3><a name="editStock">Fabric Out</a></h3>
		 ...
		 <h2><a name="addUser">Fabric Out</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<label>Amount(In Meter)<span class="orangeLetter">*</span></label>
