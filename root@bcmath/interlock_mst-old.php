...
//echo $keyword;exit;
	if($_POST['type'] ==""){
		...
		$link = '';
		$sid = $advSearch->getCommonSearch($keyword,$type,$userId,'interlock_id','interlock_mst');
...
else
{
	...
	$sid = $interlock->getAllInterlockId('interlock_id', 'DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> - Interlock Maintenance</title>
...
$(document).ready(function(){
  $('#example').dataTable().yadcf([
		{column_number : 9,  filter_type: "range_date", filter_container_id: "filterDate"}
                ...
                <br><br>
				 <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "interlock_add.php"."?action=add_interlock"; ?>">
                            Add New Record
                        </a> 
                    </div>
                </div>
              ...
              <div class="padT30"><!-- --> </div> 
               <div id="PrintForm" style="position:relative; bottom: 150px;"><!--Start Print-->
				...
				<!--		  <th width="7%" >Iron Id</th>
						  ...
						  <th width="10%"  >Type Of Interlock</th>
						  <th width="10%"  >Interlock Quantity</th>
						  <th width="10%"  >rate</th>
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							$labourDtl = $labour->showLabour($interlockDtl[4]);
							
							$customerDetail = $client->getCustomerData($interlockDtl[3]);
							$date=date_create($interlockDtl[10]);
                    ...
                    ?>
						...
						<td align="center"><?php echo $interlockDtl[1]; ?></td>
						<td align="center"><?php echo $interlockDtl[2]; ?></td>  
						<td align="center"><?php echo $customerDetail[5]; ?></td>
						<td align="center"><?php echo $labourDtl[1]; ?></td>
						<td align="center"><?php echo $interlockDtl[13]; ?></td>
						<td align="center"><?php echo $interlockDtl[5]; ?></td>
						<td align="center"><?php echo $interlockDtl[6]; ?></td>
						<td align="center"><?php echo $interlockDtl[7]; ?></td>
					   <td align="center"><?php echo $interlockDtl[8]; ?></td>
