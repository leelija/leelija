...
<title><?php echo COMPANY_S; ?>Stitch Particular cost</title>
...
<h2><a name="editStock">Final Stitch Particular Details</a></h2>
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						...
						<?php 
							...
							$SamFstichlDtl = $sample->getAllFstichParticular($sid);
							?>	
							<?php $reco_record = 0; 
							//echo "$data[2]";
