    ...
    <div class="webform-area">		
        ...
        ?>
			...
			<div id="PrintForm" style="padding-left:80px;"><!-- start Print -->
				...
				<div style="width: 100%;">
					<p style="width: 50%; float: left;">No.: <b>C<?php echo $bid;?></b></p> 
                ...
                <div id="data-column" style="position:relative; bottom: 9px; font-size:12px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tr>
						  ...
						  <th width="15%" >Head/Line</th>
						   <th width="5%" >Quantity(Pcs)</th>
						   <th width="10%" >Total Head/Line</th>
						...
						?>
							<tr width="100%" class="single-column" cellpadding="0" cellspacing="0">
								...
								<td style="text-align:center;border: solid 1px #000;"><?php echo $eachRecord['computer_design_no']; ?></td>
								<td style="text-align:center;border: solid 1px #000;"><?php echo $eachRecord['total_stich']; ?></td>
								...
								<td style="text-align:center;border: solid 1px #000;">
									<?php			
										foreach($color as $colour)
										{
										  echo $perPcsHeadLine;echo "&nbsp;";echo $eachRecord['unit'];echo "-";echo $eachRecord['additional']; echo "<br>"; 
										}
									?>
								</td>
								<td style="text-align:center;border: solid 1px #000;"><?php echo $totalQuantity; ?></td>
								<td style="text-align:center;border: solid 1px #000;"><?php echo $totalHead; echo $eachRecord['unit'];?></td>
								<td style="text-align:center;border: solid 1px #000;"><?php echo $eachRecord['stich_rate']; ?></td>
								<td style="text-align:center;border: solid 1px #000;"><?php echo $totalCost; ?></td>
                ...
                <div id="data-column" style="position:relative; bottom: 9px; font-size:12px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                        <!-- display option -->
                        <?php 
							$billMatDtls  	= $bill->showBillMat($bid,'computer_bill_material');	
