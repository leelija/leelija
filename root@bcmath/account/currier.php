...
$currierDtls	= $currier->getCurrier();
...
<title><?php echo COMPANY_S; ?> -Courier Details</title>
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="add_currier.php?action=add_customer#addSupplier" >
                          Add Records				  
                        </a>
                    </div>
					<a href="../file_download.inc.php?table=currier_details">Download</a>
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($currierDtls as $eachRecord)
                            {
								$bgColor 	= $utility->getRowColor($k);	
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   <td align="left"><?php echo $sl; ?></td>
					   <td align="center"><a href=""><?php echo $eachRecord['name']; ?></a></td>
					   <td align="center"><?php echo $eachRecord['cemail']; ?></td>
					   <td align="center"><?php echo $eachRecord['cphone']; ?></td>
					   <td align="center"><?php echo $eachRecord['gstin_no']; ?></td>
					   <td align="center"><?php echo $eachRecord['pan_no']; ?></td>
					   <td align="center"><?php echo $eachRecord['address']; ?></td>
					   <td align="center"><?php echo $eachRecord['city']; ?></td>
					   <td align="center"><?php echo $eachRecord['balance']; ?></td>
					   <td align="center">
						
						<a href="#?action=create_edit&party_id=<?php echo $eachRecord['id']; ?>" >
							edit				  
                        </a>|
						<a href="#?action=create_Tran&party_id=<?php echo $eachRecord['id']; ?>" >
							Payment				  
                        </a>
					   </td>
