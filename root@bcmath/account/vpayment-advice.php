...
$venPayAdvice	= $vendor->getVenPAdviceData();
...
<title><?php echo COMPANY_S; ?> -Vendor Payment Advice</title>
<!-- Style -->
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="gen-ven-advice.php?action=addVPayAdvice" >
                          Generate Advice				  
                        </a>
                    </div>
					
					<a href="../file_download.inc.php?table=vpayment_advice">Download</a>
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($venPayAdvice as $eachRecord)
                            {
                    ...
                    <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					    ...
					    <td align="center"><?php echo $venDtl[1]; ?></td>
					    <td align="center"><?php echo $eachRecord['pamount']; ?></td>
						<td align="center"><a href=""><?php echo $eachRecord['payment_by']; ?></a></td>
						<td align="center"><a href=""><?php echo $eachRecord['payment_on']; ?></a></td>
					   </td>
				    </tr>
                      <?php 
						$sl++;
