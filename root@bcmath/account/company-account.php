...
<title><?php echo COMPANY_S; ?> -Company Account Details</title>
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="add-comp-account.php?action=add_cmpAcc#addEmpPbook" >
                          Add Records				  
                        </a>
                    </div>
                	...
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tr>
						 ...
						 <!-- <th width="3%" height="25"  align="center">Stock Id</th> -->
						  ...
						  <th width="10%" >P.SGST</th>
						  <th width="10%" >P.CGST</th>
						  <th width="10%" >P.IGST</th>
						  <th width="10%" >Sales SGST</th>
						  <th width="15%" >Sales CGST</th>
						  <th width="15%" >Sales IGST</th>
                       ...
                       <?php 
                        ...
                        foreach($cmpDtls as $eachRecord)
							...
							$compDetail 				= $company->showCompDtls($eachRecord['account_name']);
							
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
						<td align="left"><?php echo $sl; ?></td>
					   <td align="center"><a href=""><?php echo $compDetail[1]; ?></a></td>
					   <td align="center"><?php echo $eachRecord['bank']; ?></td>
					   <td align="center"><?php echo $eachRecord['balance']; ?></td>
					   <td align="center"><?php echo $eachRecord['in_sgst']; ?></td>
					   <td align="center"><?php echo $eachRecord['in_cgst']; ?></td>
					   <td align="center"><?php echo $eachRecord['in_igst']; ?></td>
					   <td><?php echo $eachRecord['out_sgst']; ?></td>
					   <td align="center"><?php echo $eachRecord['out_cgst']; ?></td>
					   <td align="center"><?php echo $eachRecord['out_igst']; ?></td>
					   
					   <td align="center">
						
						<a href="create_transaction.php?action=create_Tran&ca_id=<?php echo $eachRecord['ca_id']; ?>" >
							Withdraw/Deposit				  
                        </a>|
						<a href="transfer.php?action=create_Tran&ca_id=<?php echo $eachRecord['ca_id']; ?>" >
							Transfer				  
                        </a>|
					   </td>
