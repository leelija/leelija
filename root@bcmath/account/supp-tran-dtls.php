...
$supTranDtls	= $supplier->getSupplierTranData();
...
<title><?php echo COMPANY_S; ?> -Supplier Transaction Details</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="admin-top">
                	<h1>Supplier Transaction Details</h1>
                   <div class="cl"></div> 
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tr>
						 ...
						 <!-- <th width="3%" height="25"  align="center">Stock Id</th> -->
						  ...
						  <th width="10%" >payment from</th>
						  <th width="10%" >Balance</th>
						  <th width="10%" >Notes</th>
						  <th width="10%" >Tran. By</th>
						  <th width="15%" >Tran. On</th>
						</tr>  
                        </thead>
						<tbody>
                       <?php 
                        ...
                        foreach($supTranDtls as $eachRecord)
                            {
							$bAccDtls 					= $company->showCompAcc($eachRecord['cheque_issue_from']);
							$compDtls 					= $company->showCompDtls($bAccDtls[1]);
							//$compDetail 				= $company->showCompAcc($eachRecord['cheque_issue_from']);
							$suppDtls					=  $supplier->showSupplier($eachRecord['sid']);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><a href=""><?php echo $suppDtls[1]; ?></a></td>
					   <td align="center"><?php echo $eachRecord['payment_type']; ?></td>
					   <td align="center"><?php echo $eachRecord['cheque_no']; ?></td>
					   <td align="center"><?php echo $compDtls[1]; ?>-<?php echo $bAccDtls[2]; ?></td>
					   <td align="center"><?php echo $eachRecord['balance']; ?></td>
					   <td align="center"><?php echo $eachRecord['stran_notes']; ?></td>
