...
<title><?php echo COMPANY_S; ?> -Selling Rate Details</title>
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="add-selling-rate.php?action=add_rate#addRate" >
                          Add Records				  
                        </a>
                    </div>
					<a href="../file_download.inc.php?table=selling_stock">Download</a>
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($sRateDtls as $eachRecord)
                            {
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><?php echo $eachRecord['design_part']; ?></td>
					   <td align="center"><?php echo $eachRecord['sprice']; ?></td>
					   <td align="center"><?php echo $eachRecord['unit']; ?></td>
					   <td align="center"><?php echo $eachRecord['added_by']; ?></td>
					   <td align="center"><?php echo $eachRecord['added_on']; ?></td>
					   <td align="center">
						
						<a href="#?action=create_edit&id=<?php echo $eachRecord['id']; ?>" >
							edit				  
                        </a>|
						<a href="#?action=create_Tran&id=<?php echo $eachRecord['id']; ?>" >
							Del			  
                        </a>
					   </td>
