...
$suppDtls		=  $supplier->showSupplier($sid);
...
{	
	...
	else
	{
		...
		$supplier->UpdateSupplier($sid,$suppDtls[1],$suppDtls[2], $suppDtls[3],$suppDtls[4],$suppDtls[5], $sbalance,$userData[2]);
		//Supplier Acc Details
		$suppAccDtls = $supplier->showSuppAccCompWise($sid,$bAccDtls[1]);
		$ctBalance 	= $suppAccDtls[3] - $txtBalance;
		$supplier->UpdateSuppAccBlnc($sid,$bAccDtls[1], $ctBalance);
		...
		$uMesg->showSuccessT('success', 0, '', 'supplier-dtls.php', "Transaction has been successfully completed", 'SUCCESS');
	}
...
if(isset($_POST['btnCancel']))
{
	...
	//forward
	header("Location: supplier-dtls.php");
}
?>
...
<body>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                <div id="admin-top">
                	<h1>Payment For Supplier: <?php echo $suppDtls[1];?>&nbsp;&nbsp; </h1>
                </div>
                ...
                <div class="webform-area">
					...
					?>
                        ...
                        <form action="<?php $_SERVER['PHP_SELF']?>?action=create_Tran&sid=<?php echo $sid; ?>" method="post" enctype="multipart/form-data">
                            <div class="cl"></div>
							<div >
					        ...
					        value="<?php echo $suppDtls[6]; ?>" size="25" />
                            <div class="cl"></div>
