...
if(isset($_POST['Submit'])) { //check if form submitted
	...
	else
	{
		...
		//Account details
		$bAccDtls 		= $company->showCompAcc($txtBillingOn);
		$otsgst			= $bAccDtls[8] + $sgst_amount;
		$otcgst			= $bAccDtls[9] + $cgst_amount;
		$otigst			= $bAccDtls[10] + $igst_amount;
						...
						<div class="mytable_row ">
							<table class="form">
								...
								<tr> 
									...
									?>
										<option value="<?php echo $row['ca_id'];?>"><?php echo $row['account_name'];?></option> 
									<?php
