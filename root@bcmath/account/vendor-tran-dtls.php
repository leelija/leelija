...
$venTranDtls	= $vendor->getVendorTranData();
...
<title><?php echo COMPANY_S; ?> -Vendor Transaction Details</title>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($venTranDtls as $eachRecord)
                            {
							...
							$venDtls					=  $vendor->showVendor($eachRecord['vid']);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><a href=""><?php echo $venDtls[1]; ?></a></td>
					   ...
					   <td align="center"><?php echo $eachRecord['vtran_notes']; ?></td>
