...
{	
	...
	else
	{
		...
		$supplier->addPurchPrmBill($txtSupName,$txtBillNo,$txtBillingName, $txtBalance,$txtSGSTRate,$sgst, $txtCGSTRate,$cgst,
		...
		$tsgst			= $bAccDtls[5] - $sgst;
		$tcgst			= $bAccDtls[6] - $cgst;
		$tigst			= $bAccDtls[7] - $igst;
		//update company account
		$company->updateCompAcc($bAccDtls[0],$bAccDtls[1],$bAccDtls[2], $bAccDtls[3],$bAccDtls[4],$tsgst, $tcgst, 
		$tigst, $bAccDtls[8],$bAccDtls[9], $bAccDtls[10],$userData[2]);
		
		//deleting the sessions
		$utility->delSessArr($sess_arr);
		
		//forward the web page
		$uMesg->showSuccessT('success', 0, '', 'purchase-prm.php', "Bill Record has been successfully added", 'SUCCESS');
	}
...
if(isset($_POST['btnCancel']))
{
	...
	//forward
	header("Location: purchase-prm.php");
}
?>
...
<title><?php echo COMPANY_S; ?> - New Purchase PRM Bill Entry</title>
					...
					?>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<div >
								...
								?>
									<option value="<?php echo $row['sid'];?>"><?php echo $row['supplier_name'];?></option> 
								<?php
    ...
    $("#txtIGSTRate").keyup(function() {
       // var grandTotal = 0;
        $("input[name='txtBalance']").each(function (index) {
			...
			var sgst		= parseInt(txtBalance) * parseInt(txtSGSTRate) / 100;
			var cgst		= parseInt(txtBalance) * parseInt(txtCGSTRate) / 100;
			var igst		= parseInt(txtBalance) * parseInt(txtIGSTRate) / 100;
            var txtNetBalance 		= parseInt(txtBalance) + parseInt(sgst) + parseInt(cgst)+ parseInt(igst);
			//alert(txtNetBalance);
