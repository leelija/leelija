...
$cmpDtls		= $company->getCompDtlsData();
...
<title><?php echo COMPANY_S; ?> -Company Details</title>
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="#.php?action=add_cmpAcc#addEmpPbook" >
                          Add Records				  
                        </a>
                    </div>
					<a href="../file_download.inc.php?table=company_dtls">Download</a>
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><a href=""><?php echo $eachRecord['company_name']; ?></a></td>
					   ...
					   <td align="center">
						...
						<a href="#?action=create_Tran&comp_id=<?php echo $eachRecord['comp_id']; ?>" >
							Withdraw/Deposit				  
                        </a>|
						<a href="#?action=create_Tran&comp_id=<?php echo $eachRecord['comp_id']; ?>" >
							Transfer				  
