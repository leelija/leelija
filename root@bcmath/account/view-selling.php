...
<title><?php echo COMPANY_S; ?> -Sales Bill Details</title>
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="acc/add_sales.php" >
                          Add Records				  
                        </a>
                    </div>
					<a href="../file_download.inc.php?table=invoice">Download</a>
                </div>
                	...
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($invoiceDtls as $eachRecord)
							...
							//$compDtls 					= $company->showCompDtls($eachRecord['billing_name']);
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?> <?php if($eachRecord['status'] == 'cancel'){ ?> style="background-color:#999999;" <?php }?>>
					   ...
					   <td align="center">
							...
							<a href="btemplate/sales-bill-review.php?action=add_suppBill&bid=<?php echo $eachRecord['invoice_id']; ?>" >
								Preview			  
							</a>
							
							<?php if($eachRecord['status'] == 'cancel'){ ?>	
								<p style="color: red;">Cancel</p>
							<?php } else{?>
							
								<a 
									onClick="MM_openBrWindow('add-courier-dtls.php?action=bill-review&invoice_id=<?php echo $eachRecord['invoice_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									Additional					  
								</a> 
								<a 
									onClick="MM_openBrWindow('invoice-cancel.php?action=invoiceCancel&invoice_id=<?php echo $eachRecord['invoice_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									Cancel					  
								</a>
							<?php }?>
