...
if(isset($_POST['btnLogin']))
{
	...
	$userDtls 			= $customer->getCustDatabyEmail($login);
	$CustomerTypeDtl	= $customer->getCustomerTypeData($userDtls[0]);
	...
	{
		if($userDtls[0] == 6){
			$Login->validateAccount($login, $password, 'email', 'password', 'customer');
		}
		else{
...
<title>Account Control Panel -  CRM</title>
