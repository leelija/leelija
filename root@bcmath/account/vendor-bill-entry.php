...
$vBillEntDtls	= $vendor->getVendorBillData();
...
<title><?php echo COMPANY_S; ?> -Vendor Bill Details</title>
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="add-vendor-bill.php?action=add_venBill#addVendorBill" >
                          Add Records				  
                        </a>
                    </div>
					<a href="../file_download.inc.php?table=vendor_bill_entry">Download</a>
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($vBillEntDtls as $eachRecord)
                            {
							
							$compDetail 				= $company->showCompDtls($eachRecord['billing_name']);
							$venDtl						= $vendor->showVendor($eachRecord['vid']);
							$bgColor 					= $utility->getRowColor($k);	
							
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
						<td align="left"><?php echo $sl; ?></td>
					   <td align="center"><a href=""><?php echo $venDtl[1]; ?></a></td>
					   ...
					   <td align="center"><?php echo $eachRecord['tds']; ?></td>
					   ...
					   <td align="center"><?php echo $eachRecord['added_on']; ?></td>
						<td>
							<?php
								if($eachRecord['payment_status'] == 'paid'){
									
							?>
								<a style="color:red;" href="vpayment.php?action=create_Tran&vbe_id=<?php echo $eachRecord['vbe_id']; ?>" >
									Paid				  
								</a>
							<?php	
								}
							...
							?>	
								<a href="vpayment.php?action=create_Tran&vbe_id=<?php echo $eachRecord['vbe_id']; ?>" >
									UnPaid				  
								</a>
						...
						<td>
                            <div class="chk-box">
                                <input type="checkbox" 
                                data-blog-id="<?php echo $b ?>" onchange="cartUpdate('blog-chk-'+<?php echo $b ?>)" 
                                data-blog-price="<?php echo $eachRecord['net_balance']; ?>" <?php echo ($alreadyInCart ? 'checked' : '');?>
                                value="None" id="blog-chk-<?php echo $b ?>" name="blog-chk-<?php echo $b ?>" />
                                <label for="blog-chk-<?php echo $b ?>" class="chk-lebel"></label>
                            </div>
                        </td>
