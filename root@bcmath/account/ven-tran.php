...
$venDtls		=  $vendor->showVendor($vbe_id);
$bAccDtls 		= $company->showCompAcc(1);
...
{	
	...
	$sess_arr	= array('txtPayType', 'txtCheqeNo', 'txtBalance', 'txtProdDesc');
	...
	*/	
		...
		$uMesg->showSuccessT('success', 0, '', 'vendor-dtls.php', "Transaction has been successfully completed", 'SUCCESS');
	}
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="admin-top">
                	<h1>Payment For Vendor: <?php echo $venDtls[1];?>&nbsp;&nbsp; </h1>
                </div>
