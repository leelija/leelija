...
<title><?php echo COMPANY_S; ?> - Packing Pending Status</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
			  ...
			  <!-- Download option -->
                <div id="options-area">
					<a href="file_download.inc.php?table=packing_pending">Download</a>
					<a href="checking_status_download.php">View & Download</a>
                </div>
                <!-- eof Download option -->
				...
				<!--		  <th width="7%" >Iron Id</th>
                          ...
                          <th width="13%"  >Submit Date </th>
                          <th width="10%" >Colour</th>
						  <th width="10%" >Pending</th>
						  <th width="10%" >complete</th>
						  <th width="10%" >Alter</th>
						  
						  <th width="18%"  >Status</th>
                          <th width="34%"  align="center">Complete</th>
						<!--  <th width="34%"  align="center">Alter</th>   -->
                        </thead>
                       <?php 
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							// Update pending status table
							$statusCat->updatePackingPendingStatus($statusCatDetail[7],'Complete');

							$ordDtls 		= $order->showOrders($statusCatDetail[2]);
							// update factory
							$status->updatePipeLine($statusCatDetail[2],$ordDtls[14],'packing_pending');
                    ?>
				...
				<!--	   <td align="center">
					...
					-->   
					   ...
					   <td align="center"><?php echo $statusCatDetail[17]; ?></td>
						...
						<td align="center"><a href="packing_status.php?ord_id=<?php echo $statusCatDetail[2];?>"><?php echo $statusCatDetail[14]; ?></a></td>
                          ...
                          <td  align="center">
								...
								<a href="#" onClick="MM_openBrWindow('packing_pending_update.php?action=update_packing&dhmckfip=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=700,height=600')">
								Complete				  </a> 
							</td>	
						<!--	<td  align="center">
								
								<a href="#" onClick="MM_openBrWindow('update_alter_particular.php?action=update_packing&dhmckfip=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=700,height=600')">
								Alter				  </a> 
