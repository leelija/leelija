...
//echo $keyword;exit;
	$link = '';
	$sid = $search_obj->getProductKeywordKali($keyword);
	//echo $sid;exit;
}
...
else
{
	...
	$sid = $statusCat->getAllKaliCut('kalicut_id','DESC',$userId);
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> - Kalicut Status</title>
              ...
              <div class="padT30"><!-- --> </div> 
                ...
                <div id="data-column">
					...
					<!--	  <th width="7%" >KalicutId</th>
						  ...
						  <th width="18%"  >Kali Cutting(left)</th>
                          <th width="18%"  >Kali Cutting(complete)</th>
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							$statusCatDetail = $statusCat->showProductKaliCut($x);
					...
					<!--  <td align="left"><?php //echo $statusCatDetail[0]; ?></td>
					 ...
					 <!--  <td align="center"><?php //echo $statusCatDetail[5]; ?></td>-->
					  ...
					  <td align="center"><?php echo $statusCatDetail[15]; ?></td>
					   ...
					   if($statusCatDetail[7] == 0)
						{
							$statusCat->editKalistatus($statusCatDetail[0],'Complete');
					   ?>
					   ...
					   <?php
								...
								if($statusCatDetail[15]==0)
								{
									...
									{
										$statusCat->editKalistatus($statusCatDetail[0],'Running');
									}	
									else{
										$statusCat->editKalistatus($statusCatDetail[0],'Incomplete');
									}
								}
								else{
									$statusCat->editKalistatus($statusCatDetail[0],'Running');
					   ...
					   <?php
						...
						?>  
                         ...
                         [ 
                          <a href="#" onClick="MM_openBrWindow('kalicut_update.php?action=update_kalicut&dhmckfip=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=700,height=600')">
                          Update Kalicut					  </a> ]
