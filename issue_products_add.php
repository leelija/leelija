...
{	
	...
	for($i=0; $i < $selNum; $i++)
			{
				...
				$txtRate			= $_POST['txtrate'][$i];
				$txtQuantity		= $_POST['txtQuantity'][$i];
				
				//$total_cost	= $_POST['txtKaliQuantity'][$i] * $_POST['txtrate'][$i];
				
				$total_cost		= $txtRate * $txtQuantity;
				
				//add Issue Products Details
				$issueProducts->addIssueProducts($_POST['txtOrderId'][$i],$_POST['txtDesignNo'][$i],$_POST['txtBillNo'][$i],
				$txtMasterId,$txtEmpid,$_POST['txtIssueType'][$i],$_POST['txtParticular'][$i],
				$txtQuantity,$txtRate,$total_cost,$customerDtl[2]);
	...
	//forward
	$uMesg->showSuccessT('success', 0, '', 'issue_products.php', " record has been successfully Added", 'SUCCESS');
	
}
if(isset($_POST['btnCancel']))
{
	//forward
	header("Location: issue_products.php");
}
...
<title><?php echo COMPANY_S; ?> - Add Issue Products</title>
...
<script type="text/javascript" src="js/issue_products.js"></script>
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if(isset($_GET['action']) && ($_GET['action'] == 'add_issue_products')) 
					{	
					?>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="cl"></div>
							<tr>
								<label>Select Particular No.</label>
									...
									?>
									  <select name="selNum" id="selNum" onchange="return getAllIssueProducts();"
									   class="textBoxA">
								...
								<div class="cl"></div>
								<div id="showIssueProductsRecord"></div>
                            <div class="cl"></div>
