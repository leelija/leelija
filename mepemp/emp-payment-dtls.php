...
$empPayDtls 	= $employee->EmpPayBookDtsData();
...
<title><?php echo COMPANY_S; ?> - Employee Payment Details</title>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($empPayDtls as $eachRecord)
                            {
							$PayBookDtls 			= $employee->showEmpBookData($eachRecord['pb_id']);
							$empDetail 				= $employee->showEmployee($PayBookDtls[1]);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><?php echo $eachRecord['payable']; ?></td>
					   <td align="center"><?php echo $eachRecord['pay_amount']; ?></td>
					   <td align="center"><?php echo $eachRecord['payment_via']; ?></td>
					   ...
					   <td align="center"><?php echo $eachRecord['added_on']; ?></td>
						<td  align="center">
                          <p onClick="MM_openBrWindow('pay-voucher.php?action=adv-voucher&payment_id=<?php echo $eachRecord['payment_id']; ?>','AdminDelete','scrollbars=yes,width=1000,height=800')">
                          view					  </p> 
					  	</td>
