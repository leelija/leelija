...
$payment_id		= $utility->returnGetVar('payment_id','0');
		...
		<!-- Display Data -->
                <div id="data-column">
                	...
                	<?php 
						...
						$empPayDtls 	= $employee->showEmpPayDtlsData($payment_id);
						$PayBookDtls 	= $employee->showEmpBookData($empPayDtls[1]);
						...
						$pre_date 		= date('d-m-Y', strtotime($empPayDtls[8]));
					?>
						...
						<form class="voucher-form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<div style="width: 100%; height:40px;">
								...
								<div style="float:right; width:45%;">
									Total Rs.:&nbsp;<span class="vtext"><?php echo $empPayDtls[5];?></span>
								</div>
							</div>
							
							<div style="width: 100%; height:40px;">
								Rupee:&nbsp;<span class="vtext"><?php echo convert_number_to_words($empPayDtls[5]); ?></span>
							</div>
							<div style="width: 100%; height:40px;">
								<div style="float:left; width:45%;">
							...
							<div style="width: 100%; height:40px;">
								<div style="float:left; width:45%;">
									Payment by:<span class="vtext"><?php echo $empPayDtls[9];?></span>
								</div>
								<div style="float:right; width:45%;">
									Payment Date:&nbsp;<span class="vtext"><?php 
									$cheched_date = date('d-m-Y', strtotime($empPayDtls[8]));
