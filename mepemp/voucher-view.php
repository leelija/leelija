	...
	<h3><a name="editStock">Voucher</a></h3>
		...
		<!-- Display Data -->
                <div id="data-column">
					...
					<div class="voucher" id="PrintForm"><!--Voucher Start-->
						<form class="voucher-form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							<div class="vouPayDetails">
								Voucher No.:&nbsp;<span class="vtext"><?php echo $PaymentDtls[0]; ?></span>
							</div>
							<div class="vline"></div>
							<div class="vrow" id="vrow">	
								<div class="leftsubtitle">
									<p class="title" style="text-transform: uppercase;"><?php echo $empDtls[15];?></p>
								</div>	
							...
							<div class="vouRow">
								<div class="vouRowLeft">
									Payment by:<span class="vtext"><?php echo $PaymentDtls[8];?></span>
								</div>
								<div class="vouRowRight">
									Payment Date:&nbsp;<span class="vtext"><?php 
									$cheched_date = date('d-m-Y', strtotime($PaymentDtls[12]));
									echo $cheched_date; ?></span>
								</div>
							</div>
