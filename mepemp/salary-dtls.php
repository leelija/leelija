...
$empDutySalDtls = $employee->EmpDutySalaryData();
...
<title><?php echo COMPANY_S; ?> - Employee Salary Details</title>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tr>
						 ...
						 <!-- <th width="3%" height="25"  align="center">Stock Id</th> -->
						  ...
						  <th width="10%" >Adv.Withdraw</th>
						  <th width="10%" >Remarks</th>
						 <th width="12%" >Sal By</th>
						 <th width="10%" >Sal.Date</th> 
						</tr>  
                        </thead>
						<tbody>
                       <?php 
                        ...
                        foreach($empDutySalDtls as $eachRecord)
                            {
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><?php echo $eachRecord['salary']; ?></td>
					   <td align="center"><?php echo $eachRecord['adv_withdraw']; ?></td>
