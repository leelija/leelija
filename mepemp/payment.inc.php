...
if((isset($_POST['btnPayButton'])))
{
	...
	if(($txtSecurity == ''))
	{
		echo "invalid Security No.";exit;
	}
	else
	{
		//if password match
			if($txtSecurity == $x_password)
			{
				$employee->PaymentComp($txtPayId, $userData[10],'Complete');
				$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], "Payment has been Successfully Complete", 'SUCCESS');exit;
			}
			else
			{
				echo "invalid Security No.";exit;
						...
						<form class="voucher-form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<div class="vouRow">
								<div class="vouRowLeft">
									...
									<input type="hidden" name="txtAdhar" id="txtAdhar" value="<?php echo $empDtls[28];?>" >
									<input type="hidden" name="txtSecurityNo" id="txtSecurityNo" value="<?php echo $empDtls[5];?>" >
								</div>
							...
							<div class="vouRow">
								<div class="vouRowLeft">
									Checked by:<span class="vtext"><?php echo $PaymentDtls[7];?></span>
								</div>
								<div class="vouRowRight">
									Checked Date:&nbsp;<span class="vtext"><?php 
									$cheched_date = date('d-m-Y', strtotime($PaymentDtls[11]));
							...
							<div class="vrow">
								<div class="row">
									<div class="col-xs-12 col-sm-4 col-md-4">
										<p>Security No</p>
										<input type="password" name="txtSecurity" id="txtSecurity" >
										
									</div>
								</div>	
							</div>	<br>
							<button type="submit" class="btn btn-primary" name="btnPayButton" >Payment</button>
