...
$empAttendanceDtls 	= $employee->EmpAttendanceData();
...
<title><?php echo COMPANY_S; ?> - Employee Attendance Details</title>
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					<div class="add-new-option">
						<a href="#" 
						    onClick="MM_openBrWindow('sms-for-absent.php?action=Show_Sal','stockEdit','scrollbars=yes,width=750,height=600')">
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($empAttendanceDtls as $eachRecord)
                            {
							$empDtls 				= $employee->showEmployeeAdhar($eachRecord['aadhaar_no']);
							$empTypeDtl				= $employee->getEmpTypeData($empDtls[1]);
							$bgColor 				= $utility->getRowColor($k);	
							
							$entrTime 				= date_create($eachRecord['entry_time']);
							$exitTime 				= date_create($eachRecord['exit_time']);
						?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
						<td align="left"><?php echo $sl; ?></td>
						<td align="center"><a href=""><?php echo $empDtls[2]; ?></a></td>
						<td align="center"><?php echo $empTypeDtl[2]; ?></td>
					   <?php
							if($eachRecord['entry_attendance'] == 1)
								{
						?>
					   ...
					   <?php
							if($eachRecord['exit_attendance'] == 1)
								{
						?>
						<td align="center"><?php echo "Yes"; ?></td>
						<?php
					   ...
					   <td align="center"><?php echo date_format($entrTime,"d/m/Y H:i:s"); ?></td>
					   <td>
						<?php 
							if($eachRecord['exit_time']!='0000-00-00 00:00:00'){
								echo date_format($exitTime,"d/m/Y H:i:s"); 
							}else{
								echo "N/A";
							}
						?>
					   </td>
					   <td align="center"><?php echo $eachRecord['amonth']; ?></td>
					   <td align="center"><?php echo $eachRecord['ayear']; ?></td>
