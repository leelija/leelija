...
$empTranDtls 	= $employee->EmpTranData();
...
<title><?php echo COMPANY_S; ?> - Employee Payment Transaction Details</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="admin-top">
                	<h1>Employee Payment Transaction Details</h1>
                   <div class="cl"></div> 
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tr>
						 ...
						 <!-- <th width="3%" height="25"  align="center">Stock Id</th> -->
						  ...
						  <th width="10%" >Tran. Amount</th>
						  <th width="10%" >Prev. Amount</th>
						  <th width="10%" >Current Amount</th>
						 <th width="12%" >Tran By</th>
                       ...
                       <?php 
                        ...
                        foreach($empTranDtls as $eachRecord)
                            {
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><?php echo $eachRecord['tran_amount']; ?></td>
					   <td align="center"><?php echo $eachRecord['prev_amount']; ?></td>
					   <td align="center"><?php echo $eachRecord['curr_amount']; ?></td>
