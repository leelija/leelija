...
$empAdvanceDtls 	= $employee->EmpAdvData();
...
<title><?php echo COMPANY_S; ?> - Employee Advance Details</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="admin-top">
                	<h1>Employee Advance Details</h1>
                   <div class="cl"></div> 
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tr>
						 ...
						 <th width="12%" >Advance By</th>
						 <th width="10%" >Advance.Date</th> 
                       ...
                       <?php 
                        ...
                        foreach($empAdvanceDtls as $eachRecord)
                            {
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td  align="center">
                          <p onClick="MM_openBrWindow('adv-voucher.php?action=adv-voucher&adv_id=<?php echo $eachRecord['adv_id']; ?>','AdminDelete','scrollbars=yes,width=1000,height=800')">
                          view					  </p> 
					  	</td>
				     </tr>
                      <?php 
