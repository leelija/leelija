...
$empFoodDtls 	= $employee->EmpFoodData();
...
<title><?php echo COMPANY_S; ?> - Employee Food Details</title>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($empFoodDtls as $eachRecord)
                            {
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><?php echo $eachRecord['no_of_food']; ?></td>
					   <td align="center"><?php echo $eachRecord['fmonth']; ?></td>
