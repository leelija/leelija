...
//echo $keyword;exit;
	if($_POST['type'] ==""){
		$link = '';
		$sid = $search_obj->getHandPipeline($keyword);
		//echo $sid;exit;
	}
	else{
		$link = '';
		$sid = $advSearch->getCommonSearchAdmin($keyword,$type,'hand_id','hand_table');
...
else
{
	...
	$sid = $statusCat->getAllHandAll('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> - Hand Status</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <a href="downloadfile/hand_status.php">Download</a>
					  ...
					  <?php 
					   ...
					   <?php
						...
						?>  
                         ...
                         [ 
                          <a href="#" onClick="MM_openBrWindow('hand_edit.php?action=update_hand&dhmckfip=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=700,height=600')">
                          Edit				  </a> ] 
