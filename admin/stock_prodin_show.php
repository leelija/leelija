...
//echo $keyword;exit;
	$link = '';
	$sid = $search_obj->getProductInKeyword($keyword);
	//echo $sid;exit;
}
else
{
	$link = '';
	$sid = $stock->getAllProductIn('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  In products Details</title>
<!-- Style -->
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="options-area">
					...
					<a href="productin_download.php">Download</a>
                ...
                <div id="data-column">
                    ...
                    ?>  
                    <thead>
                      <th width="3%" height="25"  align="center">Product In Id</th>
                      <th width="10%" >Design No. </th>
					  <th width="10%" >Bill No. </th>
                      <th width="10%" >Products In(pieces)</th>
					...
					<?php
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							$productInDetail = $stock->showProductIn($x);
							//print_r($prodDetail);exit;
							$bgColor 	= $utility->getRowColor($k);	
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					  <td align="left"><?php echo $productInDetail[0]; ?></td>
					  <td align="center" ><?php echo $productInDetail[1]; ?></td>
					  <td align="center" ><?php echo $productInDetail[9]; ?></td>
					   <td><?php echo $productInDetail[2]; ?></td>
					   <td><?php echo $productInDetail[8]; ?></td>
					    <td align="center"><?php echo $productInDetail[3]; ?></td>
						<td align="center"><?php echo $productInDetail[4]; ?></td>
						
					 
					  <td >
					    [ 
					  <a href="#" onClick="MM_openBrWindow('product_in_edit.php?action=prod_in&sid=<?php echo $productInDetail[0]; ?>','OrdDelete','scrollbars=yes,width=700,height=500')">
					  Edit					  </a> ]<br>
					 
					  [ 
					  <a href="#" onClick="MM_openBrWindow('product_in_delete.php?action=del_sid&sid=<?php echo $x; ?>','OrdDelete','scrollbars=yes,width=400,height=350')">
					  Cancel					  </a> ]<br>
