...
{	
	...
	$stockDtl 		= $stock->showStock($stockDetails[0]);
	
	$currentStock  	= $stockDtl[2]-$stockDetails[3];
	//echo $currentStock;exit;
	
	//stock update
	 $stock->editstockCurrentprod($stockDetails[0],$currentStock);
	 
	//delete the stock
	$stock->delStockDetails($sid);
...
<title><?php echo COMPANY_S; ?> -  - Delete Stock Details </title>
...
<table class="tblBrd" align="center" width="100%">
    ...
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Stock Details :: <?php //echo $stockDetails[0]; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?sid=<?php echo $sid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            Are you sure	that	you	want	to delete the product in data 
            <strong><?php //echo $stockDetails[0]; ?></strong> from table
