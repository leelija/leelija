...
{	
	...
	$sess_arr	= array('txtPartyName','txtAddress', 'txtCity', 'txtPhone');
	...
	//add the Company
	 $pCompany->addPurchaseComp($txtPartyName, $txtAddress, $txtCity, $txtPhone,$txtEmail,$userData[10]);	
		...
		$uMesg->showSuccessT('success', 0, '', 'purchase-company.php', 'Company has been successfully added', 'SUCCESS');
	}
...
if(isset($_POST['btnCancel']))
{
	...
	//forward
	header("Location: purchase-company.php");
}
?>
...
<title><?php echo COMPANY_S; ?> - Add PurchaseCompany</title>
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if(isset($_GET['action']) && ($_GET['action'] == 'add_company')) 
					{	
					?>
                   
                        <h2><a name="addUser">Add Company</a></h2>
