...
{	
	...
	//delete the stock
	$sample->delSamComputer($sid);
	
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], "Sample Computer has been delete successfully", 'SUCCESS');
...
<table class="tblBrd" align="center" width="100%">
    ...
    {
        $samDetails = $sample->showSamComputer($sid);
    ?>
    <tr class=''>
