...
if(isset($_POST['btnAddOrd']))
{
	...
	if($txtDesignNo	==''){
		...
		$i		= 0;
			...
			//add orders image
			$ordImgId	= $photogallery->addPhotoGallery($txtDesignNo,$txtDesignNo, $isDefault);
		...
		*/						   
			...
			$imgid = $uImg->imgCropResize($_FILES['fileSubImg'], '', $newName, 
								   ...
								   3000, 4800, $ordImgId,'image', 'photo_gallery_id', 'photo_gallery');					   
			//echo $imgid;exit;					   
								   
			//resizing the image
			$uImg->imgCropResize($_FILES['fileSubImg'], '', $newName, 
								   '../images/gallery/thumb/', 
								   80, 80, $ordImgId,'thumb_image', 'photo_gallery_id', 'photo_gallery');
