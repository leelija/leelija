...
if($txtDesignNo == '')
	...
	{
		//add the Orders
	   $stock->editSales($sid,$txtDesignNo, $txtSales, $txtColour, $txtCompany,$txtAddress, $txtContact,
		...
		$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], 'product Sales has been update', 'SUCCESS');
	}
}
...
<title><?php echo COMPANY_S; ?> -  - product Sales edit</title>
...
<!-- /TinyMCE -->
    ...
    <div class="webform-area">		
		<?php 
        //form
        if( (isset($_GET['action'])) && ($_GET['action'] == 'sales_edit') )
        {
             
            $stockDetails = $stock->showProductSales($sid);
        ?>
		
<h3><a name="editStock">Product Sales</a></h3>
    
          <form action="<?php $_SERVER['PHP_SELF']?>?action=sales_edit&sid=<?php echo $sid; ?>" method="post" enctype="multipart/form-data">
		 ...
		 <h2><a name="addUser">Product Sales</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <label>Product Sales(pieces) </label>
