...
{	
	...
	$txtLabourType	 	= $_POST['txtLabourType'];

	//registering the post session variables
	$sess_arr	= array('txtDesignNo','txtProdDesc','txtUser');
	...
	//add the stock table
	    $sample->addSample($txtDesignNo,$txtLabourType,$txtProdDesc,$txtUser);
		...
		$uMesg->showSuccessT('success', 0, '', 'sample_product.php', PRODOD001, 'SUCCESS');
	}
...
if(isset($_POST['btnCancel']))
{
	...
	//forward
	header("Location: sample_product.php");
}
?>
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if(isset($_GET['action']) && ($_GET['action'] == 'add_sample')) 
					{	
					?>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<div >
                                    ...
                                    <select name="txtLabourType" type="text" id="txtLabourType" class="text_box_large">
