...
{	
	...
	$txtMatAmount 	        = $_POST['txtMatAmount'];
	$txtMaterialCost 	        = $_POST['txtMaterialCost'];*/
...
if($sampleDtl[1] == '')
	...
	else
	{
					for($i=0; $i < $selNum; $i++)
			{
				...
				$sample->addSamFstich($sampleDtl[0],$sampleDtl[1],$_POST['txtParticularName'][$i],$_POST['txtTime'][$i],'',
				$_POST['txtProductType'][$i],$_POST['txtFabricAmount'][$i],$_POST['txtMaterialCost'][$i],$_POST['txtOthersCost'][$i],$txtProdDesc);	
			}
...
<h3><a name="editStock">Add Sample Final stich Cost & Material</a></h3>
