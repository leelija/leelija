...
{
	$link = '';
	$rid = $rate->getAllInterlockAll('interlock_rate_id','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  - Interlock rate</title>
<!-- Style -->
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "interlock_rate_add.php"."?action=add_interlock_rate"; ?>">
                            Add Interlock Rate
                        </a> 
                    </div>
                </div>
                ...
                <div id="data-column">
                    ...
                    ?>  
                    <thead>
                      <th width="3%" height="25"  align="center">S.L No.</th>
                      <th width="10%" >Interlock Name</th>
                      <th width="10%" >Interlock Type</th>
					   <th width="10%" >Interlock Rate(RS.)</th>
					...
					<?php
                       ...
                       $rid = array_slice($rid, $start, $limit);     
                        foreach($rid as $x)
							...
							$InterlockRateDtls = $rate->showInterlockRate($x);
                    ...
                    ?>
					  ...
					  <td align="center"><?php echo $InterlockRateDtls[1]; ?></td>
					   <td align="center"><?php echo $InterlockRateDtls[2]; ?></td>
					   <td align="center"><?php echo $InterlockRateDtls[3]; ?></td>
					...
					<!--  [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('stich_rate_edit.php?action=stich_rate&rid=<?php echo $InterlockRateDtls[0]; ?>','editStichRate','scrollbars=yes,width=750,height=600')">
					  Edit					  </a> ] -->
					  
					  
					 
					  [ 
					  <a href="#" onClick="MM_openBrWindow('interlock_rate_delete.php?action=del_stichRate&sid=<?php echo $InterlockRateDtls[0]; ?>','DeleteStichRate','scrollbars=yes,width=400,height=350')">
					  Delete					  </a> ]<br>
                  ...
                  <div class="first-column">
                        ...
                        <div class="pagination-bottom">
                            <div class="upper-block">Total Interlock Rate(s): <?php echo count($rid);?></div>
                         <?php echo $pagination ?>
                        </div>
