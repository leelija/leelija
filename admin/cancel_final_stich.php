		 ...
		 <h2>->Order Id <?php echo $FinalStichDetails[2];?>&nbsp;->Design No. <?php echo $FinalStichDetails[3];?></h2>
				...
				-->
						...
						<!--	<label>Particular<span class="orangeLetter">*</span></label>  -->
							...
							<option value="<?php echo $FinalStichDetails[18];?>"><?php echo $FinalStichDetails[18];?></option>
							<?php
							$rateDetails         = $rate->getStichRateDisplay($FinalStichDetails[3]);
							foreach ($rateDetails as $row){//Array or records stored in $row
							//echo $row[colour_name];
