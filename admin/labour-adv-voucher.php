...
$labAdvDtls 	= $labour->showLabourAdvDtls($id);
...
<title><?php echo COMPANY_S; ?>Labour Advance Voucher Details</title>
	...
	<h3><a name="editStock" >Payment Slip</a></h3>
		...
		<!-- Display Data -->
                <div id="data-column">
                	...
                	<?php 
						$labourDetails = $labour->showLabour($labAdvDtls[1]);
						...
						//$tdate			= 
						$pre_date 		= date('d-m-Y', strtotime($toDate));
					?>
						...
						<form class="voucher-form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<div style="width: 100%; height:120px;">
								<div style="float:left; width:60%;">
									Debit/Credit Name:&nbsp;<span class="vtext"><?php echo $labourDetails[1]; ?></span><br>
									Mobile:&nbsp;<span class="vtext">............</span><br>
									Adhar No.:&nbsp;<span class="vtext">..............</span>
								</div>
							...
							<div style="width: 100%; height:40px;">
								...
								<div style="float:right; width:70%;">
									Payment for <?php echo $month; echo "-"; echo $year;?>
								</div>
							</div>
							<div style="width: 100%; height:40px;">
								...
								<div style="float:right; width:45%;">
									Total Rs.:&nbsp;<span class="vtext"><?php echo $labAdvDtls[2];?></span>
								</div>
							</div>
							
							<div style="width: 100%; height:40px;">
								Rupee:&nbsp;<span class="vtext"><?php echo convert_number_to_words($labAdvDtls[2]); ?></span>
							</div>
							<div style="width: 100%; height:40px;">
								<div style="float:left; width:45%;">
							...
							<div style="width: 100%; height:40px;">
								<div style="float:left; width:45%;">
									Payment by:<span class="vtext"><?php echo $labAdvDtls[3];?></span>
								</div>
								<div style="float:right; width:45%;">
									Payment Date:&nbsp;<span class="vtext"><?php 
									$cheched_date = date('d-m-Y', strtotime($toDate));
