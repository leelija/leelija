...
{	
	...
	$labour->delLabour($lid);
	
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], 'Labour Account has been successfully delete ', 'SUCCESS');
	
}
?>

<title><?php echo COMPANY_S; ?> -  - Delete Labour Account </title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'del_labour') )
    {
        //$stockDetails = $stock->showStock($sid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Labour Account. :: <?php echo $lid; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?lid=<?php echo $lid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="2" align="left" class=" blackLarge">
            <div class="marT25 padL10 padR10 padB20" style="color: red;">
            Are you sure	that	you	want	to delete the Labour Account.
            <strong><?php echo $lid;; ?></strong> from Labour Tables
