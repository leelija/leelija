...
$numResDisplay	= (int)$utility->returnGetVar('numResDisplay', 30);
...
//echo $keyword;exit;
	$link = '';
	$cid = $search_obj->getProductColourKeyword($keyword);
	//echo $sid;exit;
}
else
{
	$link = '';
	$cid = $unit->getAllDesCategories('categories_name','ASC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> - Design Categories Master </title>
<!-- Style -->
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="admin-top">
                	<h1>Design Categories Management</h1>
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="#" onClick="MM_openBrWindow('add-design-cat.php?action=add_img','AddImg','scrollbars=yes,width=700,height=600')">
						  Add New Categories				  
						</a> 
                    </div>
                </div>
                ...
                <div id="data-column">
                    ...
                    ?>  
                    <thead>
						<th width="3%" height="25"  align="center">Colour Id</th>
					...
					<?php
                       ...
                       $sid = array_slice($cid, $start, $limit);     
                        foreach($cid as $x)
                            {
							//$x = $pageArray[$pageNumber][$j];
							
							$CatDetail 	= $unit->showDesCategories($x);
							//print_r($prodDetail);exit;
							$bgColor 			= $utility->getRowColor($k);	
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					  <td align="left"><?php echo $CatDetail[0]; ?></td>
					  <td align="center" ><?php echo $CatDetail[1]; ?></td>
					    <td align="center"><?php echo $CatDetail[2]; ?></td>
					 <td align="center"><?php echo $CatDetail[3]; ?></td>
					  <td >
					  [ 
					  <a href="#" onClick="MM_openBrWindow('#.php?action=del_colourId&sid=<?php echo $CatDetail[0]; ?>','OrdDelete','scrollbars=yes,width=400,height=350')">
					  delete					  </a> ]<br>
                  ...
                  <div class="first-column">
                        ...
                        <div class="pagination-bottom">
                            <div class="upper-block">Total Colour(s): <?php echo count($cid);?></div>
                         <?php echo $pagination ?>
                        </div>
