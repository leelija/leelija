		...
		for($i=0; $i < $selNum; $i++)
			{
				...
				$sample->addSamManual($sampleDtl[0],$sampleDtl[1],$_POST['txtParticularName'][$i],$_POST['txtTime'][$i],$_POST['txtLabourCost'][$i],$_POST['txtProductType'][$i],$_POST['txtFabricAmount'][$i],$_POST['txtMaterialCost'][$i],$_POST['txtOthersCost'][$i],$txtProdDesc);	
...
<title><?php echo COMPANY_S; ?> -Add Sample Manual Material</title>
...
<h3><a name="editStock">Add Sample Manual Material</a></h3>
		 ...
		 <h2><a name="addUser">Add Sample Manual Material</a></h2>
						...
						<!--<label>Time<span class="orangeLetter">*</span></label>
							...
							<label>Labour Cost<span class="orangeLetter">*</span></label>
                            <input name="txtLabourCost" type="text" class="text_box_large" id="txtLabourCost" 
					         size="25" />
                            <div class="cl"></div>-->
