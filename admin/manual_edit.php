...
$ManualDtl		= $statuscat->showProductManual($dhmckfip);

$customerDetail = $customer->getCustomerData($ManualDtl[5]);// HandWorker name display
...
if($OrderDate == '')
	...
	{
		//Edit Manual table
	   $statuscat->editManual($dhmckfip,$ManualDtl[1],$ManualDtl[2],$ManualDtl[3],$ManualDtl[4],$txtEmpId,$ManualDtl[6],
	   $txtFabAmountlft,$txtProdDesc,$OrderDate,$TargetDate,$userData[10],$txtFabAmountcomp,$ManualDtl[16],$txtBillNo,$txtParticular);	
		...
		$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], 'Manual Status has been successfully edit', 'SUCCESS');
	}
}
...
<!-- /TinyMCE -->
    ...
    <div class="webform-area">		
		<?php 
        //form
        if( (isset($_GET['action'])) && ($_GET['action'] == 'update_manual') )
        {
...
<h3><a name="editStock">Edit Hand status</a></h3>
          ...
          <form action="<?php $_SERVER['PHP_SELF']?>?action=update_manual&dhmckfip=<?php echo $dhmckfip; ?>" method="post" enctype="multipart/form-data">
		 ...
		 <h2><a name="addUser">Edit Hand status</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<div >
								<label>Manual Worker<span class="orangeLetter">*</span></label>							
							...
							<label>Bill No</label>
							<input name="txtBillNo" id="txtBillNo" type="text" class="text-field" value="<?php echo $ManualDtl[17]; ?>" />
							<div class="cl"></div>
							
							<label>Particular</label>
							<input name="txtParticular" id="txtParticular" type="text" class="text-field" value="<?php echo $ManualDtl[18]; ?>" />
							<div class="cl"></div>
							
							<label>Left Particular</label>
							<input name="txtFabAmountlft" id="txtFabAmountlft" type="text" class="text-field" value="<?php echo $ManualDtl[7]; ?>" />
							<div class="cl"></div>
							<label>Complete Particular</label>
							<input name="txtFabAmountcomp" id="txtFabAmountcomp" type="text" class="text-field" value="<?php echo $ManualDtl[15]; ?>" />
							<div class="cl"></div>
							
							<label>Order Date<span class="orangeLetter">*</span></label>
							  <input name="OrderDate" type="date" class="text_box_large" id="OrderDate" 
								value="<?php echo $ManualDtl[9]; ?>" size="25"  />
							  <div class="cl"></div>
												
							  <label>Target Date<span class="orangeLetter">*</span></label>
							  <input name="TargetDate" type="date" class="text_box_large" id="TargetDate" 
							  value="<?php echo $ManualDtl[10]; ?>" size="25"  />
							  <div class="cl"></div>
							
							 <label>Remarks</label>
                            <textarea  name="txtProdDesc" id="txtProdDesc">
								<?php echo $ManualDtl[8]; ?>
                            </textarea>
                            <div class="cl"></div>
