...
if(isset($_POST['txtCatName']))
{
	...
	$duplicateId	= $error->duplicateUser($txtCatName, 'categories_name', 'design_categories');
	
	//add the additional images
	if($txtCatName	==''){
		echo "The Categories Name is empty.";
	}
	elseif( ($txtCatName != '') && (preg_match("/^ER/i",$duplicateId)) )		
	{
		
		$error->showErrorTA($action, $id, $id_var, $_SERVER['PHP_SELF'], "Categories is already in use", $typeM, $anchor);
	}	
	else{
		
			//add Categories
			$unit->addDesCat($txtCatName,$userData[10]);
			
			//forward
			$uMesg->showSuccessT('success', $cid, 'cid', $_SERVER['PHP_SELF'],"Categories has been successfully added", 'SUCCESS');
...
<title><?php echo COMPANY_S; ?> -Add Design Categories</title>
<!-- Style -->
...
<table class="tblBrd" align="center" width="650">
	...
	<tr>
	  <td height="25" align='left' bgcolor="#EEEEEE">
	  	<h3><a name="addSub">Add Design Categories </a> </h3>
	</td>
    </tr>
	<tr>
	  <td>
	  ...
	  method="post"  enctype="multipart/form-data" />
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
			...
			<input name="txtCatName" id="txtCatName" type="text" class="text-field" />
			<div class="cl"></div>
