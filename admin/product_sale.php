				...
				if($txtProdColour == $eachrecord['colour'] && $txtDesignNo == $eachrecord['design_no'])
					{
						...
						// add sales
						$stock->addSales($txtDesignNo, $txtProductIn,$txtProdColour, $txtCompanyName, $txtAddress , $txtContactNo , $txtProdDesc, $userData[10]);
...
<title><?php echo COMPANY_S; ?> -  - Product Sales</title>
