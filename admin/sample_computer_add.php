		...
		for($i=0; $i < $selNum; $i++)
			{
				...
				$sample->addSamComputer($sampleDtl[0],$sampleDtl[1],$_POST['txtParticular'][$i],$_POST['txtTime'][$i],$_POST['txtOtherCost'][$i],$_POST['txtComDesinNo'][$i],$_POST['txtStichAmount'][$i],$_POST['txtStichRate'][$i],$txtProdDesc);	
			}	
