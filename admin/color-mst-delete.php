...
{	
	...
	//delete the Colour
	$unit->delColorMstDtl($cid);
	//echo $cid;exit;
	
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], 'Colour has been successfully delete ', 'SUCCESS');
...
<table class="tblBrd" align="center" width="100%">
    ...
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete colour. :: <?php echo $cid; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?cid=<?php echo $cid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            Are you sure	that	you	want	to delete the Colour
            <strong><?php echo $cid;; ?></strong> from Colour table
