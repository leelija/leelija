...
{	
	...
	//registering the post session variables
		...
		$sess_arr	= array('txtDesignNo', 'txtStock', 'txtProductIn', 'txtSales', 'txtGdReturn', 'AddDate',
		'txtProdDesc','txtUser');
...
if($txtDesignNo == '')
	...
	{
		//add the Orders
	    $stock->editstockDetails($sid,$txtStockId,$txtDesignNo,$txtColour, $txtStock, $txtProductIn, $txtSales,$txtNetSales, $txtGdReturn,
		 $AddDate,$txtUser);	
		...
		$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], 'stock details has been update', 'SUCCESS');
	}
}
...
<title><?php echo COMPANY_S; ?> -  - Edit Stock details</title>
...
<!-- /TinyMCE -->
    ...
    <div class="webform-area">		
		<?php 
        //form
        if( (isset($_GET['action'])) && ($_GET['action'] == 'stock_edit') )
        {
             
            $stockDetails = $stock->showStockDetails($sid);
        ?>
		
<h3><a name="editStock">Edit Stock details</a></h3>
    
          <form action="<?php $_SERVER['PHP_SELF']?>?action=stock_edit&sid=<?php echo $sid; ?>" method="post" enctype="multipart/form-data">
         
		 
		 <h2><a name="addUser">Edit Stock details</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
					        ...
					        value="<?php echo $stockDetails[10] ?>" size="25" />
                            <div class="cl"></div>
							
							<label>Net Sales</label>
                            <input name="txtNetSales" type="text" class="text_box_large" id="txtNetSales" 
					        value="<?php echo $stockDetails[11] ?>" size="25" />
                            <div class="cl"></div>
