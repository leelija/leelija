...
$current_stock= $threadDtl[2]-$txtAmount;
	
	//registering the post session variables
	
		$sess_arr	= array('txtAmount','txtOrdId');
	...
	{
		//add the fabric out
	   $thread->addThreadOut($txtOrdId,$threadDtl[1],$txtAmount,$txtCompany,$txtPrice,$totalamount,$txtEmpId,$txtEmpName,$txtProdDesc,$customerDtl[16]);	
	   $thread->editThread($tid,$threadDtl[1],$current_stock,$threadDtl[5],$threadDtl[4]);
...
<title><?php echo COMPANY_S; ?> - Out thread</title>
...
<!-- /TinyMCE -->
    ...
    <div class="webform-area">		
		<?php 
        //form
        if( (isset($_GET['action'])) && ($_GET['action'] == 'out_tid') )
        {
             
            $threadDetails = $thread->showThread($tid);
        ?>
		
<h3><a name="editStock">Thread Out</a></h3>
    
          <form action="<?php $_SERVER['PHP_SELF']?>?action=out_tid&tid=<?php echo $tid; ?>" method="post" enctype="multipart/form-data">
         
		 
		 <h2><a name="addUser">Thread Out</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input name="txtOrdId" type="text" class="text_box_large" id="txtOrdId" 
					         size="25" />
                            <div class="cl"></div>
							
							<label>Thread(Psc)<span class="orangeLetter">*</span></label>
