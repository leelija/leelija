...
//echo $keyword;exit;
	$link = '';
	$pids = $party->getPartyKeyword($keyword);
	//echo $sid;exit;
}
else
{
	$link = '';
	$pids = $party->getAllParty('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> customer Management</title>
<!-- Style -->
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "party_add.php"."?action=add_party"; ?>">
                            Add New party
                        </a> 
                    </div>
					Party List: <a href="party_download.php">Download</a>
                </div>
                ...
                <div id="data-column">
                    ...
                    <tr align="left" class="orangeLetter">
                      <td height="20" colspan="5">  <?php echo "No Company Has Been Added So Far."; ?> </td>
                    </tr>
                    <?php 
                    }
                    else
                    ...
                    ?>  
                    <thead>
                      <th width="3%" height="25"  align="center">Buyer Id</th>
                      <th width="10%" > Buyer Name </th>
					  <th width="10%" >Buyer Address</th>
                      <th width="10%" >Buyer City</th>
					  <th width="10%" >Buyer Phone </th>
					  <th width="10%" >Buyer Email </th>
					  <th width="10%" >Brokar Name</th>
				...
				<!--	  <th width="15%"  align="center"> Status</th>   -->
					...
					<?php
                       ...
                       $pids = array_slice($pids, $start, $limit);     
                        foreach($pids as $x)
                            {
							//$x = $pageArray[$pageNumber][$j];
							
							$partyDetail = $party->showParty($x);
							//print_r($prodDetail);exit;
							$bgColor 	= $utility->getRowColor($k);	
                    ?>
						<tr align="left"<?php $utility->printRowColor($bgColor);?>>
						<td align="center"><?php echo $partyDetail[0]; ?></td>
						<td align="center"><?php echo $partyDetail[1]; ?></td>
						<td align="center"><?php echo $partyDetail[2]; ?></td>
						<td align="center"><?php echo $partyDetail[3]; ?></td>
						<td align="center"><?php echo $partyDetail[4]; ?></td>
						<td align="center"><?php echo $partyDetail[11]; ?></td>
						<td align="center"><?php echo $partyDetail[5]; ?></td>
					    <td align="center"><?php echo $partyDetail[6]; ?></td>
						<td align="center"><?php echo $partyDetail[7]; ?></td>
				...
				<!--	 <td >
                     ...
                     [ 
					  <a href="#" onClick="MM_openBrWindow('party_delete.php?action=Party_delete&pid=<?php echo $x; ?>','PartyDele','scrollbars=yes,width=700,height=500')">
					  delete					  </a> ]				  </td>  -->  
				    </tr>
                  <?php 
                  ...
                  <div class="first-column">
                        ...
                        <div class="pagination-bottom">
                            <div class="upper-block">Total company(s): <?php echo count($pids);?></div>
                         <?php echo $pagination ?>
                        </div>
