...
if($txtAmount == '')
	...
	elseif($txtAmount <= 0)
	{
	echo "Order quantity less than assign quantity";
	}
	...
	else
	{
	   ...
	   $statuscat->addFinalStichDtl($final_stich_id,$FinalStichDtl[3],$txtEmpid,$labourDtl[1],$txtParticular,$txtAmount,$workprice,'unpaid');
		 ...
		 <h2>->Order Id <?php echo $FinalStichDetails[2];?>&nbsp;->Design No. <?php echo $FinalStichDetails[3];?></h2>
				...
				-->
                            ...
                            <input name="txtParticular" type="text" class="text_box_large" id="txtParticular" 
					         value="<?php echo $FinalStichDetails[18];?>" size="25" />
                            <div class="cl"></div>
