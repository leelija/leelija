...
//echo $keyword;exit;
	$link = '';
	$sid = $search_obj->getProductColourKeyword($keyword);
	//echo $sid;exit;
}
else
{
	$link = '';
	$sid = $stock->getAllProductColour('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  product colour</title>
<!-- Style -->
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="admin-top">
                	<h1>Product Colour Management</h1>
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "add_product_colour.php"."?action=add_pcolour"; ?>">
                            Add New Colour
                        </a> 
                    </div>
                ...
                <div id="data-column">
                    ...
                    ?>  
                    <thead>
                      <th width="3%" height="25"  align="center">Product Colour Id</th>
                      <th width="10%" >Design No. </th>
					  <th width="10%" >Design Colour </th>
					...
					<?php
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							$ProductColouDetail = $stock->showProductColour($x);
							//print_r($prodDetail);exit;
							$bgColor 	= $utility->getRowColor($k);	
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					  <td align="left"><?php echo $ProductColouDetail[0]; ?></td>
					  <td align="center" ><?php echo $ProductColouDetail[1]; ?></td>
					    <td align="center"><?php echo $ProductColouDetail[2]; ?></td>
					 <td align="center"><?php echo $ProductColouDetail[3]; ?></td>
					  <td >
					  [ 
					  <a href="#" onClick="MM_openBrWindow('colour_delete.php?action=del_colourId&sid=<?php echo $ProductColouDetail[0]; ?>','OrdDelete','scrollbars=yes,width=400,height=350')">
					  delete					  </a> ]<br>
                  ...
                  <div class="first-column">
                        ...
                        <div class="pagination-bottom">
                            <div class="upper-block">Total product Colour(s): <?php echo count($sid);?></div>
                         <?php echo $pagination ?>
                        </div>
