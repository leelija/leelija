...
{	
	...
	$sess_arr	= array('txtFabName','', '', 'txtProdDesc','txtUser');
	...
	if($txtFabName == '')
	{
		echo "Please fill the Thread Name field";
	}
	...
	//add the Orders
	    $thread->addThread($txtFabName,'', '', $txtProdDesc, $txtUser);	
		...
		$uMesg->showSuccessT('success', 0, '', 'thread.php', SSUPROD001, 'SUCCESS');
	}
...
<title><?php echo COMPANY_S; ?> - Add Thread</title>
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if(isset($_GET['action']) && ($_GET['action'] == 'add_thread')) 
					{	
					?>
                   
                        <h2><a name="addUser">Add Thread</a></h2>
                        <span>Please fill the  <span class="required"></span> Thread Name field</span>
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                            
                          
                            <div class="cl"></div>                      
                    		<label>Thread Name <span class="orangeLetter">*</span></label>
