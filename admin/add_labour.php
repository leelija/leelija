...
{	
	...
	//add the Orders
	    $labour->addLabour('',$txtLabour,$txtEmpName,$txtAddress, $txtMobile, '', '','',$txtFactory);	
		...
		$uMesg->showSuccessT('success', 0, '', 'labour.php', MSG001, 'SUCCESS');
	}
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if(isset($_GET['action']) && ($_GET['action'] == 'addLabour')) 
					{	
					?>
                   
                        <h2><a name="addUser">Add Labour</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input name="txtLabour" type="text" class="text_box_large" id="txtLabour" 
					           value="<?php $utility->printSess2('txtLabour',''); ?>"
                              size="25" />
                            <div class="cl"></div>
                           ...
                           <div class="cl"></div>                      
                            ...
                            <input name="txtAddress" type="text" class="text_box_large" id="txtAddress" 
					           value="<?php $utility->printSess2('txtAddress',''); ?>"
                              size="25" />
                            <div class="cl"></div>
                            ...
                            <input name="txtMobile" type="text" class="text_box_large" id="txtMobile" 
					           value="<?php $utility->printSess2('txtMobile',''); ?>"
                              size="25" />
                            <div class="cl"></div>
							
							<div >
								<label>Factory<span class="orangeLetter">*</span></label>							
								<select name="txtFactory" type="text" id="txtFactory" class="text_box_large">
									<option value="1">MonienterPrises</option>
