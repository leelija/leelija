...
{	
	...
	//delete the product colour
	$stock->delProductColour($sid);
	
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], "Product Colour has been successfully delete", 'SUCCESS');
	
}
?>

<title><?php echo COMPANY_S; ?> -  - Delete product colour </title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'del_colourId') )
    {
        //$stockDetails = $stock->showStock($sid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Design No. :: <?php echo $sid; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?sid=<?php echo $sid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            Are you sure	that	you	want	to delete the Design colour
            <strong><?php echo $sid;; ?></strong> from product colour Tables
