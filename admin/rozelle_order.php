...
//echo $keyword;exit;
	if($_POST['type'] ==""){
		...
		$link = '';
		$oids = $advSearch->getRozelOrdAdvsearch($keyword,$type);
...
{
	$link = '';
	$oids = $rozelleOrder->getAllRozOrd('orders_id','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                                    ...
                                    <div id="dropdown-page-back" style="display:none">
                                       ...
                                       <select name="type" id="type" class="textBoxA">
										...
										?>
											...
											<option value="party_name">Party Code</option>
                ...
                <div class="header-title" style="height:20px;">
					...
					<h2 style="float:left;">[[Last 2 months Due Rozelle Order:<?php  $rozelleOrder->DueRozelleOrder();?>]]</h2>
                    ...
                    ?>
					  ...
					  <td align="center"><?php echo $orderDetail[14]; ?></td>
					   ...
					   <td align="center"><?php echo $orderDetail[4]; ?></td>
						...
						<td align="center">
							<a href="#" 
								onClick="MM_openBrWindow('roz_deli_remark_edit.php?action=delivery_edit&oid=<?php echo $orderDetail[0]; ?>','OrdAssign','scrollbars=yes,width=700,height=600')">
								<?php echo $orderDetail[8]; ?>|edit|
							</a>
						</td>
				...
				<!--	  [ 
					...
					[ 
					    <p style="color: red;" 
					  onClick="MM_openBrWindow('rozelle_order_deliver.php?action=deliver_ord&oid=<?php echo $orderDetail[0]; ?>','OrdDeliver','scrollbars=yes,width=750,height=600')">
					  Deliver					  </p> ]
					  [ 
					    <p style="color: red;" 
