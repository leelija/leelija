...
<h3><a name="editStock">View Sample Final Stich Cost & Material</a></h3>
		  ...
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						...
						<tr class="table-row" >
							...
							[ 
							<a href="#" 
							  onClick="MM_openBrWindow('delete_sample_fstich.php?action=del_fstich&sid=<?php echo $eachrecord ['fstich_id']; ?>','delFstich','scrollbars=yes,width=400,height=400')">
							  Delete					  </a> ]
