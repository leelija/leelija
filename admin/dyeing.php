...
if((isset($_GET['btnSearch'])) &&($_GET['btnSearch'] == 'search'))
{
	if($_GET['type'] ==""){
		...
		$link = "&btnSearch=search&keyword=".$_GET['keyword']."&mode=&type=".$_GET['type'];
		$sid = $advSearch->getSearchdyeSort($keyword,$type);
...
else
{
	...
	$sid = $statusCat->getAllDyeingAll('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                           		...
                           		<div id="dropdown-page-options">
                                    ...
                                    <div id="dropdown-page-back" style="display:none">
                                       ...
                                       <select name="type" id="type" class="textBoxA">
											...
											<option value="employeeId">Dye Worker Id</option>
               ...
               <a href="downloadfile/dyeing_status.php">Download</a>
                	...
                	<table class="single-column" cellpadding="0" cellspacing="0">
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							//$customerDetailemp  = $client->getCustomerData($statusCatDetail[4]);
                      ...
                      <?php echo $customerDetail[5]; ?>	 </a> 
					   ...
					   <?php
						...
						?>  
                         ...
                         [ 
                          <p style="color:blue;" href="#" onClick="MM_openBrWindow('dyeing_edit.php?action=update_dyeing&dhmckfip=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=700,height=600')">
                          Edit					  </p> ]  
