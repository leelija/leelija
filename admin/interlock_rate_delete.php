...
{	
	...
	$rate->delInterlockRate($sid);
	
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], 'Interlock rate has been successfully delete ', 'SUCCESS');
	
}
?>

<title><?php echo COMPANY_S; ?> -  - Delete Interlock rate </title>
...
<table class="tblBrd" align="center" width="100%">
    ...
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Interlock rate. :: <?php echo $sid; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?sid=<?php echo $sid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            Are you sure	that	you	want	to delete the Interlock rate
            <strong><?php echo $sid;; ?></strong> from interlock rate Tables
