...
if((isset($_GET['btnSearch'])) &&($_GET['btnSearch'] == 'search'))
{
	if($_GET['type'] ==""){
		...
		$sid = $search_obj->getFinalstichPipeline($keyword);
	}
	else{
		$link = "&btnSearch=search&keyword=".$_GET['keyword']."&mode=&type=".$_GET['type'];
		$sid = $advSearch->getSearchFstichSort($keyword,$type);
...
else
{
	...
	$sid = $statusCat->getAllFinalStichAll('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> - Final Stiching Status</title>
    ...
    <div class="container">
        <div class="inner-container">
          ...
          <div id="search-page-back">
                           		...
                           		<div id="dropdown-page-options">
                                    ...
                                    <div id="dropdown-page-back" style="display:none">
                                       ...
                                       <select name="type" id="type" class="textBoxA">
											...
											<option value="employeeId">Master Id</option>
											<option value="bill_no">Bill No.</option>
											<option value="particular_name">Particular</option>
              ...
              <a href="downloadfile/finalstich_status.php">Download final stich</a>|| <a href="downloadfile/final_stich_details.php">Download final stich details</a>
				...
				<!--	  <td align="left"><?php //echo $statusCatDetail[0]; ?></td>
					  <td align="center"><?php //echo $statusCatDetail[1]; ?></td>   -->
					   ...
					   <?php
						...
						<td align="center">
                          <p style="color: blue;" href="" onClick="MM_openBrWindow('final_stich_complete.php?action=final_stichcomp&final_sid=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=500,height=400')">
					  ...
					  <!-- <td align="center"><?php //echo $statusCatDetail[15]; ?></td>-->
					   ...
					   <?php
						...
						?>  
                         ...
                         [ 
                          <a href="#" onClick="MM_openBrWindow('edit_final_stich.php?action=edit_finalStich&fsid=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=700,height=600')">
                          Edit					  </a> ]  
						  
						<!--  [ 
                          <a href="#" onClick="MM_openBrWindow('cancel_final_stich.php?action=edit_finalStich&fsid=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=300,height=200')">
                          Cancel					  </a> ]  -->
