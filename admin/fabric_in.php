...
if($txtAmount == '')
	...
	{
		//add the fabric
		$matId 		= $fabric->addfabricIn($fabricDtl[1],$txtAmount,$txtCheckBy,$txtCompany,$txtFrom,$txtPrice,$totalAmount,$txtBillNo,
		$txtProdDesc,$userData[10]);	
		
		
		//rename the file
		$newName = $utility->getNewName4($_FILES['fileSubImg'], '',$matId);
			
		//upload in the server
		$imgid = $uImg->imgCropResize($_FILES['fileSubImg'], '', $newName,  '../images/matbill/', 
								   800, 1000, $matId,'image', 'fabric_in_id', 'fabric_in');	
		
		
		
		
		// update total fabric amount
		$fabric->editFabric($fid,$current_stock,$userData[10]);
...
<h3><a name="editStock"></a></h3>
		 ...
		 <h2><a name="addUser"><?php echo $fabricDtl[1];?> In</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<label>Materials Quantity(in <?php echo $fabricDtl[9];?>)<span class="orangeLetter">*</span></label>
                            <input name="txtAmount" type="text" class="text_box_large" id="txtAmount" 
					         size="25" />
                            <div class="cl"></div>
							
							<label>Price/<?php echo $fabricDtl[9];?><span class="orangeLetter">*</span></label>
							...
							<span class="orangeLetter">Best size (800 X 1000)</span>
							<div class="cl"></div>
							 <label>Remarks</label>
