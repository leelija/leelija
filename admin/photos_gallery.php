...
//echo $keyword;exit;
	if($_POST['type'] ==""){
		$link = '';
		$pgid = $advSearch->getCommonSearchAdmin($keyword,'design_no','photo_gallery_id','photo_gallery');
		//$pgid = $search_obj->getOrdersProduct($keyword);
		//echo $sid;exit;
	}
	else{
		$link = '';
		$pgid = $advSearch->getCommonSearchAdmin($keyword,$type,'photo_gallery_id','photo_gallery');
...
{
	$link = '';
	$pgid = $photogallery->getAllPhotoGl('design_no','ASC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  - Photos Gallery Management</title>
<!-- Style -->
<link href="../style/style.css" rel="stylesheet" type="text/css">
<link href="../style/admin/admin.css" rel="stylesheet" type="text/css">
<link href="../style/admin/photo_gallery.css" rel="stylesheet" type="text/css">
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="#" onClick="MM_openBrWindow('add_image_gallery.php?action=add_img','AddImg','scrollbars=yes,width=700,height=600')">
						  Add New Photo					  
						</a> 
                    </div>
                </div>
                    ...
                    else
                    {
                       ...
                       $pgid = array_slice($pgid, $start, $limit);     
                        foreach($pgid as $x)
							...
							$photoGalleryDetail = $photogallery->showPhotoGallery($x);
                    ?>
					
					<div class="img">
					  <a target="_blank" href="../images/gallery/large/<?php echo $photoGalleryDetail[3];?>">
						<img src="../images/gallery/large/<?php echo $photoGalleryDetail[3];?>" alt="Gallery" width="300" height="200">
					  </a>
					  <div class="desc"><?php echo $photoGalleryDetail[1];?></div>
					</div>
