		...
		for($i=0; $i < $selNum; $i++)
			{
				...
				$sample->addSamHand($sampleDtl[0],$sampleDtl[1],$_POST['txtParticularName'][$i],$_POST['txtTime'][$i],$_POST['txtLabourCost'][$i],$_POST['txtProductType'][$i],$_POST['txtFabricAmount'][$i],$_POST['txtMaterialCost'][$i],$_POST['txtOthersCost'][$i],$txtProdDesc);	
			}
...
<h3><a name="editStock">Add Sample Hand Material</a></h3>
