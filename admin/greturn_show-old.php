...
//echo $keyword;exit;
	$link = '';
	$sid = $search_obj->getGoodsReturnKeyword($keyword);
	//echo $sid;exit;
}
else
{
	$link = '';
	$sid = $stock->getAllProductReturn('greturn_id','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  products Return Details</title>
<!-- Style -->
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="options-area">
					...
					<a href="greturn_dload.php">Download</a>
                </div>
                <!-- eof Options -->
                ...
                <div id="data-column">
				   ...
				   <tbody>
					<?php
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							$productReturnDetail = $stock->showProductReturn($x);
                    ...
                    ?>
						...
						<td align="center" ><?php echo $stockDetails[1]; ?></td>
						<td align="center"><?php echo $productReturnDetail[2]; ?></td>
					    <td align="center"><?php echo $productReturnDetail[6]; ?></td>
						<td align="center"><?php echo $productReturnDetail[3]; ?></td>
						<td align="center"><?php echo $productReturnDetail[4]; ?></td>
						<td align="center"><?php echo $productReturnDetail[5]; ?></td>
					    <td align="center"><?php echo $productReturnDetail[7]; ?></td>
					  ...
					  <td >
						...
						[ 
							<a href="#" 
							onClick="MM_openBrWindow('greturn_update.php?action=update_gd&gd_id=<?php echo $productReturnDetail[0]; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
							GR Update					  </a> ] 
				...
				<?php		
                  ...
                  <div class="first-column">
                        ...
                        <div class="pagination-bottom">
                            <div class="upper-block">Total Product Return(s): <?php echo count($sid);?></div>
                         <?php echo $pagination ?>
                        </div>
