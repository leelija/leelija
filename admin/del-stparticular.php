...
{	
	...
	$rate->delStParticRate($sid);
	
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], 'Stich Particular rate has been successfully delete ', 'SUCCESS');
	
}
?>

<title><?php echo COMPANY_S; ?> -  - Delete stich rate </title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'del_stichRate') )
    {
        //$stockDetails = $stock->showStock($sid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete stich rate. :: <?php echo $sid; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?sid=<?php echo $sid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            Are you sure	that	you	want	to delete the Design No.
            <strong><?php echo $sid;; ?></strong> from Stock, Stock In , Stock Sales, Stock Details and Good Return Tables
