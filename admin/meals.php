...
{
	$link = '';
	$lid = $meals->getAllMealsId('meals_id','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  - Labour Meals</title>
<!-- Style -->
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "add_meals.php"."?action=addMeals"; ?>">
                            Add Meals
                        </a> 
                    </div>
                </div>
                ...
                <div id="data-column">
                    ...
                    <thead>
                      ...
                      <th width="10%" >No Of Meals</th>
					  <th width="10%" >Meals Rate(RS)</th>
					...
					<?php
                       ...
                       $rid = array_slice($lid, $start, $limit);     
                        foreach($lid as $x)
							...
							$mealsDetails = $meals->showMeals($x);
							$labourDtl = $labour->showLabour($mealsDetails[4]);
                    ...
                    ?>
						...
						<td align="center"><?php echo $mealsDetails[1]; ?></td>
						<td align="center"><?php echo $mealsDetails[2]; ?></td>
						<td align="center"><?php echo $mealsDetails[3]; ?></td>
					    <td align="center"><?php echo $labourDtl[1]; ?></td>
						<td align="center"><?php echo $mealsDetails[6]; ?></td>
