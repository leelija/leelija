...
if($txtReason == '')
	...
	else
	{
			  ...
			  $rozelleOrder->addRozOrderCancel($orderDetail[0],$orderDetail[1],$txtReason,$txtProdDesc);
			  $rozelleOrder->UpdateRozOrders($orderDetail[0],'cancel');
			  $rozelleOrder->UpdateRozOrderDetails($orderDetail[0]);
