...
$HandDtl		= $statuscat->showProductHand($dhmckfip);

$customerDetail = $customer->getCustomerData($HandDtl[5]);// HandWorker name display
...
if($OrderDate == '')
	...
	{
		//Edit Dyeing table
	   $statuscat->editHand($dhmckfip,$HandDtl[1],$HandDtl[2],$HandDtl[3],$HandDtl[4],$txtEmpId,$HandDtl[6],
	   $txtFabAmountlft,$txtProdDesc,$OrderDate,$TargetDate,$userData[10],$txtFabAmountcomp,$HandDtl[16],$txtBillNo,$txtParticular);	
		...
		$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], 'hand status has been edit', 'SUCCESS');
	}
}
...
<title><?php echo COMPANY_S; ?> -  - EDIT Hand status</title>
...
<!-- /TinyMCE -->
    ...
    <div class="webform-area">		
		<?php 
        //form
        if( (isset($_GET['action'])) && ($_GET['action'] == 'update_hand') )
        {
...
<h3><a name="editStock">Edit Hand status</a></h3>
          ...
          <form action="<?php $_SERVER['PHP_SELF']?>?action=update_hand&dhmckfip=<?php echo $dhmckfip; ?>" method="post" enctype="multipart/form-data">
		 ...
		 <h2><a name="addUser">Edit Hand status</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<div >
								<label>Hand Worker<span class="orangeLetter">*</span></label>							
							...
							<label>Bill No</label>
							<input name="txtBillNo" id="txtBillNo" type="text" class="text-field" value="<?php echo $HandDtl[17]; ?>" />
							<div class="cl"></div>
							
							<label>Particular</label>
							<input name="txtParticular" id="txtParticular" type="text" class="text-field" value="<?php echo $HandDtl[18]; ?>" />
							<div class="cl"></div>
							
							<label>Left Particular</label>
							<input name="txtFabAmountlft" id="txtFabAmountlft" type="text" class="text-field" value="<?php echo $HandDtl[7]; ?>" />
							<div class="cl"></div>
							<label>Complete Particular</label>
							<input name="txtFabAmountcomp" id="txtFabAmountcomp" type="text" class="text-field" value="<?php echo $HandDtl[15]; ?>" />
							<div class="cl"></div>
							
							<label>Order Date<span class="orangeLetter">*</span></label>
							  <input name="OrderDate" type="date" class="text_box_large" id="OrderDate" 
								value="<?php echo $HandDtl[9]; ?>" size="25"  />
							  <div class="cl"></div>
												
							  <label>Target Date<span class="orangeLetter">*</span></label>
							  <input name="TargetDate" type="date" class="text_box_large" id="TargetDate" 
							  value="<?php echo $HandDtl[10]; ?>" size="25"  />
							  <div class="cl"></div>
