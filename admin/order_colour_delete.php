...
{	
	...
	//delete the orders
	$orders->delOrdDetails($oid_dtl_id);
...
<title><?php echo COMPANY_S; ?> -  - Delete Order colour  </title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'delete_ord_colour') )
    {
        $ordColourDetail = $orders->getOrdersDetails($oid_dtl_id);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Order Colour :: <?php echo $ordColourDetail[0]; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?oid_dtl_id=<?php echo $oid_dtl_id; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td colspan="2" align="left" class=" blackLarge">
            <div class="marT25 padL10 padR10 padB20">
            Are you sure	that	you	want	to delete the order Colour 
            <strong><?php echo $ordColourDetail[0]; ?></strong> from Order Colour table
