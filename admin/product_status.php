...
//echo $keyword;exit;
	if($_POST['type'] ==""){
		$link = '';
		$sid = $search_obj->getProdTableKeyword($keyword);
		//echo $sid;exit;
	}
	else{
		$link = '';
		$sid = $advSearch->getSearchProdStatusSort($keyword,$type);
...
else
{
	...
	$sid = $status->getAllPstatusA('status_id','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
              ...
              <div class="padT30"><!-- --> </div> 
                ...
                <div id="options-area">
                	...
                	<!--<div class="add-new-option">
                    	<a href="<?php //echo "assign_job.php?action=assign_job"; ?>">Assign Job </a>
                    </div>-->
					<!--<a href="downloadfile/product_status.php">Download</a>-->
                </div>
                <!-- eof Options -->
                ...
                <div id="data-column">
                	...
                	<table class="single-column" cellpadding="0" cellspacing="0">
                        ...
                        <thead>
                          ...
                          <th width="18%" >Kali Cutting</th>
						  <th width="18%"  >Final Stiching</th>
                          <th width="13%"  >Iron </th>
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							//$customerDetail = $client->getCustomerData($prodstasDetail[19]);
                    ...
                    ?>
					  ...
					  <td align="center"><?php echo $prodstasDetail[1]; ?></td>
					   ...
					   <td align="center"><?php echo $prodstasDetail[19]; ?></td>
					   ...
					   <td align="center"><a href="dyeing.php?ord_id=<?php echo $prodstasDetail[1];?>"><?php echo $prodstasDetail[6]; ?></a></td>
					   ...
					   <td align="center"><?php echo $prodstasDetail[9]; ?></td>
					    <td align="center"><a href="final_stiching.php?ord_id=<?php echo $prodstasDetail[1];?>"><?php echo $prodstasDetail[10]; ?></a></td>
					   <td align="center"><?php echo $prodstasDetail[11]; ?></td>
					   <td align="center"><?php echo $prodstasDetail[12]; ?></td>
					   	<td align="center"><?php echo $prodstasDetail[13]; ?></td>
