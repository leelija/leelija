		...
		if($txtPurpose =='Production')
			{
				...
				//add the fabric out
				$fabric->addfabricOut($fid,$txtBillNo,'',$txtAmount,$txtPurpose,$txtReceiveBy,$txtProdDesc,$userData[10]);	
				//Update fabric table
				...
				//add the fabric out
				$fabric->addfabricOut($fid,'',$txtDesign,$txtAmount,$txtPurpose,$txtReceiveBy,$txtProdDesc,$userData[10]);	
				//Update fabric table
				$fabric->editFabric($fid,$current_stock,$userData[10]);
			}
