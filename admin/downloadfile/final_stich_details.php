...
$con=mysqli_connect('localhost','raqib','admin123','moni_enterprises');
...
$query = "SELECT * FROM final_stich_details ";
$header = '';
$data ='';
...
header("Content-Disposition: attachment; filename=finalstich_status_details.xls");
