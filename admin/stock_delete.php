...
{	
	...
	$stock->delStockDtlDes($sid);
	//delete the stock in
	$stock->delStockInDtlDes($sid);
	//delete the stock sales
	$stock->delStocksalesDtlDes($sid);
	
	//delete the stock return
	$stock->delStockReturnDtlDes($sid);
...
<title><?php echo COMPANY_S; ?> -  - Delete stock </title>
