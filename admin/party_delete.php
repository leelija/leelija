...
{	
	...
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], "Company has been delete successfully", 'SUCCESS');
	
}
?>

<title><?php echo COMPANY_S; ?> -  - Delete Company </title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'Party_delete') )
    {
        $partyDetails = $party->showParty($pid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Company  :: <?php echo $partyDetails[1]; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?pid=<?php echo $pid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <strong><?php echo $partyDetails[1]; ?></strong> from table
