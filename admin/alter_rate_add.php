...
{	
	...
	$sess_arr	= array('txtDesign','txtParticular','txtParticularRate');
	$utility->addPostSessArr($sess_arr);

	
	//defining error variables
	$action		= 'add_alter_rate';
	...
	if($txtParticular == '')
	{
		echo "Please fill the Particulars field";
	}
	elseif($txtParticularRate == '')
	{
		echo "Please fill the Particulars rate field";
	}
	else
	{
		
	//add the Orders
	    $altrate->addAlterRate($txtDesign,$txtParticular, $txtParticularRate);	
		...
		$uMesg->showSuccessT('success', 0, '', 'alter_rate.php', MSG001, 'SUCCESS');
	}
...
if(isset($_POST['btnCancel']))
{
	...
	//forward
	header("Location: alter_rate.php");
}
?>
...
<title><?php echo COMPANY_S; ?> - Add Alter Rate</title>
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if(isset($_GET['action']) && ($_GET['action'] == 'add_alter_rate')) 
					{	
					?>
                   
                        <h2><a name="addUser">Add Final Stiching Rate</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input name="txtDesign" type="text" class="text_box_large" id="txtDesign" 
					           value="<?php $utility->printSess2('txtDesign',''); ?>"
                              size="25" />
                            <div class="cl"></div>
							...
							<div >
								...
								<select name="txtParticular" type="text" id="txtParticular" class="text_box_large">
									<?php
										$stichRateDtl         = $rate->getParticularGroup();
										foreach ($stichRateDtl as $row){//Array or records stored in $row
										//echo $row[colour_name];
										echo "<option value=$row[particulars]>$row[particulars]</option>"; 
							...
							<div class="cl"></div>                      
                    		<label>Particulars Rate/Pieces <span class="orangeLetter">*</span></label>
