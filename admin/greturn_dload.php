...
$numResDisplay	= (int)$utility->returnGetVar('numResDisplay', 1000);
...
{
	$link = '';
	$sid = $stock->getAllProductReturn('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="options-area">
					...
					<!--<a href="greturn_download.php">Download</a>-->
                ...
                <table >
					...
					<thead>
						<tr>
						  <th>GR Id</th>
						  <th>Design No.</th>
						  <th>GR Pending(pieces)</th>
						  <th>GR Ready(pieces)</th>
						  <th>Colour</th>
						  <th>Party Code</th>
						  <th>Remarks</th>
						  <th>Added Date</th>
				   ...
				   <tbody >
                    ...
                    ?>
						<tr >
						<td ><?php echo $productReturnDetail[0]; ?></td>
						<td ><?php echo $stockDetails[1]; ?></td>
						<td><?php echo $productReturnDetail[2]; ?></td>
					    <td><?php echo $productReturnDetail[6]; ?></td>
						<td><?php echo $productReturnDetail[3]; ?></td>
						<td><?php echo $productReturnDetail[4]; ?></td>
						<td><?php echo $productReturnDetail[5]; ?></td>
					    <td><?php echo $productReturnDetail[7]; ?></td>
