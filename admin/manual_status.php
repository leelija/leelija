...
if((isset($_GET['btnSearch'])) &&($_GET['btnSearch'] == 'search'))
{
	if($_GET['type'] ==""){
		...
		$sid = $search_obj->getManualPipeline($keyword);
	}
	else{
		$link = "&btnSearch=search&keyword=".$_GET['keyword']."&mode=&type=".$_GET['type'];
		$sid = $advSearch->getSearchManuSort($keyword,$type);
...
else
{
	...
	$sid = $statusCat->getAllManualAll('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> - Manual Status</title>
    ...
    <div class="container">
        <div class="inner-container">
          ...
          <div id="search-page-back">
                           		...
                           		<div id="dropdown-page-options">
                                    ...
                                    <div id="dropdown-page-back" style="display:none">
                                       ...
                                       <select name="type" id="type" class="textBoxA">
											...
											<option value="employeeId">Manual Worker Id</option>
               ...
               <a href="downloadfile/manual_status.php">Download</a>
					  ...
					  <?php 
					   ...
					   <?php
						...
						?>  
                         ...
                         [ 
                          <a href="#" onClick="MM_openBrWindow('manual_edit.php?action=update_manual&dhmckfip=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=700,height=600')">
                          Edit					  </a> ]
