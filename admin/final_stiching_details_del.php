...
{	
	...
	//delete the stock
	$statusCat->delFinalStichingDtl($sid);
...
<title><?php echo COMPANY_S; ?> Delete Final stich Details </title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'del_finalStich') )
    {
        $productInDetails = $statusCat->showProductFinalStichDtl($sid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Final stich Details :: <?php echo $productInDetails[0]; ?></h3></td>
    </tr>
    <tr>
      <td>
