...
{
	$link = '';
	$tid = $thread->getAllThread('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  - show thread</title>
<!-- Style -->
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "thread_add.php"."?action=add_thread"; ?>">
                            Add New Thread
                        </a> 
                    </div>
                </div>
                ...
                <div id="data-column">
                    ...
                    ?>  
                    <thead>
                      <th width="3%" height="25"  align="center">Thread Id</th>
                      <th width="10%" >Thread Name </th>
                      <th width="10%" >Current Stock</th>
					   <th width="10%" >Remarks</th>
                      <th width="10%" >Last Transaction Date</th>
					...
					<?php
                       ...
                       $fid = array_slice($tid, $start, $limit);     
                        foreach($tid as $x)
                            {
							//$x = $pageArray[$pageNumber][$j];
							
							$ThreadDetail = $thread->showThread($x);
							//print_r($prodDetail);exit;
							$bgColor 	= $utility->getRowColor($k);	
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					  <td align="left"><?php echo $ThreadDetail[0]; ?></td>
					  <td align="center"><?php echo $ThreadDetail[1]; ?></td>
					   <td align="center"><?php echo $ThreadDetail[2]; ?></td>
					   <td align="center"><?php echo $ThreadDetail[4]; ?></td>
					    <td align="center"><?php echo $ThreadDetail[3]; ?></td>
					  ...
					  [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('thread_in.php?action=in_tid&tid=<?php echo $x; ?>','threadIn','scrollbars=yes,width=750,height=600')">
					  IN					  </a> ]
					  
					  [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('thread_out.php?action=out_tid&tid=<?php echo $x; ?>','threadOut','scrollbars=yes,width=750,height=600')">
					  OUT					  </a> ]
					 
					  [ 
					  <a href="#" onClick="MM_openBrWindow('thread_delete.php?action=del_tid&tid=<?php echo $x; ?>','OrdDelete','scrollbars=yes,width=400,height=350')">
					  delete					  </a> ]<br>
