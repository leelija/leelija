...
{	
	...
	$ratechart->delDyeRate($drid);
	
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], 'Dye rate has been successfully delete ', 'SUCCESS');
	
}
?>

<title><?php echo COMPANY_S; ?> -  - Delete Dye rate </title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'del_DyeRate') )
    {
        //$stockDetails = $stock->showStock($sid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Dye rate. :: <?php echo $drid; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?drid=<?php echo $drid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            Are you sure	that	you	want	to delete the Dye rate
            <strong><?php echo $drid;; ?></strong> from Dye rate  Table
