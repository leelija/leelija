...
if(isset($_POST['btnAddCus'])) 
{
	...
	$txtCompanyName			= "MoniPVT";
	$txtProfession			= "";
	$txtDiscountOffered		= 0;
	
	$intOrder				= 22;
	//$file  					= $_FILES['fileImg'];
	
	$txtWorkas		= $_POST['txtWorkas'];
	...
	elseif( ($txtEmail != '') && (preg_match("/^ER/i",$duplicateId)) )		
	{
		...
		$error->showErrorTA($action, $id, $id_var, $url, "Email already in use", $typeM, $anchor);
	}
	...
	else
	{
		...
		$customerId = $customer->addCustomer( $typeId, $typeId, $txtUserName, $txtEmail, $txtPassword,  $txtfirstName,  $txtLastName, 'na',
											 ...
											 $radioAcc, $txtDiscountOffered,$txtWorkas,$userData[10]); 

		//add the address
		$customer->addCusAddress( $customerId,  $txtAddress1,  '',  '', $txtTownId, $txtCountyId, $txtProvinceId,
								  $txtPostalCode, $txtCountriesId, $txtPhone1, '', $intFax, $intMobile);
		...
		//forward
		$uMesg->showSuccessT('success', 0, '', 'employee.php', SUCUST201, 'SUCCESS');
        ...
        <div class="inner-container">
            ...
            <div class="webform-area">
                ...
                ?>
                    ...
                    <h2><a name="addClient">Add Employee</a></h2>
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="cl"></div>
						 ...
						 <div >
							<label>Work As<span class="orangeLetter">*</span></label>
							    <select name="txtWorkas" type="text" class="text_box_large" id="txtWorkas"  />
                        ...
                        <label>Employee Name/Billing Name<span class="orangeLetter">*</span></label>
