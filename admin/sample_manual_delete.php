...
{	
	...
	//delete the stock
	$sample->delSamManual($sid);
	
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], "Sample manual  has been delete successfully", 'SUCCESS');
	
}
?>

<title><?php echo COMPANY_S; ?> -  - Delete Sample manual </title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'del_manual') )
    {
        $samDetails = $sample->showSamManual($sid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Sample particular :: <?php echo $samDetails[11]; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?sid=<?php echo $sid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <strong><?php echo $samDetails[11]; ?></strong> from table
