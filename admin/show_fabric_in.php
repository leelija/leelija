...
if((isset($_POST['btnSearch'])))
{
	...
	$fid = $search_obj->getFabricInKeyword($keyword);
	
}
else
{
	$link = '';
	$fid = $fabric->getAllFabricIn('fabric_in_id','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  - Fabric In </title>
<!-- Style -->
            ...
            <div id="admin-body">
                ...
                <div id="data-column">
                    ...
                    <thead>
                      ...
                      <th width="10%" >Materials Name </th>
                      <th width="10%" >Quantity</th>
					  <th width="10%" >Company</th>
                      <th width="10%" >from</th>
					  <th width="10%" >price/meter </th>
                      <th width="10%" >Total Amount</th>
					  
					  <th width="10%" >Bill No</th>
					  <th width="10%" >Bill Image</th>
					...
					<?php
                       ...
                       $fid = array_slice($fid, $start, $limit);     
                        foreach($fid as $x)
							...
							$fabricInDetail 	= $fabric->showFabricIn($x);
							
							$pCompanyDtls 		= $pCompany->showPCompany($fabricInDetail[4]);
                    ...
                    ?>
					  ...
					  <td align="center"><?php echo $fabricInDetail[1]; ?></td>
					  <td align="center"><?php echo $fabricInDetail[2]; ?></td>
					  <td align="center"><?php echo $pCompanyDtls[1]; ?></td>
					  <td align="center"><?php echo $fabricInDetail[5]; ?></td>
					  <td align="center"><?php echo $fabricInDetail[6]; ?></td>
					  <td align="center"><?php echo $fabricInDetail[7]; ?></td>
					  <td align="center"><?php echo $fabricInDetail[13]; ?></td>
					   
					   <td align="center">
					 	<?php 
							if(($fabricInDetail[14] != '') && ( file_exists("../images/matbill/".$fabricInDetail[14])) )
							{
								echo $utility->imageDisplay2('../images/matbill/', $fabricInDetail[14], 50, 50, 0, '', $fabricInDetail[0]);
	
							}
						?>
                      </td>
					   
					   <td align="center"><?php echo $fabricInDetail[3]; ?></td>
					   <td align="center"><?php echo $fabricInDetail[8]; ?></td>
					   <td><?php echo $dateUtil->printDate($fabricInDetail[9]); ?></td>
