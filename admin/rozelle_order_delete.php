...
{	
	...
	//delete the Rozelle Orders
	$rozelleOrder->delRozOrd($oid);
	
	//delete the Rozelle Orders Details
	$rozelleOrder->delRozOrdDetaills($oid);
	
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], "Rozelle Order has been successfully delete", 'SUCCESS');
	
}
?>

<title><?php echo COMPANY_S; ?> -  - Delete Rozelle Order </title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'rozelle_ord') )
    {
		$orderDetail = $rozelleOrder->showRozelleOrders($oid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Rozlle order :: <?php echo $orderDetail[0]; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?oid=<?php echo $oid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            Are you sure	that	you	want	to delete the Plan 
            <strong><?php echo $orderDetail[0]; ?></strong> from table
