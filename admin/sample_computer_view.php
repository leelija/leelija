...
<title><?php echo COMPANY_S; ?>View sample computer cost</title>
...
<h3><a name="editStock">View Sample computer cost</a></h3>
    
          
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						<tr class="listheader">
						<th class="listheader">Particular Name </th>
						<th class="listheader">Time </th>						
						<th class="listheader">Computer Design No. </th>
						<th class="listheader">Total Stich</th>
						<th class="listheader">Stich Rate/100</th>
						...
						<?php 
							...
							$SamComputerDtl = $sample->getAllComputerDtl($sid);
							?>	
							<?php $reco_record = 0; 
							//echo "$data[2]";
							...
							$classname="evenRow";
									...
									$classname="oddRow";
									$sa =	$eachrecord ['stich_amount'];
									$sr =	$eachrecord ['material_cost']; 
									$labourCost =	$eachrecord ['stich_amount']/100*$eachrecord ['material_cost'];
						...
						<tr class="table-row" >
							...
							<td align="center"><?php echo $labourCost; ?></td>
							...
							[ 
							<a href="#" 
							  onClick="MM_openBrWindow('sample_computer_delete.php?action=del_computer&sid=<?php echo $eachrecord ['computer_id']; ?>','delComputer','scrollbars=yes,width=400,height=400')">
							  Delete					  </a> ]
