...
//echo $keyword;exit;
	$link = '';
	$cid = $search_obj->getColourMstKeyword($keyword);
	//echo $sid;exit;
}
else
{
	$link = '';
	$cid = $unit->getAllMstColour('colour_name','ASC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> - Colour Master </title>
<!-- Style -->
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="admin-top">
                	<h1>Colour Master Management</h1>
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="#" onClick="MM_openBrWindow('add-colour_mst.php?action=add_img','AddImg','scrollbars=yes,width=700,height=600')">
						  Add New Colour				  
						</a> 
                    </div>
                </div>
					...
					<?php
                       ...
                       $sid = array_slice($cid, $start, $limit);     
                        foreach($cid as $x)
							...
							$MstColouDetail 	= $unit->showMstColour($x);
							//print_r($prodDetail);exit;
							$bgColor 			= $utility->getRowColor($k);	
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					  <td align="left"><?php echo $MstColouDetail[0]; ?></td>
					  <td align="center" ><?php echo $MstColouDetail[1]; ?></td>
					    <td align="center"><?php echo $MstColouDetail[2]; ?></td>
					 <td align="center"><?php echo $MstColouDetail[3]; ?></td>
					  <td >
					  [ 
					  <a href="#" onClick="MM_openBrWindow('color-mst-delete.php?action=del_colourId&cid=<?php echo $MstColouDetail[0]; ?>','OrdDelete','scrollbars=yes,width=400,height=350')">
					  delete					  </a> ]<br>
