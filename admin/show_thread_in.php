...
if((isset($_GET['btnSearch'])) &&($_GET['btnSearch'] == 'search'))
{
	...
	$tid = $search_obj->getProductKeyword($keyword);
	
}
else
{
	$link = '';
	$tid = $thread->getAllThreadIn('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="data-column">
                    ...
                    ?>  
                    <thead>
                      <th width="3%" height="25"  align="center">Thread In Id</th>
                      <th width="10%" >Thread Name </th>
                      <th width="10%" >Thread(pcs)</th>
					...
					<?php
                       ...
                       $tid = array_slice($tid, $start, $limit);     
                        foreach($tid as $x)
							...
							$threadInDetail = $thread->showThreadIn($x);
                    ...
                    ?>
					  ...
					  <td align="center"><?php echo $threadInDetail[1]; ?></td>
					   <td align="center"><?php echo $threadInDetail[2]; ?></td>
					   <td align="center"><?php echo $threadInDetail[4]; ?></td>
					   <td align="center"><?php echo $threadInDetail[5]; ?></td>
					   <td align="center"><?php echo $threadInDetail[6]; ?></td>
					   <td align="center"><?php echo $threadInDetail[7]; ?></td>
					   <td align="center"><?php echo $threadInDetail[8]; ?></td>
					   <td align="center"><?php echo $threadInDetail[9]; ?></td>
