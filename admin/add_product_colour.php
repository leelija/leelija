...
{	
	...
	if($selNum=='')
	{
		$error->showErrorTA($action, $id, $id_var, $url, "Select number of colour", $typeM, $anchor);
	}
	...
	else
	{
		for($i=0; $i < $selNum; $i++)
			{
				//add colour
				$stock->addColour($_POST['txtDesignNo'][$i], $_POST['txtProductColour'][$i]);
		...
		$uMesg->showSuccessT('success', 0, '', 'product_colour.php', "Product colour has been successfully add", 'SUCCESS');
	}
...
if(isset($_POST['btnCancel']))
{
	...
	$sess_arr	= array('txtDesignNo','txtProductColour');
	...
	//forward
	header("Location: product_colour.php");
}
?>
...
<script type="text/javascript" src="../js/add-color.js"></script>
<!-- eof JS Libraries -->
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if(isset($_GET['action']) && ($_GET['action'] == 'add_pcolour')) 
					{	
					?>
                   
                        <h2><a name="addUser">Add New Design colour</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<tr>
								...
								<td align="left" class="bodyText pad5">
									...
									?>
									  <select name="selNum" id="selNum" onchange="return getAddColour();"
									   class="textBoxA">
