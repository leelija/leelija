...
if($txtDesign == '')
	...
	else
	{
		...
		for($i=0; $i < $selNum; $i++)
			{
				...
				$ratechart->addHandRate($txtDesign,$_POST['txtWorker'][$i],$_POST['txtParticular'][$i],$_POST['txtAmountPiece'][$i],$_POST['txtOtherCost'][$i],$_POST['txtWorktime'][$i]);	
			}	
		...
		$uMesg->showSuccessT('success', 0, '', "hand_rate_chart.php", "Hand rate has been successfully added", 'SUCCESS');
	}
}

if(isset($_POST['btnCancel']))
{
	header("Location: hand_rate_chart.php");
}
...
<title><?php echo COMPANY_S; ?> - Add Hand rate</title>
...
<script type="text/javascript" src="../js/ratechart.js"></script>
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if( (isset($_GET['action'])) && ($_GET['action'] == 'add_hand_rate') )
					{	
					?>
                   
                        <h2><a name="addUser">Add Hand Rate</a></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<tr>
									<label>Select No. Particular</label>
									...
									$arr_label	= range(1,8);
									?>
									  <select name="selNum" id="selNum" onchange="return getHandRate();"
									   class="textBoxA">
