...
{	
	...
	//add the Party
	 $party->addParty($txtPartyName, $txtAddress, $txtCity, $txtPhone,$txtEmail,$txtBrokar,$txtRetaHol,$userData[10]);	
		...
		$uMesg->showSuccessT('success', 0, '', 'party.php', 'party has been successfully added', 'SUCCESS');
	}
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if(isset($_GET['action']) && ($_GET['action'] == 'add_party')) 
					{	
					?>
                   
                        <h2><a name="addUser">Add Party</a></h2>
