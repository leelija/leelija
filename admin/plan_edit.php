...
{	
	...
	$txtEndDate	 	    = $_POST['txtEndDate'];
		...
		$sess_arr	= array($pid,'txtDesignNo','txtQuantity','txtEmpId','txtStartDate','txtEndDate');
...
if($txtDesignNo == '')
	{
		echo "Please fill the Design no.";
	}
	...
	{
		//Update Plan
	    $plan->editPlan($pid,$txtDesignNo,$txtQuantity,$txtEmpId,$txtStartDate,$txtEndDate);	
...
<h3><a name="editStock">Update plan</a></h3>
		 ...
		 <h2><a name="addUser">Update Plan</a></h2>
                        <span>Please fill following field</span>
