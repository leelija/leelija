...
$con=mysqli_connect('localhost','safikul','monimonimoni2030','moni_enterprises');
...
$query = "SELECT * FROM rozelle_orders where order_date BETWEEN DATE_SUB(NOW(), INTERVAL 2 MONTH) AND NOW()";
$header = '';
$data ='';
...
header("Content-Disposition: attachment; filename=rozelle_orders.xls");
