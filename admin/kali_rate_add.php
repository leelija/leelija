...
{	
	...
	$sess_arr	= array('txtKaliName','txtKaliType','txtRate');
	$utility->addPostSessArr($sess_arr);

	
	//defining error variables
	$action		= 'add_kali_rate';
	...
	if($txtKaliType == '')
	{
		echo "Please fill the Kali Type field";
	}
	elseif($txtRate == '')
	{
	...
	//add the Orders
	    $rate->addKaliRate($txtKaliName,$txtKaliType, $txtRate);	
		...
		$uMesg->showSuccessT('success', 0, '', 'kali_rate.php', MSG001, 'SUCCESS');
	}
...
<title><?php echo COMPANY_S; ?> - Add kali rate</title>
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if(isset($_GET['action']) && ($_GET['action'] == 'add_kali_rate')) 
					{	
					?>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input name="txtKaliName" type="text" class="text_box_large" id="txtKaliName" 
					           value="<?php $utility->printSess2('txtKaliName',''); ?>"
                              size="25" />
                            <div class="cl"></div>
                          
                           <div class="cl"></div>                      
                    		<label>Type Of Kali<span class="orangeLetter">*</span></label>
                            <input name="txtKaliType" type="text" class="text_box_large" id="txtKaliType" 
					           value="<?php $utility->printSess2('txtKaliType',''); ?>"
                              size="25" />
                            <div class="cl"></div>
