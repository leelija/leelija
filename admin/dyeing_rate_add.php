...
if(count($selNum) == '')
	...
	else
	{
		...
		for($i=0; $i < $selNum; $i++)
			{
				...
				$ratechart->addDyeRate($_POST['txtWorker'][$i],$_POST['txtProductType'][$i],$_POST['txtAmountPiece'][$i],$_POST['txtWorktime'][$i],'');	
			}	
		...
		$uMesg->showSuccessT('success', 0, '', "dyeing_rate.php", "Dye rate has been successfully added", 'SUCCESS');
	}
}

if(isset($_POST['btnCancel']))
{
	header("Location: dyeing_rate.php");
}
...
<title><?php echo COMPANY_S; ?> - Add Dye rate</title>
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if( (isset($_GET['action'])) && ($_GET['action'] == 'add_dye_rate') )
					{	
					?>
                   
                        <h2><a name="addUser">Add Dyeing Rate</a></h2>
