...
{
	$link = '';
	$rid = $rate->getAllStichRateAll('rate_id','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
            ...
            <div id="admin-body">
                ...
                <div id="data-column">
					...
					<!--  [ 
					  ...
					  [ 
					  <a href="#" onClick="MM_openBrWindow('stich_rate_delete.php?action=del_stichRate&sid=<?php echo $StichRateDetails[0]; ?>','DeleteStichRate','scrollbars=yes,width=400,height=350')">
					  Delete					  </a> ]<br>
