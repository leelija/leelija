...
//echo $keyword;exit;
	$link = '';
	$rid = $search_obj->getStitchPartRateKeyword($keyword);
	//echo $sid;exit;
}
...
{
	$link = '';
	$rid = $rate->getAllStichPartRateAll('rate_id','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  - Stitching Particular rate</title>
<!-- Style -->
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div id="admin-top">
                	<h1>Stitch Particular rate Details</h1>
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "stitch-part-rate-add.php"."?action=add_stich_rate"; ?>">
                            Add Particular and Rate
                        </a> 
                    </div>
                </div>
                <!-- eof Options -->
                ...
                <div id="data-column">
					...
					<?php
                       ...
                       $rid = array_slice($rid, $start, $limit);     
                        foreach($rid as $x)
							...
							$StichRateDetails = $rate->showStitchPartRate($x);
					...
					<!--  [ 
					  ...
					  [ 
					  <a href="#" onClick="MM_openBrWindow('del-stparticular.php?action=del_stichRate&sid=<?php echo $StichRateDetails[0]; ?>','DeleteStichRate','scrollbars=yes,width=400,height=350')">
					  Delete					  </a> ]<br>
