	...
	<h3><a name="editStock" >Payment Slip</a></h3>
		...
		<!-- Display Data -->
                <div id="data-column">
                	...
                	<?php 
						$labourDetails = $labour->showLabour($lid);
						...
						<form class="voucher-form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<div style="width: 100%; height:40px;">
								...
								<div style="float:right; width:45%;">
									Total Rs.:&nbsp;<span class="vtext"><?php echo $labourDetails[5];?></span>
								</div>
							</div>
							
							<div style="width: 100%; height:40px;">
								Rupee:&nbsp;<span class="vtext"><?php echo convert_number_to_words($labourDetails[5]); ?></span>
							</div>
							<div style="width: 100%; height:40px;">
								<div style="float:left; width:45%;">
							...
							<div style="width: 100%; height:40px;">
								<div style="float:left; width:45%;">
									Payment by:<span class="vtext"><?php echo $userData[10];?></span>
								</div>
								<div style="float:right; width:45%;">
