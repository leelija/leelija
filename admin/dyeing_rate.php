...
{
	$link = '';
	$rid = $ratechart->getAllDyeingRateId('drate_chart_id','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  - Dyeing rate</title>
<!-- Style -->
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "dyeing_rate_add.php"."?action=add_dye_rate"; ?>">
                            Add Dyeing Rate
                        </a> 
                    </div>
                </div>
                ...
                <div id="data-column">
                    ...
                    <thead>
						...
						<th width="10%">Fabric rate/meter</th>
					...
					<?php
                       ...
                       $rid = array_slice($rid, $start, $limit);     
                        foreach($rid as $x)
							...
							$DyeRateDetails = $ratechart->showDyeRate($x);
							//print_r($prodDetail);exit;
							$bgColor 	= $utility->getRowColor($k);	
                    ?>
                    <tr align="left"<?php $utility->printRowColor($bgColor);?>>
						<td align="left"><?php echo $DyeRateDetails[0]; ?></td>
						<td align="center"><?php echo $DyeRateDetails[1]; ?></td>
						<td align="center"><?php echo $DyeRateDetails[2]; ?></td>
						<td align="center"><?php echo $DyeRateDetails[3]; ?></td>
						<td align="center"><?php echo $DyeRateDetails[4]; ?></td>
					...
					<!--  [ 
					  ...
					  [ 
					  <a href="#" onClick="MM_openBrWindow('dye_rate_delete.php?action=del_DyeRate&drid=<?php echo $DyeRateDetails[0]; ?>','DeleteStichRate','scrollbars=yes,width=400,height=350')">
					  Delete					  </a> ]<br>
