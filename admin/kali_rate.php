...
{
	$link = '';
	$rid = $rate->getAllKaliRateAll('kali_rate_id','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> -  - Kali rate</title>
<!-- Style -->
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "kali_rate_add.php"."?action=add_kali_rate"; ?>">
                            Add Klai Rate
                        </a> 
                    </div>
                </div>
                ...
                <div id="data-column">
                    ...
                    <thead>
                      ...
                      <th width="10%" >Kali Type</th>
					   <th width="10%" >Kali Rate(RS.)</th>
					...
					<?php
                       ...
                       $rid = array_slice($rid, $start, $limit);     
                        foreach($rid as $x)
							...
							$KaliRateDetails = $rate->showKaliRate($x);
                    ...
                    ?>
					  ...
					  <td align="center"><?php echo $KaliRateDetails[1]; ?></td>
					   <td align="center"><?php echo $KaliRateDetails[2]; ?></td>
					   <td align="center"><?php echo $KaliRateDetails[3]; ?></td>
					...
					<!--  [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('stich_rate_edit.php?action=stich_rate&rid=<?php echo $KaliRateDetails[0]; ?>','editStichRate','scrollbars=yes,width=750,height=600')">
					  Edit					  </a> ] -->
					  
					  
					 
					  [ 
					  <a href="#" onClick="MM_openBrWindow('kali_rate_delete.php?action=del_stichRate&sid=<?php echo $KaliRateDetails[0]; ?>','DeleteStichRate','scrollbars=yes,width=400,height=350')">
					  Delete					  </a> ]<br>
                  ...
                  <div class="first-column">
                        ...
                        <div class="pagination-bottom">
                            <div class="upper-block">Total Kali Rate(s): <?php echo count($rid);?></div>
                         <?php echo $pagination ?>
                        </div>
