...
$stockDtls		= $stock->stockAllDisplay();
            ...
            <div id="admin-body">
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
					...
					<a href="stock_download.php">Download</a>
                </div>
                      ...
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><?php echo date_format($date,"m/d/Y"); ?></td>
					   	...
					   	<td >
							...
							<p href="#" 
						  onClick="MM_openBrWindow('stock_prod_in.php?action=edit_sid&sid=<?php echo $eachRecord['stock_id']; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
						  Product In					  </p> 
						 
						    
							<p href="#" 
						  onClick="MM_openBrWindow('product_sale.php?action=edit_sid&sid=<?php echo $eachRecord['stock_id']; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
						  Sales					  </p> 
					   ...
					   <!--   [ 
						...
						?>		
								<p href="#" 
								  onClick="MM_openBrWindow('stock_edit.php?action=edit_sid&sid=<?php echo $eachRecord['stock_id']; ?>','stockEdit','scrollbars=yes,width=750,height=600')">
								  Edit Design No					  </p> 
						<?php
							}
							?>
