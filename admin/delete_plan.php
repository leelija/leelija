...
{	
	...
	//forward
	$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], PLODOD003, 'SUCCESS');
...
<table class="tblBrd" align="center" width="100%">
    ...
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Plan :: <?php echo $planDetails[0]; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?pid=<?php echo $pid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <strong><?php echo $planDetails[0]; ?></strong> from table
