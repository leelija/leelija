...
if((isset($_GET['btnSearch'])) &&($_GET['btnSearch'] == 'search'))
{
	if($_GET['type'] ==""){
		...
		$sid = $search_obj->getComputerPipeline($keyword);
	}
	else{
		$link = "&btnSearch=search&keyword=".$_GET['keyword']."&mode=&type=".$_GET['type'];
		$sid = $advSearch->getSearchCompSort($keyword,$type);
...
else
{
	...
	$sid = $statusCat->getAllComputerAll('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> - Computer Status</title>
    ...
    <div class="container">
        <div class="inner-container">
          ...
          <div id="search-page-back">
                           		...
                           		<div id="dropdown-page-options">
                                    ...
                                    <div id="dropdown-page-back" style="display:none">
                                       ...
                                       <select name="type" id="type" class="textBoxA">
											...
											<option value="employeeId">Computer Worker Id</option>
               ...
               <a href="downloadfile/computer_status.php">Download </a>
              <div class="padT30"><!-- --> </div> 
                ...
                <div id="data-column">
					...
					<!--	  <th width="7%" >dhmckfip</th>
						  ...
						  <th width="10%"  >Computer worker</th>
						  <th width="10%"  >Bill No.</th>
						  <th width="10%"  >Particulars</th>
						  <th width="14%" >Computer Design Number</th>
                          <th width="13%"  >Order Date </th>
                          <th width="10%" >Target Date</th>
						  <th width="10%" >R.day</th>
						  <th width="18%"  >Computer(left)</th>
                          <th width="18%"  >Computer(complete)</th>
					  ...
					  <?php 
					   ...
					   <?php
						...
						?>  
                         ...
                         [ 
                          <a href="#" onClick="MM_openBrWindow('computer_edit.php?action=update_comp&dhmckfip=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=700,height=600')">
                          Edit				  </a> ]
