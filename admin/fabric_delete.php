...
<title><?php echo COMPANY_S; ?> -  - Delete Fabric </title>
...
<table class="tblBrd" align="center" width="100%">
	...
	<?php 
    //delete form
    if( (isset($_GET['action'])) && ($_GET['action'] == 'del_fid') )
    {
        $FabricDetail = $fabric->showFabric($fid);
    ?>
    <tr class=''>
	  <td height="25" align='left' bgcolor="#EEEEEE"><h3>Delete Fabric :: <?php echo $FabricDetail[0]; ?></h3></td>
    </tr>
    <tr>
      <td>
      <form action="<?php $_SERVER['PHP_SELF']?>?fid=<?php echo $fid; ?>" method="post">
        <table width="100%"  border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            Are you sure	that	you	want	to delete the Fabric 
            <strong><?php echo $FabricDetail[0]; ?></strong> from table
