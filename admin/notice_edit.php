...
$news_id		= $utility->returnGetVar('news_id','');

$newsDtl		= $news->showNewsData($news_id);
...
<title><?php echo COMPANY_S; ?>-News Edit</title>
...
<div class="popup-form">
    ...
    if( (isset($_GET['action'])) && ($_GET['action'] == 'edit_news') )
    {
        ...
        <form action="<?php $_SERVER['PHP_SELF']?>" method="post" enctype="multipart/form-data">
                       ...
                       <div class="cl"></div>
                        ...
                        <select name="txtParentId" id="txtParentId" tabindex="2">
                          ...
                          {
                            $category->categoryDropDown($newsDtl[7],0,1,'add',0,'news_categories');
                          }
                          ?>
                        </select>
                         <div class="cl"></div> 
                        ...
                        value="<?php echo $newsDtl[0]; ?>" size="25">
                        <div class="cl"></div>
