...
<!-- /TinyMCE -->
    ...
    <div class="webform-area">		
        ...
        if( (isset($_GET['action'])) && ($_GET['action'] == 'bill-review') )
        {
			...
			$sampleBillDetails  	= $bill->showSampleBillingDtl($bid);
			
			$sampBillDtls 			= $bill->allSampleBilling($bid);
        ...
        ?>
			...
			<div id="PrintForm" style="padding-left:60px;"><!-- start Print -->
				<h2 style="text-align: center;"><a name="addUser">Challan <?php echo $sampBillDtls[3];?></a></h2>
				<div style="width: 100%;">
                ...
                <div id="data-column" style="position:relative; bottom: 9px; font-size:12px;">
					...
					<h3>Remark: <?php echo $sampBillDtls[8];?></h3>
					<p>Date: <?php echo date_format($ordDate,"d/m/Y"); ?></p>
