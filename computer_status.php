...
if((isset($_GET['btnSearch'])) &&($_GET['btnSearch'] == 'search'))
{
	...
	$sid = $search_obj->getComputerPipeline($keyword ,$userId);
...
//echo $keyword;exit;
	if($_POST['type'] ==""){
		...
		$link = '';
		$sid = $advSearch->getCommonSearch($keyword,$type,$userId,'computer_id','computer_table');
	}		
}
...
else
{
	...
	$sid = $statusCat->getAllComputer('added_on','DESC',$userId);
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
			  ...
			  <!-- Download option -->
                <div id="options-area">
					<a href="file_download.inc.php?table=computer_table">Download</a>
					<a href="computer-status-download.php">Download & view</a>
                </div>
                <!-- eof Download option -->
                ...
                <div id="data-column">
                	...
                	<table style="width:100%" class="single-column" cellpadding="0" cellspacing="0">
                        ...
                        ?>  
                        <thead >
					<!--	  <th width="5%" >Computer Id</th>
						  <th width="5%" >Status Id </th>     -->
                          ...
                          <th width="5%"  >Computer(complete)</th>
                       ...
                       $sid = array_slice($sid, $start, $limit);     
                        foreach($sid as $x)
							...
							$statusCatDetail = $statusCat->showProductComputer($x);
							
							$customerDetail = $client->getCustomerData($statusCatDetail[5]);
							
							$ordDtls 		= $order->showOrders($statusCatDetail[2]);
							// update factory
							$status->updatePipeLine($statusCatDetail[2],$ordDtls[14],'computer_table');
			...
			<!--		  <td align="left"><?php //echo $statusCatDetail[0]; ?></td>
					  <td align="center"><?php //echo $statusCatDetail[1]; ?></td>    -->
						...
						<td align="center">
							<p href="#" onClick="MM_openBrWindow('cbill-change.php?action=bill_details&id=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=500,height=400')">
					   ...
					   <?php
						...
						if($statusCatDetail[7]>0)
						   ...
						   ?>
						<td align="center"><?php echo $statusCatDetail[20]; ?></td>	
						<td align="center"><?php echo $statusCatDetail[22]; ?></td>
					   ...
					   if($statusCatDetail[7] == 0)
						{
							$statusCat->editComputerstatus($statusCatDetail[0],'Complete');
					   ?>
					   ...
					   <?php
								...
								if($statusCatDetail[15]==0)
								{
									...
									{
										$statusCat->editComputerstatus($statusCatDetail[0],'Running');
									}	
									else{
										$statusCat->editComputerstatus($statusCatDetail[0],'Incomplete');
									}
								}
								else{
									$statusCat->editComputerstatus($statusCatDetail[0],'Running');
					   ...
					   <?php
						...
						?>  
                         ...
                         [ 
                          <a href="#" onClick="MM_openBrWindow('computer_update.php?action=update_comp&dhmckfip=<?php echo $statusCatDetail[0]; ?>','AdminDelete','scrollbars=yes,width=700,height=600')">
                          Update Computer					  </a> ]
