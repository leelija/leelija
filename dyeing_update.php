...
if($txtAmount == '')
	...
	{
		//Edit Dyeing table
	  if($txtAmount <= $DyeingDtl[7]){	
	   $statuscat->editDyeing($dhmckfip,$DyeingDtl[1],$DyeingDtl[2],$DyeingDtl[3],$DyeingDtl[4],$DyeingDtl[5],$DyeingDtl[6],
	   $leftAmount,$DyeingDtl[8],$DyeingDtl[9],$DyeingDtl[10],$customerDtl[16],$completeTotal,$txtStatus,$DyeingDtl[17],$DyeingDtl[18]);	
...
<h3><a name="editStock"></a></h3>
		 ...
		 <h2><a name="addUser">Update dyeing status</a></h2>
		 
					<h2>->Order Id <?php echo $DyeingDtl[2];?>&nbsp;->Design No.<?php echo $DyeingDtl[3];?></h2>
                        <!--<span>Please  <span class="required"></span>fill the amount field.</span>-->
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                        <?php 
							if($DyeingDtl[7] == 0)
							{
								echo "SORRY!..Update has been completed.. ";
						?>
								<div class="cl"></div>
						...
						<!---	
					        ...
					        value=<?php echo $DyeingDtl[7];?> size="25" />
                            <div class="cl"></div>
