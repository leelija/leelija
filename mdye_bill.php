...
$rDyeBilldata 	= $bill->showRFRIBill('mep_dye_bbook');
                	...
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						?>
							<tr align="left"<?php $utility->printRowColor($bgColor);?>>
								...
								<td>
									<p 
									onClick="MM_openBrWindow('mdye-bill-review.php?action=bill-review&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									View					  
									</p> 
									
									<p 
									onClick="MM_openBrWindow('#?action=bill-update&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','align=right','scrollbars=yes,width=450,height=600')">
									Payment					  
									</p>
								</td>
							</tr>
