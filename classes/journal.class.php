...
class Journal
{
	...
	*	@return int
	*/
	function addJournalAcc($jacc_name,$jacc_desc,$balance,$added_by)
	
	{
		...
		$insert		=   "INSERT INTO journal_account
	...
	function UpdateJournalAccount($jacc_id, $jacc_name,$jacc_desc,$balance,$modified_by)
	{
	...
	*	@return array				
	*/
	function showJournalAcc($jacc_id)
	{
		//declare vars
		$data = array();
		//statement
		$select = "SELECT * FROM journal_account
	...
	*			
	*/
	public function getAllJournalAcc(){
     $temp_arr = array();
     $res = mysql_query("SELECT * FROM journal_account order by jacc_name ASC") or die(mysql_error());        
	...
	*	@return int
	*/
	function addJournalBook($jacc_id,$expenses_purpose,$payment_type,$pay_amount,$payment_received,$prepared_by,$status,$added_by,$added_on)
	
	{
		...
		//satement to insert in stock table
		$insert		=   "INSERT INTO journal_book
	...
	function UpdateJournalBook($jb_id,$jacc_id,$payment_type,$pay_amount,$payment_received,$prepared_by,$modified_by)
	{
		$jacc_id			  	   	=	mysql_real_escape_string(trim($jacc_id));
		$payment_type			  	=	mysql_real_escape_string(trim($payment_type));
		$pay_amount			   		=	mysql_real_escape_string(trim($pay_amount));
	...
	//Update Journal Book table
	function UpdatejBookPayment($jb_id,$status,$modified_by)
	{
		$status			  	   		=	mysql_real_escape_string(trim($status));
		$modified_by			    =	mysql_real_escape_string(trim($modified_by));
	...
	*	@return array				
	*/
	function showJournalBook($jb_id)
	{
		//declare vars
		$data = array();
		//statement
		$select = "SELECT * FROM journal_book
				   WHERE jb_id	= '$jb_id'";
		//execute query
		$query	= mysql_query($select);
		//echo $select.mysql_error();exit;
	...
	*			
	*/
	public function getAllJournalBook(){
     $temp_arr = array();
     $res = mysql_query("SELECT * FROM journal_book order by jb_id desc") or die(mysql_error());        
     $count=mysql_num_rows($res);
	...
	*			
	*/
	public function getAlldJBook(){
     $temp_arr = array();
     $res = mysql_query("SELECT * FROM journal_book order by jb_id desc limit 60") or die(mysql_error());        
     $count=mysql_num_rows($res);
	...
	*//*===============================*/
	 public function conDailyExp($todate,$fromdate){
     $temp_arr = array();
     $res = mysql_query("SELECT sum(pay_amount) AS `count_amount` FROM `journal_book` 
	...
	// Display Daily expenses Journal account wise
	 public function getdailyExpAccwise($todate,$fromdate){
     $temp_arr = array();
     $res = mysql_query("SELECT SUM(pay_amount),jacc_id FROM journal_book WHERE added_on between '$todate' and '$fromdate'
	...
	/*==============================*/
	/* Total daily expenses on Particular date
	*//*===============================*/
	 public function TcntDailyExp($todate){
     $temp_arr = array();
     $res = mysql_query("SELECT sum(pay_amount) AS `count_amount` FROM `journal_book` 
	 WHERE added_on = '$todate'") or die(mysql_error());        
     $count=mysql_num_rows($res);
	...
	*	@return int
	*/
	function addAssets($assets_type,$assets_name,$balance,$added_by)
	...
	function UpdateAssets($assets_id, $assets_type,$assets_name,$balance,$modified_by)
	{
		$assets_type			  	   	=	mysql_real_escape_string(trim($assets_type));
		$assets_name			  	   	=	mysql_real_escape_string(trim($assets_name));
		$balance			   			=	mysql_real_escape_string(trim($balance));
	...
	*	@return array				
	*/
	function showAssetsAcc($assets_id)
	{
		//declare vars
		$data = array();
		//statement
	...
	*			
	*/
	public function getAllAssetsAcc(){
     $temp_arr = array();
     $res = mysql_query("SELECT * FROM assets order by assets_name ASC") or die(mysql_error());        
     $count=mysql_num_rows($res);
	...
	*	@return int
	*/
	function addAssetsHist($assets_id,$balance,$purpose,$assets_source,$note,$added_by)
	
	{
		...
		//satement to insert in stock table
		$insert		=   "INSERT INTO assets_hist
						(assets_id,balance,purpose,assets_source,note,added_by, added_on)
						VALUES
						('$assets_id','$balance','$purpose','$assets_source','$note','$added_by',now())
	...
	*			
	*/
	public function getAllAssetsHist(){
     $temp_arr = array();
     $res = mysql_query("SELECT * FROM assets_hist order by assets_hist_id desc") or die(mysql_error());        
     $count=mysql_num_rows($res);
