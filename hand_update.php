...
{	
	...
	$leftAmount			= $HandDtl[7]-$txtAmount;
	$completeTotal		= $HandDtl[15]+$txtAmount;	
...
if($txtAmount == '')
	...
	{
		 if($txtAmount <= $HandDtl[7]){
		//Edit Dyeing table
		$statuscat->editHand($dhmckfip,$HandDtl[1],$HandDtl[2],$HandDtl[3],$HandDtl[4],$HandDtl[5],$HandDtl[6],
		$leftAmount,$HandDtl[8],$HandDtl[9],$HandDtl[10],$customerDtl[16],$completeTotal,$txtStatus,$HandDtl[17],$HandDtl[18]);	
	   
		$prodStatusDtl	=$prodStatus->showProductStat($HandDtl[1]);
	   
		$prodStatus->editStatus($HandDtl[1],$prodStatusDtl[1],$prodStatusDtl[2], $prodStatusDtl[19],$prodStatusDtl[3],
		$prodStatusDtl[4], $prodStatusDtl[5],$prodStatusDtl[6],$txtStatus,$prodStatusDtl[8],$prodStatusDtl[18],$prodStatusDtl[9],
...
<!-- /TinyMCE -->
    ...
    <div class="webform-area">		
        ...
        if( (isset($_GET['action'])) && ($_GET['action'] == 'update_hand') )
        {
            ...
            $HandDetails = $statuscat->showProductHand($dhmckfip);
        ?>
...
<h3><a name="editStock">Edit Hand status</a></h3>
		 ...
		 <h2>->Order Id <?php echo $HandDetails[2];?>->Design No.<?php echo $HandDetails[3];?></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<label>Hand Amount<span class="orangeLetter">*</span></label>
                            <input name="txtAmount" type="text" class="text_box_large" id="txtAmount" 
					        value=<?php echo $HandDetails[7];?> size="25" />
                            <div class="cl"></div>
