...
{	
	...
	//echo $txtStatus;exit;
	$leftAmount			= 0;
	$completeTotal		= $PackingDtl[15]+$txtAmount;	
...
if($txtAmount == '')
	...
	else
	{
	   ...
	   $statuscat->editPacking($dhmckfip,$PackingDtl[1],$PackingDtl[2],$PackingDtl[3],$PackingDtl[4],$txtEmp,$PackingDtl[6],
	   $leftAmount,$PackingDtl[8],$PackingDtl[9],$PackingDtl[10],$customerDtl[16],$completeTotal,$txtStatus);	
	   
	   $prodStatusDtl	=$prodStatus->showProductStat($PackingDtl[1]);
	   
	   $prodStatus->editStatus($PackingDtl[1],$prodStatusDtl[1],$prodStatusDtl[2], $prodStatusDtl[19],$prodStatusDtl[3],
	   ...
	   $prodStatusDtl[9],$prodStatusDtl[10],$prodStatusDtl[11],$txtStatus,$prodStatusDtl[13],$prodStatusDtl[20]);
		...
		$orders->editOrderSubmit($PackingDtl[2]);
...
<!-- /TinyMCE -->
    ...
    <div class="webform-area">		
        ...
        if( (isset($_GET['action'])) && ($_GET['action'] == 'update_packing') )
        {
            ...
            $PackingDetails = $statuscat->showProductPaking($dhmckfip);
        ?>
		
<h3><a name="editStock">Edit Packing status</a></h3>
    
          <form action="<?php $_SERVER['PHP_SELF']?>?action=update_packing&dhmckfip=<?php echo $dhmckfip; ?>" method="post" enctype="multipart/form-data">
         
		 
		 <h2><a name="addUser">Edit Packing status</a></h2>
		 <h2>->Order Id <?php echo $PackingDetails[2];?>&nbsp;->Design No. <?php echo $PackingDetails[3];?></h2>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                            ...
                            <input name="txtEmp" type="text" class="text_box_large" id="txtEmp" 
					         value="<?php echo $PackingDetails[5];?>" size="25" />
                            <div class="cl"></div>
                            ...
                            <input name="txtAmount" type="text" class="text_box_large" id="txtAmount" 
					         value="<?php echo $PackingDetails[7];?>" size="25" />
                            <div class="cl"></div>
