...
$rStitchBilldata = $bill->showRFRIBill('mep_fs_bbook');
                	...
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						?>
							<tr align="left"<?php $utility->printRowColor($bgColor);?>>
								...
								<td>
									<p 
									onClick="MM_openBrWindow('mstitch-bill-review.php?action=bill-review&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									View					  
									</p> 
								</td>
							</tr>
