...
//echo $keyword;exit;
	$link = '';
	$pids = $pCompany->getPcompanyKeyword($keyword);
	//echo $sid;exit;
}
else
{
	$link = '';
	$pids = $pCompany->getAllPcompany('company_id','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
...
<title><?php echo COMPANY_S; ?> Purchase Company Management</title>
<!-- Style -->
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "pcompany_add.php"."?action=add_company"; ?>">
                            Add New Record
                        </a> 
                    </div>
					Company List: <a href="">Download</a>
                </div>
					...
					<?php
                       ...
                       $pids = array_slice($pids, $start, $limit);     
                        foreach($pids as $x)
							...
							$pCompanyDetail = $pCompany->showPCompany($x);
							//print_r($prodDetail);exit;
							$bgColor 	= $utility->getRowColor($k);	
                    ?>
						<tr align="left"<?php $utility->printRowColor($bgColor);?>>
						<td align="center"><?php echo $k; ?></td>
						<td align="center"><?php echo $pCompanyDetail[1]; ?></td>
						<td align="center"><?php echo $pCompanyDetail[2]; ?></td>
						<td align="center"><?php echo $pCompanyDetail[3]; ?></td>
						<td align="center"><?php echo $pCompanyDetail[4]; ?></td>
						<td align="center"><?php echo $pCompanyDetail[5]; ?></td>
					    <td align="center"><?php echo $pCompanyDetail[7]; ?></td>
						<td align="center"><?php echo $pCompanyDetail[6]; ?></td>
