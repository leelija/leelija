...
{	
	...
	if($txtFabName == '')
	{
		echo "Please fill the Materials/Fabric Name field";
	}
	/*elseif( ($txtFabName != '') && (preg_match("/^ER/i",$duplicateId)) )		
	{
		$error->showErrorTA($action, $id, $id_var, $url, "Material/Fabrics Name And Colour already in use", $typeM, $anchor);
	}
	*/
	else
	{
		//add the Fabric/Material
	    $mmats->addMmaterials($txtFabName,$txtColour,$txtMatType,$txtFabUnit, '', $txtProdDesc, $userData[2]);	
		//deleting the sessions
		$utility->delSessArr($sess_arr);
		
		//forward the web page
		$uMesg->showSuccessT('success', 0, '', 'mmaterials.php', "New Material/Fabric add successfully ", 'SUCCESS');
	}
                ...
                <div class="webform-area">
					...
					?>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                            <div class="cl"></div>                      
                    		<label>Materials/Fabrics Name <span class="orangeLetter">*</span></label>
                            <input name="txtFabName" type="text" class="text_box_large" id="txtFabName" 
					           value="<?php $utility->printSess2('txtFabName',''); ?>"
                              size="25" />
                            <div class="cl"></div>
							<div >
								<label>Materials/Fabrics Colour<span class="orangeLetter">*</span></label>							
							...
							<div class="cl"></div>                      
                    		<label>Materials/Fabric Unit <span class="orangeLetter">*</span></label>
                            <input name="txtFabUnit" type="text" class="text_box_large" id="txtFabUnit" 
					           value="<?php $utility->printSess2('txtFabUnit',''); ?>"
                              size="25" />
                            <div class="cl"></div>
						   <label>Materials/fabric Type <span class="orangeLetter">*</span></label>
