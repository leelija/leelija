...
$journalBook	= $journal->getAlldJBook();

$numResDisplay	= (int)$utility->returnGetVar('numResDisplay', 60);
...
<title><?php echo COMPANY_S; ?> - Daily Expenses Maintenance</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="admin-top">
                	<h1>Daily Expenses Maintenance</h1>
                   <div class="cl"></div> 
                </div>
                ...
                <div id="options-area">
					...
					<a href="../file_download.inc.php?table=journal_book">Download</a>
					<!--<a href="#">Download</a>-->
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tr>
						 ...
						 <!-- <th width="3%" height="25"  align="center">Stock Id</th> -->
						  ...
						  <th width="10%" >Expenses Purpose</th>
                       ...
                       <?php 
                        ...
                        foreach($journalBook as $eachRecord)
                            {
							$jAccDtls 		= $journal->showJournalAcc($eachRecord['jacc_id']);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
						...
						<td align="center"><a href=""><?php echo $jAccDtls[1]; ?></a></td>
						<td align="center"><a href=""><?php echo $eachRecord['expenses_purpose']; ?></a></td>
					    <td align="center"><a href=""><?php echo $eachRecord['payment_type']; ?></a></td>
					    <td align="center"><?php echo $eachRecord['payment_received']; ?></td>
					    <td align="center"><?php echo $eachRecord['pay_amount']; ?></td>
					    <td align="center"><?php echo $eachRecord['prepared_by']; ?></td>
					    ...
					    <td>
							<?php
								if($eachRecord['status'] == 1){
									echo "Paid";
								?>
									<a href="#" onClick="MM_openBrWindow('voucher-view.php?action=adv-voucher&jb_id=<?php echo $eachRecord['jb_id']; ?>','AdminDelete','scrollbars=yes,width=1000,height=800')">
									View					 
								</a>
								<?php	
								}
							...
							?>	
								<a href="#" onClick="MM_openBrWindow('jpayment-update.php?action=payment_status&jb_id=<?php echo $eachRecord['jb_id']; ?>','AdminDelete','scrollbars=yes,width=500,height=300')">
									UnPaid					 
								</a>
								<a href="#" onClick="MM_openBrWindow('voucher-view.php?action=adv-voucher&jb_id=<?php echo $eachRecord['jb_id']; ?>','AdminDelete','scrollbars=yes,width=1000,height=800')">
									View					 
