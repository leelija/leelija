...
{	
	...
	$current_stock			= $matsDtl[5]-$txtAmount;
	...
	else
	{
			...
			$mmats->addMmaterialsOut($fid,$txtBillNo,'',$txtAmount,$txtPurpose,$txtReceiveBy,$txtProdDesc,$userData[2]);	
			//Update fabric table
...
<h3><a name="editStock"></a></h3>
          ...
          <form action="<?php $_SERVER['PHP_SELF']?>?action=out_fid&fid=<?php echo $fid; ?>" method="post" enctype="multipart/form-data">
			...
			<h2><a name="addUser">Material/Fabric:<?php echo $matsDtl[1];?> Colour:<?php echo $matsDtl[1];?> </a></h2>
                ...
                <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
					...
					<label>Quantity(<?php echo $matsDtl[4];?>)<span class="orangeLetter">*</span></label>
					...
					<input name="txtReceiveBy" type="text" class="text_box_large" id="txtReceiveBy"  size="25" />
