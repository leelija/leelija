...
// Display Journal Account details
$journalAccDtls	= $mjournal->getMAllJournalAcc();
...
<title><?php echo COMPANY_S; ?> - Journal Account Maintenance</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="admin-top">
                	<h1>Journal Account Maintenance</h1>
                   <div class="cl"></div> 
                </div>
                ...
                <div id="options-area">
                	<div class="add-new-option"> 
						<a href="#" 
						    onClick="MM_openBrWindow('mjournal-acc-add.php?action=journalAcc','stockEdit','scrollbars=yes,width=750,height=600')">
						    Add New Record				  
						</a> 
                    </div>
					<!--<a href="#">Download</a>-->
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tr>
						 ...
						 <!-- <th width="3%" height="25"  align="center">Stock Id</th> -->
						  ...
						  <th width="10%" >Expenses Amount(Rs.)</th>
                       ...
                       <?php 
                        ...
                        foreach($journalAccDtls as $eachRecord)
                            {
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><a href=""><?php echo $eachRecord['jacc_name']; ?></a></td>
					   <td align="center"><?php echo $eachRecord['jacc_desc']; ?></td>
