...
$journalBook	= $mjournal->getMAllJournalBook();
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
                	<div class="add-new-option"> 
						<a href="#" 
						    onClick="MM_openBrWindow('mdaily-expenses-add.php?action=journalAcc','stockEdit','scrollbars=yes,width=750,height=600')">
						    Add New Record				  
						</a> 
                    </div>
					<a href="../file_download.inc.php?table=mjournal_book">Download</a>
					<!--<a href="#">Download</a>-->
                </div>
                	...
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($journalBook as $eachRecord)
                            {
							$jAccDtls 		= $mjournal->showMJournalAcc($eachRecord['jacc_id']);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					    ...
					    <td>
							...
							?>	
								<a href="#" onClick="MM_openBrWindow('mjpayment-update.php?action=payment_status&jb_id=<?php echo $eachRecord['jb_id']; ?>','AdminDelete','scrollbars=yes,width=500,height=300')">
									UnPaid					 
								</a>
