...
$jourDtls 		= $journal->showJournalBook($jb_id);
//admin detail
		...
		<!-- Display Data -->
                <div id="data-column">
                	...
                	<?php 
						...
						$pre_date 		= date('d-m-Y', strtotime($jourDtls[7]));
					?>
						...
						<form class="voucher-form" action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<div style="width: 100%; height:120px;">
								<div style="float:left; width:60%;">
									Debit/Credit Name:&nbsp;<span class="vtext"><?php echo $jourDtls[4]; ?></span><br>
									Mobile:&nbsp;<span class="vtext"><?php echo ''; ?></span><br>
									Adhar No.:&nbsp;<span class="vtext"><?php echo ''; ?></span>
								</div>
							...
							<div style="width: 100%; height:40px;">
								...
								<div style="float:right; width:45%;">
									Total Rs.:&nbsp;<span class="vtext"><?php echo $jourDtls[3];?></span>
								</div>
							</div>
							
							<div style="width: 100%; height:40px;">
								Rupee:&nbsp;<span class="vtext"><?php echo convert_number_to_words($jourDtls[3]); ?></span>
							</div>
							<div style="width: 100%; height:40px;">
								<div style="float:left; width:45%;">
							...
							<div style="width: 100%; height:40px;">
								<div style="float:left; width:45%;">
									Payment by:<span class="vtext"><?php echo $jourDtls[6];?></span>
								</div>
								<div style="float:right; width:45%;">
									Payment Date:&nbsp;<span class="vtext"><?php 
									$cheched_date = date('d-m-Y', strtotime($jourDtls[7]));
