...
//echo $keyword;exit;
	$link = '';
	$fid = $search_obj->getMatOutKeyword($keyword);
	//echo $fid;exit;
}
else
{
...
<title><?php echo COMPANY_S; ?> -  Material Out </title>
<!-- Style -->
                ...
                <div id="data-column">
					...
					<?php
                       ...
                       $fid = array_slice($fid, $start, $limit);     
                        foreach($fid as $x)
							...
							$fabricDetail 		= $fabric->showFabric($fabricOutDetail[1]);
							
							$empDtls			= $employee->showEmployee($fabricOutDetail[6]);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
						...
						<td align="center"><?php echo $empDtls[2]; ?></td>
