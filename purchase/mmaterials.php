...
$mmatsDetail 	= $mmats->MmaterialDtls();
...
<title><?php echo COMPANY_S; ?> - Stock Material Maintenance</title>
               ...
               <div id="admin-top">
                ...
                <div id="options-area">
                	<div class="add-new-option">
                    	<a href="<?php echo "mmaterials_add.php"."?action=add_fabric"; ?>">
                            Add New Materials/Fabrics
                        </a>  
                    </div>
					<a href="../file_download.inc.php?table=mmaterials">Download</a>
					<!--<a href="#">Download</a>-->
                </div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tr>
						  ...
						  <th width="10%" >Materials/Fabrics</th>
	                   ...
	                   // $k = $pages->getPageSerialNum($numResDisplay);
                        ...
                        foreach($mmatsDetail as $eachRecord)
                            {
                    ...
                    ?>
					  ...
					  <td align="center"><?php echo $eachRecord['materials_name']; ?></td>
					  <td align="center"><?php echo $eachRecord['mat_colors']; ?></td>
					  <td align="center"><?php echo $eachRecord['mat_unit']; ?></td>
					  <td align="center"><?php echo $eachRecord['mat_type']; ?></td>
					  <td align="center"><?php echo $eachRecord['c_stock']; ?></td>
					  <td align="center"><?php echo $eachRecord['remark']; ?></td>
					   <td align="center"><?php echo $eachRecord['lastdate']; ?></td>
					   <td>
							[ 
							<a href="#" 
							onClick="MM_openBrWindow('mmaterials-in-add.php?action=in_fid&fid=<?php echo $eachRecord['id']; ?>','fabricIn','scrollbars=yes,width=750,height=600')">
							IN					  </a> ]
					  
							[ 
							<a href="#" 
							onClick="MM_openBrWindow('mmaterials-out.php?action=out_fid&fid=<?php echo $eachRecord['id']; ?>','fabricEdit','scrollbars=yes,width=750,height=600')">
							OUT					  </a> ]
