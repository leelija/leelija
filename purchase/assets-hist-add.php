...
if($txtBalance == '')
	...
	{
		$assetsDtls 		= $journal->showAssetsAcc($txtAssType);
		$asstBalance 		= $assetsDtls[3] + $txtBalance;
		//add the journal book Value
		$journal->addAssetsHist($txtAssType,$txtBalance,$txtPurpose,$txtAssSource,$txtProdDesc,$userData[2]);	
		// Update Assets Account
		$journal->UpdateAssets($txtAssType,$assetsDtls[1],$assetsDtls[2],$asstBalance,$userData[2]);
		
		// ==== Send SMS =======
		$apikey = "Cel1HfkoUkOIJP7VlXPAPA";
		$apisender = "MoniEn";
		$msgs =" Cash ".$txtBalance." Deposit from ".$txtAssSource." Now Total Balance   ".$asstBalance."  ";
			...
			<h2>Assets Add</h2>
				...
				<div >
					...
					<select name="txtAssType" type="text" id="txtAssType" class="text_box_large">
						<?php
							$assetsDtls         = $journal->getAllAssetsAcc();
