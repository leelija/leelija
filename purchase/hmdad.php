...
if(isset($_POST['btnLogin']))
{
	...
	else
	{
		...
		$Login->validateHmdadPurch($login, $password, 'email', 'password', 'customer');
...
<title>HMDA Dyeing Control Panel -  CRM</title>
...
<body>
    ...
    <div id="crm-login-page-heading-back">
    	<h1>Sign in to Work HMDA Dyeing</h1>
    </div>
    <!-- eof Page Heading -->
	...
	<div id="adminPanelLogin">
    	...
    	<div id="loginBox">
        	<h2>HMDA Dyeing Purchase Control Panel</h2>
