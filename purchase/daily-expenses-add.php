...
if($txtJAccName == '')
	...
	{
		$jAccDtls 		= $journal->showJournalAcc($txtJAccName);
		$jAccBalance 	= $jAccDtls[3] + $txtPayAmount;
		//add the journal book Value
		$journal->addJournalBook($txtJAccName,$txtExpPurpose,$txtPaymentType,$txtPayAmount,$txtPaymentTo,$txtPreparedBy,1,$userData[2],$txtPayDate);	
		
		// Update Journal Account
		$journal->UpdateJournalAccount($txtJAccName, $jAccDtls[1],$jAccDtls[2],$jAccBalance,$userData[2]);
		...
		//if($txtPayAmount >= 10000){
			...
			$apisender = "MoniEn";
			$msgs =" Cash ".$txtPayAmount." Payment to ".$txtPaymentTo.", on ".$attDate.", ".$txtExpPurpose." Purpose. Now Account Balance:".$asstBalance.".";
			...
			$apikey = "Cel1HfkoUkOIJP7VlXPAPA";
			$apisender = "MoniEn";
			$msgs =" Cash ".$txtPayAmount." Payment to ".$txtPaymentTo.", ".$txtExpPurpose." Purpose. Now Account Balance:".$asstBalance.".";
			...
			<h2>Daily Expenses Add</h2>
				...
				<div >
					...
					<select name="txtJAccName" type="text" id="txtJAccName" class="text_box_large">
						<?php
							$jAccDtls         = $journal->getAllJournalAcc();
				...
				<div >
					...
					<select name="txtPreparedBy" type="text" id="txtPreparedBy" class="text_box_large">
						<option value="Mahabubar Rahaman">Mahabubar Rahaman</option>
						<option value="Monihul Islam">Monihul Islam</option>
						<option value="Kazi Mahabub Rahaman">Kazi Mahabub Rahaman</option>
					</select>
				</div> 
