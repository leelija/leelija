...
$assetsAccDtls	= $mjournal->getMAllAssetsAcc();
...
<title><?php echo COMPANY_S; ?> - Assets Account Maintenance</title>
    ...
    <div class="container">
        <div class="inner-container">
            ...
            <div id="admin-body">
               ...
               <div id="admin-top">
                	<h1>Assets Account Maintenance</h1>
                   <div class="cl"></div> 
                </div>
                ...
                <div id="options-area">
                	<div class="add-new-option"> 
						<a href="#" 
						    onClick="MM_openBrWindow('massets-hist-add.php?action=journalAcc','stockEdit','scrollbars=yes,width=750,height=600')">
						    Add New Record				  
						</a> 
                    </div>
					<!--<a href="#">Download</a>-->
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
                       ...
                       <?php 
                        ...
                        foreach($assetsAccDtls as $eachRecord)
							...
							if($eachRecord['balance'] <=10000){
							/*	// ==== Send SMS =======
								$apikey = "Cel1HfkoUkOIJP7VlXPAPA";
								$apisender = "MoniEn";
								$msgs =" Account situation is very poor. Now Account Balance: ".$eachRecord['balance']." Please Deposit Balance As Soon As Possible.";
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><a href=""><?php echo $eachRecord['assets_type']; ?></a></td>
					   <td align="center"><?php echo $eachRecord['assets_name']; ?></td>
