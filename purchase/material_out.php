...
$matOutDetail 	= $fabric->matOutDtls();
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
	                   ...
	                   // $k = $pages->getPageSerialNum($numResDisplay);
                        ...
                        foreach($matOutDetail as $eachRecord)
                            {
							$fabricDetail 		= $fabric->showFabric($eachRecord['fabric_id']);
							$empDtls			= $employee->showEmployee($eachRecord['receive_by']);
							
							$receiveDate		= date_create($eachRecord['added_on']);
                    ...
                    ?>
                      <tr align="left"<?php $utility->printRowColor($bgColor);?>>
					   ...
					   <td align="center"><?php echo $fabricDetail[1]; ?></td>
						...
						<td align="center"><?php echo date_format($receiveDate,"m/d/Y"); ?></td>
