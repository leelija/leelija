...
<title><?php echo COMPANY_S; ?> - Stock Material In Maintenance</title>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
	                   ...
	                   // $k = $pages->getPageSerialNum($numResDisplay);
                        ...
                        foreach($matInDetail as $eachRecord)
                            {
                    ...
                    ?>
					  ...
					  <td align="center"><?php echo $eachRecord['from_w']; ?></td>
					  ...
					  <td align="center"><?php echo $eachRecord['bill_no']; ?></td>
					   ...
					   <td align="center">
					 	<?php 
							if(($eachRecord[14] != '') && ( file_exists("../images/matbill/".$eachRecord[14])) )
							{
								echo $utility->imageDisplay2('../images/matbill/', $eachRecord['image'], 50, 50, 0, '', $eachRecord['fabric_in_id']);
	
							}
						?>
                      </td>
					   <td align="center"><?php echo $eachRecord['receive_by']; ?></td>
					   ...
					   <td>
							<p 
								onClick="MM_openBrWindow('payment-update.php?action=bill-update&finId=<?php echo $eachRecord['fabric_in_id']; ?>','align=middle','billReview','scrollbars=yes,width=450,height=400')">
								Payment					  
							</p>
						</td>			
				    </tr>
