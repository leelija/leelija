...
{
	$link = '';
	$lid = $labour->getAllLabour('added_on','DESC');
}
/*	GET ALL PRODUCT*/
//print_r($pids);exit;
              ...
              <!--  <div id="options-area">
                ...
                <div id="data-column">
					  ...
					  <td align="center"><?php echo $labourDetails[1]; ?></td>
					   <td align="center"><?php echo $labourDetails[3]; ?></td>
					    <td align="center"><?php echo $labourDetails[4]; ?></td>
						 <td align="center"><?php echo $labourDetails[5]; ?></td>
					    <td align="center"><?php echo $labourDetails[10]; ?></td>
					...
					<!--  <td >
					  [ 
					    <a href="#" 
					  onClick="MM_openBrWindow('stich_rate_edit.php?action=stich_rate&rid=<?php //echo $labourDetails[0]; ?>','editStichRate','scrollbars=yes,width=750,height=600')">
					  Edit					  </a> ]
					  
					  
					 
					  [ 
					  <a href="#" onClick="MM_openBrWindow('fabric_delete.php?action=del_stichRate&rid=<?php //echo $labourDetails[0]; ?>','DeleteStichRate','scrollbars=yes,width=400,height=350')">
					  Delete					  </a> ]<br>
					  [ 
					  <a href="#" onClick="MM_openBrWindow('fabric_delete.php?action=del_stichRate&rid=<?php //echo $labourDetails[0]; ?>','DeleteStichRate','scrollbars=yes,width=400,height=350')">
					  Payment					  </a> ]<br>
