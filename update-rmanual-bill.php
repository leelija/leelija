...
if($txtPayment == '')
	...
	else
	{
		...
		//Update hand bill table
		$bill->UpdateBillTable($bid, $txtPayment,'rfri_manual_bbook');	
...
<title><?php echo COMPANY_S; ?> -Manual bill update </title>
...
<!-- /TinyMCE -->
	...
	<h3><a name="editStock"></a></h3>
        ...
        <form action="<?php $_SERVER['PHP_SELF']?>?action=bill-update&bid=<?php echo $bid; ?>" method="post" enctype="multipart/form-data">
		 ...
		 <h2><a name="addUser">Update Manual bill </a></h2>
