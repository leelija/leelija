            ...
            <div id="admin-body">
             ...
             <!--   <div id="options-area">
                ...
                <div id="data-column">
                    ...
                    ?>  
                    <thead>
                      <th width="3%" height="25"  align="center">GR Id</th>
                    ...
                    ?>
					  ...
					  <td align="left"><?php echo $productReturnDetail[0]; ?></td>
					...
					<!--  <td >
					  ...
					  [ 
					  <a href="#" onClick="MM_openBrWindow('greturn_delete.php?action=del_sid&sid=<?php echo $x; ?>','OrdDelete','scrollbars=yes,width=400,height=350')">
					  DELETE				  </a> ]<br>
					  [ 
