...
if($txtPayment == '')
	...
	else
	{
		...
		//Update Computer bill table
		$bill->UpdateBillTable($bid, $txtPayment,'rfri_comp_bbook');	
		...
		$uMesg->showSuccessT('success', 0, '', $_SERVER['PHP_SELF'], "Payment bill has been successfully updated", 'SUCCESS');
	}
}
...
<title><?php echo COMPANY_S; ?> -Computer bill update </title>
...
<!-- /TinyMCE -->
	...
	<h3><a name="editStock"></a></h3>
        ...
        <form action="<?php $_SERVER['PHP_SELF']?>?action=bill-update&bid=<?php echo $bid; ?>" method="post" enctype="multipart/form-data">
         
		 
		 <h2><a name="addUser">Update Computer bill </a></h2>
                        <span>Please  <span class="required"></span>select any one option .</span>
