...
{	
	...
	for($i=0; $i < $selNum; $i++)
			{
				...
				$txtInterlockRateId		= $_POST['txtInterlockRateId'][$i];
				$rateDtls 				= $rate->showInterlockRate($txtInterlockRateId);
				
				//$total_cost			= $_POST['txtKaliQuantity'][$i] * $_POST['txtrate'][$i];
				$total_cost				= $rateDtls[2] * $_POST['txtKaliQuantity'][$i];
				
				//add Interlock Record
				$interlock->addInterlock($_POST['txtOrderId'][$i],$_POST['txtDesignNo'][$i],$txtMasterId,$txtEmpid,
				$txtInterlockRateId,$_POST['txtKaliQuantity'][$i],$rateDtls[2],$total_cost,'unpaid');
				
				//addInterlock($order_id,$design_no,$master_id,$labour_id,$interlock_rate_id,$inte_quantity,$rate,$total_cost)
	...
	//forward
	$uMesg->showSuccessT('success', 0, '', 'interlock_mst.php', " record has been successfully Added", 'SUCCESS');
	
}
if(isset($_POST['btnCancel']))
{
	//forward
	header("Location: interlock_mst.php");
}
...
<title><?php echo COMPANY_S; ?> - Add Interlock record</title>
...
<script type="text/javascript" src="js/interlock.js"></script>
        ...
        <div class="inner-container">
            ...
            <div id="admin-body">
                ...
                <div class="webform-area">
                    ...
                    <?php 
					if(isset($_GET['action']) && ($_GET['action'] == 'add_interlock')) 
					{	
					?>
                        ...
                        <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
							...
							<input name="txtMasterId" type="text" class="text_box_large" id="txtMasterId" 
								value="" size="25" />
							<div class="cl"></div>
							-->
							<div >
							...
							<select name="txtMasterId" type="text" id="txtMasterId" class="text_box_large">
								<option value="387">Kamal Master</option>
							</select>
							</div>
							<div class="cl"></div>
                            ...
                            <div class="cl"></div>
							<tr>
								<label>Select No. of Interlock</label>
									<!--<td align="left" class="menuText">Select No. Type </td>-->
									<td align="left" class="bodyText pad5">
									<?php 
									//gen number array
									$arr_value	= range(1,68);
									$arr_label	= range(1,68);
									?>
									  <select name="selNum" id="selNum" onchange="return getAllInterlock();"
									   class="textBoxA">
								...
								<div class="cl"></div>
								<div id="showInterlockRecord"></div>
                            <div class="cl"></div>
