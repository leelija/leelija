...
$samBillingdata = $bill->showSampleBilling();
            ...
            <div id="admin-body">
                ...
                <div id="options-area">
					<div class="add-new-option">
                    	<a href="<?php echo "sample_billing_add.php"."?action=add_fbill"; ?>">
                            Add New Bill
                        </a> 
                    </div>
				</div>
                ...
                <div id="data-column" style="position:relative; bottom: 9px;">
                	<table id="example" class="single-column" cellpadding="0" cellspacing="0" >
						...
						<tbody>
						   <?php 
							$sl=1;   
							foreach($samBillingdata as $eachRecord)
								{
						...
						?>
							<tr align="left"<?php $utility->printRowColor($bgColor);?>>
								...
								<td>
									<p 
									onClick="MM_openBrWindow('sample-billing-preview.php?action=bill-review&bid=<?php echo $eachRecord['bill_id']; ?>','billReview','scrollbars=yes,width=750,height=600')">
									View					  
									</p> 
								</td>
							</tr>
