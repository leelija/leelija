...
<h3><a name="editStock">View Sample Dyeing</a></h3>
    
          
		  <table border="1" cellpadding="0" cellspacing="0" width="100%" id="myTable" class="tblListForm">
						<tr class="listheader">
						
						<th class="listheader">Fabric Name </th>
						<th class="listheader">Quantity/Piece(in meter) </th>
						<th class="listheader">Fabric Rate/Meter </th>
						<th class="listheader">Total Fabric cost</th>
						<th class="listheader">Labour Cost/meter</th>
						...
						<tr class="table-row" >
							...
							<td align="center"><?php echo $eachrecord ['labour_cost'] * $eachrecord ['fab_amount']; ?></td>
